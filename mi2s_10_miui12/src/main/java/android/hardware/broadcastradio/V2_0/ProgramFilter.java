...
public final class ProgramFilter {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.includeCategories = hwBlob.getBool(_hidl_offset + 32);
        this.excludeModifications = hwBlob.getBool(_hidl_offset + 33);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        hwBlob.putBool(_hidl_offset + 32, this.includeCategories);
        hwBlob.putBool(_hidl_offset + 33, this.excludeModifications);
    }
}
