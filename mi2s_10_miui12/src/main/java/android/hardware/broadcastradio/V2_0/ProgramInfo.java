...
public final class ProgramInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.selector.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 0);
        this.logicallyTunedTo.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 32);
        this.physicallyTunedTo.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 48);
        int _hidl_vec_size = hwBlob.getInt32(_hidl_offset + 64 + 8);
        ...
        this.infoFlags = hwBlob.getInt32(_hidl_offset + 80);
        this.signalQuality = hwBlob.getInt32(_hidl_offset + 84);
        ...
        int _hidl_vec_size3 = hwBlob.getInt32(_hidl_offset + 104 + 8);
        ...
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
            ...
            _hidl_vec_element3.readEmbeddedFromParcel(hwParcel, childBlob3, (long) (_hidl_index_03 * 32));
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        HwBlob hwBlob = _hidl_blob;
        this.selector.writeEmbeddedToBlob(hwBlob, _hidl_offset + 0);
        this.logicallyTunedTo.writeEmbeddedToBlob(hwBlob, _hidl_offset + 32);
        this.physicallyTunedTo.writeEmbeddedToBlob(hwBlob, _hidl_offset + 48);
        ...
        hwBlob.putBlob(_hidl_offset + 64 + 0, childBlob);
        hwBlob.putInt32(_hidl_offset + 80, this.infoFlags);
        hwBlob.putInt32(_hidl_offset + 84, this.signalQuality);
        int _hidl_vec_size2 = this.metadata.size();
        hwBlob.putInt32(_hidl_offset + 88 + 8, _hidl_vec_size2);
        ...
        hwBlob.putInt32(_hidl_offset + 104 + 8, _hidl_vec_size3);
        ...
        hwBlob.putBlob(_hidl_offset + 104 + 0, childBlob3);
    }
}
