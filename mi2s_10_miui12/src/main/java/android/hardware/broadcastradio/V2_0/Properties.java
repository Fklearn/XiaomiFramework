...
public final class Properties {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.serial = hwBlob.getString(_hidl_offset + 48);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        HwBlob hwBlob = _hidl_blob;
        hwBlob.putString(_hidl_offset + 0, this.maker);
        hwBlob.putString(_hidl_offset + 16, this.product);
        hwBlob.putString(_hidl_offset + 32, this.version);
        hwBlob.putString(_hidl_offset + 48, this.serial);
        ...
        hwBlob.putInt32(_hidl_offset + 80 + 8, _hidl_vec_size2);
        ...
        hwBlob.putBlob(_hidl_offset + 80 + 0, childBlob2);
    }
}
