...
public abstract interface IRadioConfigIndication
  extends android.hardware.radio.config.V1_0.IRadioConfigIndication
{
  ...
  public static IRadioConfigIndication asInterface(IHwBinder paramIHwBinder)
  {
    ...
    Object localObject = paramIHwBinder.queryLocalInterface("android.hardware.radio.config@1.1::IRadioConfigIndication");
    ...
    try
    {
      ...
      {
        boolean bool = ((String)paramIHwBinder.next()).equals("android.hardware.radio.config@1.1::IRadioConfigIndication");
        if (bool) {
          return (IRadioConfigIndication)localObject;
        }
      }
  ...
  public static IRadioConfigIndication getService(String paramString)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio.config@1.1::IRadioConfigIndication", paramString));
  }
  
  public static IRadioConfigIndication getService(String paramString, boolean paramBoolean)
    throws RemoteException
  {
    return asInterface(HwBinder.getService("android.hardware.radio.config@1.1::IRadioConfigIndication", paramString, paramBoolean));
  }
    ...
    implements IRadioConfigIndication
  {
    ...
    {
      byte[] arrayOfByte1 = { 127, -49, 22, 127, 89, 59, 16, -58, 123, 89, -85, 112, 50, 23, -127, -62, 106, 85, 117, -22, -74, 8, 3, -25, -53, -79, -63, 76, 113, 8, 90, 59 };
      byte[] arrayOfByte2 = { -20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76 };
      return new ArrayList(Arrays.asList(new byte[][] { arrayOfByte1, { 34, -117, 46, -29, -56, -62, 118, -55, -16, -81, -83, 45, -61, 19, -54, 61, 107, -67, -98, 72, 45, -33, 49, 60, 114, 4, -58, 10, -39, -74, 54, -85 }, arrayOfByte2 }));
    }
    
    public final ArrayList<String> interfaceChain()
    {
      return new ArrayList(Arrays.asList(new String[] { "android.hardware.radio.config@1.1::IRadioConfigIndication", "android.hardware.radio.config@1.0::IRadioConfigIndication", "android.hidl.base@1.0::IBase" }));
    }
    
    public final String interfaceDescriptor()
    {
      return "android.hardware.radio.config@1.1::IRadioConfigIndication";
    }
    ...
    {
      if ("android.hardware.radio.config@1.1::IRadioConfigIndication".equals(paramString)) {
        return this;
      }
      return null;
    }
...
/* Location:              /Users/sanbo/Desktop/ds/t.jar!/android/hardware/radio/config/V1_1/IRadioConfigIndication.class
