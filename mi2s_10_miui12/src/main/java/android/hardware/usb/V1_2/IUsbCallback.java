...
public interface IUsbCallback extends android.hardware.usb.V1_1.IUsbCallback {
    ...
    public static abstract class Stub extends HwBinder implements IUsbCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IUsbCallback.kInterfaceName, android.hardware.usb.V1_1.IUsbCallback.kInterfaceName, android.hardware.usb.V1_0.IUsbCallback.kInterfaceName, IBase.kInterfaceName}));
        }
