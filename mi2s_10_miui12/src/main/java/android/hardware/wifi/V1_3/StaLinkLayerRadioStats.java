...
public final class StaLinkLayerRadioStats {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.onTimeInMsForNanScan = hwBlob.getInt32(_hidl_offset + 32);
        this.onTimeInMsForBgScan = hwBlob.getInt32(_hidl_offset + 36);
        this.onTimeInMsForRoamScan = hwBlob.getInt32(_hidl_offset + 40);
        this.onTimeInMsForPnoScan = hwBlob.getInt32(_hidl_offset + 44);
        this.onTimeInMsForHs20Scan = hwBlob.getInt32(_hidl_offset + 48);
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ...
            _hidl_vec_element.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 24));
