...
public interface IServiceManager extends android.hidl.manager.V1_1.IServiceManager {
    ...
    public static abstract class Stub extends HwBinder implements IServiceManager {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IServiceManager.kInterfaceName, android.hidl.manager.V1_1.IServiceManager.kInterfaceName, android.hidl.manager.V1_0.IServiceManager.kInterfaceName, IBase.kInterfaceName}));
        }
