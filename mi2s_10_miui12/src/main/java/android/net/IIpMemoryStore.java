            ...
            if (i == TRANSACTION_getInterfaceVersion) {
                ...
                switch (i) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg1 = NetworkAttributesParcelable.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg1 = null;
                        }
                    ...
                    case 2:
                        ...
                        if (data.readInt() != 0) {
                            _arg3 = Blob.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg3 = null;
                        }
                    ...
                    case 3:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg0 = NetworkAttributesParcelable.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg0 = null;
                        }
