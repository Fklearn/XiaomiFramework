...
public class TcpKeepalivePacketData extends KeepalivePacketData implements Parcelable {
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{this.srcAddress, this.dstAddress, Integer.valueOf(this.srcPort), Integer.valueOf(this.dstPort), Integer.valueOf(this.tcpAck), Integer.valueOf(this.tcpSeq), Integer.valueOf(this.tcpWnd), Integer.valueOf(this.tcpWndScale), Integer.valueOf(this.ipTos), Integer.valueOf(this.ipTtl)});
    }
