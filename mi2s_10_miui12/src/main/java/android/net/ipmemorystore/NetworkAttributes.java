...
public class NetworkAttributes {
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{this.assignedV4Address, this.assignedV4AddressExpiry, this.groupHint, this.dnsAddresses, this.mtu});
    }
