...
public class StructNdMsg {
    ...
    public String toString() {
        return "StructNdMsg{ family{" + NetlinkConstants.stringForAddressFamily(this.ndm_family) + "}, ifindex{" + this.ndm_ifindex + "}, state{" + ("" + this.ndm_state + " (" + stringForNudState(this.ndm_state) + ")") + "}, flags{" + ("" + this.ndm_flags + " (" + stringForNudFlags(this.ndm_flags) + ")") + "}, type{" + this.ndm_type + "} }";
    }
}
