...
public interface IVold extends IInterface {
    ...
    void runDefrag(boolean z, IVoldTaskListener iVoldTaskListener) throws RemoteException;
    ...
    void stopDefrag(IVoldTaskListener iVoldTaskListener) throws RemoteException;
    ...
    public static class Default implements IVold {
        ...
        public void runDefrag(boolean forground, IVoldTaskListener listener) throws RemoteException {
        }

        public void stopDefrag(IVoldTaskListener listener) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IVold {
        ...
        static final int TRANSACTION_abortChanges = 62;
        ...
        static final int TRANSACTION_clearUserKeyAuth = 51;
        static final int TRANSACTION_commitChanges = 63;
        static final int TRANSACTION_createObb = 22;
        static final int TRANSACTION_createStubVolume = 71;
        ...
        static final int TRANSACTION_destroyStubVolume = 72;
        ...
        static final int TRANSACTION_fixateNewestUserKeyAuth = 52;
        ...
        static final int TRANSACTION_lockUserKey = 54;
        static final int TRANSACTION_markBootAttempt = 67;
        ...
        static final int TRANSACTION_openAppFuseFile = 73;
        static final int TRANSACTION_partition = 12;
        static final int TRANSACTION_prepareCheckpoint = 64;
        ...
        static final int TRANSACTION_restoreCheckpoint = 65;
        static final int TRANSACTION_restoreCheckpointPart = 66;
        static final int TRANSACTION_runDefrag = 27;
        ...
        static final int TRANSACTION_stopDefrag = 28;
        static final int TRANSACTION_supportsBlockCheckpoint = 69;
        static final int TRANSACTION_supportsCheckpoint = 68;
        static final int TRANSACTION_supportsFileCheckpoint = 70;
        static final int TRANSACTION_unlockUserKey = 53;
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case TRANSACTION_abortIdleMaint /*26*/:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_runDefrag /*27*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg1 = true;
                        }
                        runDefrag(_arg1, IVoldTaskListener.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 28:
                        parcel.enforceInterface(DESCRIPTOR);
                        stopDefrag(IVoldTaskListener.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 29:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 56:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_prepareSandboxForApp /*57*/:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 62:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_commitChanges /*63*/:
                        parcel.enforceInterface(DESCRIPTOR);
                        commitChanges();
                        reply.writeNoException();
                        return true;
        ...
        private static class Proxy implements IVold {
            ...
            public void abortIdleMaint(IVoldTaskListener listener) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(listener != null ? listener.asBinder() : null);
                    if (this.mRemote.transact(Stub.TRANSACTION_abortIdleMaint, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void runDefrag(boolean forground, IVoldTaskListener listener) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(forground ? 1 : 0);
                    _data.writeStrongBinder(listener != null ? listener.asBinder() : null);
                    if (this.mRemote.transact(Stub.TRANSACTION_runDefrag, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().runDefrag(forground, listener);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void stopDefrag(IVoldTaskListener listener) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().stopDefrag(listener);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void commitChanges() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (this.mRemote.transact(Stub.TRANSACTION_commitChanges, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
