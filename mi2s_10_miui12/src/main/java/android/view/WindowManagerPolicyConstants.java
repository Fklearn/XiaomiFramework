...
public abstract interface WindowManagerPolicyConstants
{
  ...
  public static String onReasonToString(int paramInt)
  {
    if (paramInt != 1)
    {
      if (paramInt != 2)
...
/* Location:              /Users/sanbo/Desktop/framework/miui/framework/classes3-dex2jar.jar!/android/view/WindowManagerPolicyConstants.class
