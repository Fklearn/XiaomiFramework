...
public class MonkeySourceNetworkViews {
    ...
    public static Class<?> getIdClass(String packageName, String sourceDir) throws ClassNotFoundException {
        ...
        DexClassLoader classLoader = new DexClassLoader(sourceDir, "/data/local/tmp", (String) null, ClassLoader.getSystemClassLoader());
    ...
    public static AccessibilityNodeInfo getNodeByAccessibilityIds(String windowString, String viewString) {
        ...
        return AccessibilityInteractionClient.getInstance().findAccessibilityNodeInfoByAccessibilityId(connectionId, windowId, (long) viewId, false, 0, (Bundle) null);
    }
