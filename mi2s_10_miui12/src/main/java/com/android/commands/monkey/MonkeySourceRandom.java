...
public class MonkeySourceRandom implements MonkeyEventSource {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:2:0x000b, code lost:
        r0 = true & r3.mPermissionUtil.populatePermissionsMapping();
     */
    ...
    public boolean validate() {
        /*
            r3 = this;
            r0 = 1
            float[] r1 = r3.mFactors
            r2 = 5
            r1 = r1[r2]
            r2 = 0
            int r1 = (r1 > r2 ? 1 : (r1 == r2 ? 0 : -1))
            if (r1 == 0) goto L_0x001e
            com.android.commands.monkey.MonkeyPermissionUtil r1 = r3.mPermissionUtil
            boolean r1 = r1.populatePermissionsMapping()
            r0 = r0 & r1
            ...
            r1.dump()
        L_0x001e:
            boolean r1 = r3.adjustEventFactors()
            r1 = r1 & r0
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.commands.monkey.MonkeySourceRandom.validate():boolean");
    }
