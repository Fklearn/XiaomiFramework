...
public class AppStateTracker {
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(android.os.Message r10) {
            /*
                ...
                com.android.server.AppStateTracker r0 = com.android.server.AppStateTracker.this
                java.lang.Object r0 = r0.mLock
                monitor-enter(r0)
                com.android.server.AppStateTracker r2 = com.android.server.AppStateTracker.this     // Catch:{ all -> 0x017a }
                boolean r2 = r2.mStarted     // Catch:{ all -> 0x017a }
            ...
            L_0x0015:
                monitor-exit(r0)     // Catch:{ all -> 0x017a }
                com.android.server.AppStateTracker r0 = com.android.server.AppStateTracker.this
                com.android.server.AppStateTracker r2 = com.android.server.AppStateTracker.this
                com.android.internal.util.StatLogger r2 = r2.mStatLogger
                long r2 = r2.getTime()
                int r4 = r10.what
                r5 = 1
                r6 = 0
            ...
            L_0x003d:
                r5 = r6
            L_0x003e:
                r9.handleUidGone(r1, r5)
                return
            L_0x0042:
                int r1 = r10.arg1
                r9.handleUidActive(r1)
                return
            L_0x0048:
                int r1 = r10.arg1
                int r4 = r10.arg2
                r9.handleUidStateChanged(r1, r4)
                return
            L_0x0050:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
                com.android.server.AppStateTracker$Listener[] r1 = r1.cloneListeners()
                int r4 = r1.length
            L_0x0057:
                if (r6 >= r4) goto L_0x0061
                r5 = r1[r6]
                r5.onExemptChanged(r0)
                int r6 = r6 + 1
                goto L_0x0057
            L_0x0061:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
                com.android.internal.util.StatLogger r1 = r1.mStatLogger
                r4 = 6
                r1.logDurationStat(r4, r2)
                return
            L_0x006c:
                com.android.server.AppStateTracker r4 = com.android.server.AppStateTracker.this
                java.lang.Object r4 = r4.mLock
                monitor-enter(r4)
                com.android.server.AppStateTracker r7 = com.android.server.AppStateTracker.this     // Catch:{ all -> 0x00a2 }
                boolean r7 = r7.mForcedAppStandbyEnabled     // Catch:{ all -> 0x00a2 }
                if (r7 != 0) goto L_0x0080
                com.android.server.AppStateTracker r7 = com.android.server.AppStateTracker.this     // Catch:{ all -> 0x00a2 }
                boolean r7 = r7.mForceAllAppsStandby     // Catch:{ all -> 0x00a2 }
                if (r7 != 0) goto L_0x0080
                goto L_0x0081
            L_0x0080:
                r5 = r6
            L_0x0081:
                ...
                com.android.server.AppStateTracker r4 = com.android.server.AppStateTracker.this
                com.android.server.AppStateTracker$Listener[] r4 = r4.cloneListeners()
                int r7 = r4.length
            L_0x0089:
                if (r6 >= r7) goto L_0x0098
                r8 = r4[r6]
            ...
            L_0x0098:
                com.android.server.AppStateTracker r4 = com.android.server.AppStateTracker.this
                com.android.internal.util.StatLogger r4 = r4.mStatLogger
                r4.logDurationStat(r1, r2)
                return
            L_0x00a2:
                r1 = move-exception
                monitor-exit(r4)     // Catch:{ all -> 0x00a2 }
            ...
            L_0x00b4:
                if (r6 >= r4) goto L_0x00be
                r5 = r1[r6]
                r5.onForceAllAppsStandbyChanged(r0)
                int r6 = r6 + 1
                goto L_0x00b4
            L_0x00be:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
            ...
            L_0x00d0:
                if (r6 >= r4) goto L_0x00da
                r5 = r1[r6]
                r5.onTempPowerSaveWhitelistChanged(r0)
                int r6 = r6 + 1
                goto L_0x00d0
            L_0x00da:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
            ...
            L_0x00ec:
                if (r6 >= r4) goto L_0x00f6
                r5 = r1[r6]
                r5.onPowerSaveWhitelistedChanged(r0)
                int r6 = r6 + 1
                goto L_0x00ec
            L_0x00f6:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
            ...
            L_0x0108:
                if (r6 >= r4) goto L_0x0112
                r5 = r1[r6]
                r5.onPowerSaveUnwhitelisted(r0)
                int r6 = r6 + 1
                goto L_0x0108
            L_0x0112:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
            ...
            L_0x0124:
                ...
                r5.onRunAnyAppOpsChanged(r0, r7, r8)
                int r6 = r6 + 1
                goto L_0x0124
            L_0x0134:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
            ...
            L_0x0147:
                ...
                r7 = r1[r5]
                int r8 = r10.arg1
                r7.onUidForegroundStateChanged(r0, r8)
                int r5 = r5 + 1
                goto L_0x0147
            L_0x0153:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
                com.android.internal.util.StatLogger r1 = r1.mStatLogger
                r1.logDurationStat(r6, r2)
                return
            L_0x015d:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
                com.android.server.AppStateTracker$Listener[] r1 = r1.cloneListeners()
            ...
            L_0x0164:
                ...
                r7 = r1[r6]
                int r8 = r10.arg1
                r7.onUidActiveStateChanged(r0, r8)
                int r6 = r6 + 1
                goto L_0x0164
            L_0x0170:
                com.android.server.AppStateTracker r1 = com.android.server.AppStateTracker.this
                com.android.internal.util.StatLogger r1 = r1.mStatLogger
                r1.logDurationStat(r5, r2)
                return
            L_0x017a:
                r1 = move-exception
                monitor-exit(r0)     // Catch:{ all -> 0x017a }
            ...
            L_0x017d:
                com.android.server.AppStateTracker r0 = com.android.server.AppStateTracker.this
                int r1 = r10.arg1
                r0.handleUserRemoved(r1)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.AppStateTracker.MyHandler.handleMessage(android.os.Message):void");
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static boolean isAnyAppIdUnwhitelisted(int[] r7, int[] r8) {
        /*
            r0 = 0
            r1 = 0
        L_0x0002:
