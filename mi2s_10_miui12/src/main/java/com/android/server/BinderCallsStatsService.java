...
public class BinderCallsStatsService extends Binder {
    ...
    static class AuthorizedWorkSourceProvider implements BinderInternal.WorkSourceProvider {
        ...
        public int resolveWorkSourceUid(int untrustedWorkSourceUid) {
            ...
            return workSource != -1 ? workSource : callingUid;
        }
    ...
    private static class SettingsObserver extends ContentObserver {
        ...
        public void onChange() {
            if (SystemProperties.get(BinderCallsStatsService.PERSIST_SYS_BINDER_CALLS_DETAILED_TRACKING).isEmpty()) {
                ...
                this.mBinderCallsStats.setMaxBinderCallStats(this.mParser.getInt(SETTINGS_MAX_CALL_STATS_KEY, NetworkConstants.ETHER_MTU));
                ...
                if (this.mEnabled != enabled) {
                    if (enabled) {
                        ...
                        Binder.setObserver((BinderInternal.Observer) null);
        ...
        if (args != null) {
            ...
            for (String arg : args) {
                if ("-a".equals(arg)) {
                    ...
                    SystemProperties.set(PERSIST_SYS_BINDER_CALLS_DETAILED_TRACKING, SplitScreenReporter.ACTION_ENTER_SPLIT);
                    this.mBinderCallsStats.setDetailedTracking(true);
