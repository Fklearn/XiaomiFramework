...
public class EventLogTags {
    ...
    public static void writeBatterySaverMode(int fullprevofforon, int adaptiveprevofforon, int fullnowofforon, int adaptivenowofforon, int interactive, String features, int reason) {
        EventLog.writeEvent(BATTERY_SAVER_MODE, new Object[]{Integer.valueOf(fullprevofforon), Integer.valueOf(adaptiveprevofforon), Integer.valueOf(fullnowofforon), Integer.valueOf(adaptivenowofforon), Integer.valueOf(interactive), features, Integer.valueOf(reason)});
    }
    ...
    public static void writeSystemServerStart(int startCount, long uptime, long elapseTime) {
        EventLog.writeEvent(SYSTEM_SERVER_START, new Object[]{Integer.valueOf(startCount), Long.valueOf(uptime), Long.valueOf(elapseTime)});
    }
