...
public abstract class ExtconUEventObserver extends UEventObserver {
    ...
    public static final class ExtconInfo {
        ...
        public String getDevicePath() {
            try {
                File devPath = new File(String.format(Locale.US, "/sys/class/extcon/%s", new Object[]{this.mName}));
                if (!devPath.exists()) {
                    return null;
                }
        ...
        public String getStatePath() {
            return String.format(Locale.US, "/sys/class/extcon/%s/state", new Object[]{this.mName});
        }
    }
