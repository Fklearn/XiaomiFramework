...
public class NetworkScoreService extends INetworkScoreService.Stub {
    ...
    public static final class Lifecycle extends SystemService {
        ...
        /* JADX WARNING: type inference failed for: r0v1, types: [com.android.server.NetworkScoreService, android.os.IBinder] */
        public void onStart() {
    ...
    NetworkScoreService(Context context, NetworkScorerAppManager networkScoreAppManager, Function<NetworkScorerAppData, ScoringServiceConnection> serviceConnProducer, Looper looper) {
        ...
        this.mContext.registerReceiverAsUser(this.mUserIntentReceiver, UserHandle.SYSTEM, new IntentFilter("android.intent.action.USER_UNLOCKED"), (String) null, (Handler) null);
        this.mHandler = new ServiceHandler(looper);
        this.mContext.registerReceiverAsUser(this.mLocationModeReceiver, UserHandle.SYSTEM, new IntentFilter("android.location.MODE_CHANGED"), (String) null, this.mHandler);
    ...
    static class FilteringCacheUpdatingConsumer implements BiConsumer<INetworkScoreCache, Object> {
        ...
        static FilteringCacheUpdatingConsumer create(Context context, List<ScoredNetwork> scoredNetworkList, int networkType) {
            return new FilteringCacheUpdatingConsumer(context, scoredNetworkList, networkType, (UnaryOperator<List<ScoredNetwork>>) null, (UnaryOperator<List<ScoredNetwork>>) null);
        }
