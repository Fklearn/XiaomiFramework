...
public class NetworkScorerAppManager {
    ...
    public boolean setActiveScorer(String packageName) {
        ...
        if (TextUtils.isEmpty(packageName)) {
            ...
            setNetworkRecommendationsPackage((String) null);
    ...
    public void migrateNetworkScorerAppSettingIfNeeded() {
        ...
        if (!TextUtils.isEmpty(scorerAppPkgNameSetting) && (currentAppData = getActiveScorer()) != null) {
            ...
            this.mSettingsFacade.putString(this.mContext, "network_scorer_app", (String) null);
            if (DEBUG) {
    ...
    private String getDefaultPackageSetting() {
        return this.mContext.getResources().getString(17039730);
    }
