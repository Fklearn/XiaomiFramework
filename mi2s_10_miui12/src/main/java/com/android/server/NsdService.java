...
public class NsdService extends INsdManager.Stub {
            ...
            private boolean handleNativeEvent(int code, String raw, String[] cooked) {
                ...
                switch (code) {
                    ...
                    case NativeResponseCode.SERVICE_REGISTERED /*606*/:
                        clientInfo.mChannel.sendMessage(393227, id, clientId, new NsdServiceInfo(cooked[2], (String) null));
                        break;
    ...
    public static class DaemonConnection {
        ...
        DaemonConnection(NativeCallbackReceiver callback) {
            this.mNativeConnector = new NativeDaemonConnector(callback, "mdns", 10, NsdService.MDNS_TAG, 25, (PowerManager.WakeLock) null);
