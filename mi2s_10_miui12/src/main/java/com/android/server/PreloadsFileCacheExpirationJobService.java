...
public class PreloadsFileCacheExpirationJobService extends JobService {
    ...
    public static void schedule(Context context) {
        int keepPreloadsMinDays = Resources.getSystem().getInteger(17694816);
    ...
    public boolean onStartJob(JobParameters params) {
        SystemProperties.set(PERSIST_SYS_PRELOADS_FILE_CACHE_EXPIRED, SplitScreenReporter.ACTION_ENTER_SPLIT);
