...
class TestNetworkService extends ITestNetworkManager.Stub {
    ...
    public class TestNetworkAgent extends NetworkAgent implements IBinder.DeathRecipient {
        ...
        final /* synthetic */ TestNetworkService this$0;

        /* Debug info: failed to restart local var, previous not found, register: 11 */
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        private TestNetworkAgent(TestNetworkService this$02, Looper looper, Context context, NetworkInfo ni, NetworkCapabilities nc, LinkProperties lp, int uid, IBinder binder) throws RemoteException {
        ...
        public void teardown() {
            this.mNi.setDetailedState(NetworkInfo.DetailedState.DISCONNECTED, (String) null, (String) null);
            ...
            synchronized (this.mBinderLock) {
                if (this.mBinder != null) {
                    ...
                    this.mBinder = null;
                    synchronized (this.this$0.mTestNetworkTracker) {
                        this.this$0.mTestNetworkTracker.remove(this.netId);
                    }
                }
            }
        }
    ...
    private TestNetworkAgent registerTestNetworkAgent(Looper looper, Context context, String iface, int callingUid, IBinder binder) throws RemoteException, SocketException {
        ...
        ni.setDetailedState(NetworkInfo.DetailedState.CONNECTED, (String) null, (String) null);
        ...
        nc.addCapability(21);
        nc.addCapability(13);
        nc.setNetworkSpecifier(new StringNetworkSpecifier(str));
        LinkProperties lp = new LinkProperties();
        lp.setInterfaceName(str);
        ...
        if (allowIPv4) {
            lp.addRoute(new RouteInfo(new IpPrefix(Inet4Address.ANY, 0), (InetAddress) null, str));
        }
        if (allowIPv6) {
            lp.addRoute(new RouteInfo(new IpPrefix(Inet6Address.ANY, 0), (InetAddress) null, str));
        }
        NetworkInterface networkInterface = netIntf;
