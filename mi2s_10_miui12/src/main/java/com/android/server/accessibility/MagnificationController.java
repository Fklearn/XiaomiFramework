...
public class MagnificationController {
    ...
    private final class DisplayMagnification implements WindowManagerInternal.MagnificationCallbacks {
        ...
        public boolean setScale(float scale, float pivotX, float pivotY, boolean animate, int id) {
            ...
            return setScaleAndCenter(scale2, normPivotX + offsetX, normPivotY + ((oldCenterY - normPivotY) * (oldScale / scale2)), animate, i);
        }
    ...
    public void register(int r4) {
        /*
            r3 = this;
            java.lang.Object r0 = r3.mLock
            monitor-enter(r0)
            android.util.SparseArray<com.android.server.accessibility.MagnificationController$DisplayMagnification> r1 = r3.mDisplays     // Catch:{ all -> 0x002d }
            java.lang.Object r1 = r1.get(r4)     // Catch:{ all -> 0x002d }
            com.android.server.accessibility.MagnificationController$DisplayMagnification r1 = (com.android.server.accessibility.MagnificationController.DisplayMagnification) r1     // Catch:{ all -> 0x002d }
            if (r1 != 0) goto L_0x0013
            com.android.server.accessibility.MagnificationController$DisplayMagnification r2 = new com.android.server.accessibility.MagnificationController$DisplayMagnification     // Catch:{ all -> 0x002d }
            r2.<init>(r4)     // Catch:{ all -> 0x002d }
            r1 = r2
        L_0x0013:
            boolean r2 = r1.isRegistered()     // Catch:{ all -> 0x002d }
            if (r2 == 0) goto L_0x001b
            monitor-exit(r0)     // Catch:{ all -> 0x002d }
            return
        L_0x001b:
            boolean r2 = r1.register()     // Catch:{ all -> 0x002d }
            if (r2 == 0) goto L_0x002b
            android.util.SparseArray<com.android.server.accessibility.MagnificationController$DisplayMagnification> r2 = r3.mDisplays     // Catch:{ all -> 0x002d }
            r2.put(r4, r1)     // Catch:{ all -> 0x002d }
            com.android.server.accessibility.MagnificationController$ScreenStateObserver r2 = r3.mScreenStateObserver     // Catch:{ all -> 0x002d }
            r2.registerIfNecessary()     // Catch:{ all -> 0x002d }
        L_0x002b:
            monitor-exit(r0)     // Catch:{ all -> 0x002d }
            return
        L_0x002d:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.accessibility.MagnificationController.register(int):void");
    }
