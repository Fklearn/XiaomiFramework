...
public class AdbService extends IAdbManager.Stub {
    ...
    public static class Lifecycle extends SystemService {
        ...
        /* JADX WARNING: type inference failed for: r0v1, types: [com.android.server.adb.AdbService, android.os.IBinder] */
        public void onStart() {
    ...
    private final class AdbHandler extends Handler {
        AdbHandler(Looper looper) {
            super(looper);
            try {
                boolean unused = AdbService.this.mAdbEnabled = containsFunction(SystemProperties.get(AdbService.USB_PERSISTENT_CONFIG_PROPERTY, ""), "adb");
    ...
    private AdbService(Context context) {
        ...
        boolean dataEncrypted = SplitScreenReporter.ACTION_ENTER_SPLIT.equals(SystemProperties.get("vold.decrypt"));
    ...
    public void allowDebugging(boolean alwaysAllow, String publicKey) {
        this.mContext.enforceCallingOrSelfPermission("android.permission.MANAGE_DEBUGGING", (String) null);
