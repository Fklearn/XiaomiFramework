...
final class CarUserSwitchingDialog extends UserSwitchingDialog {
    ...
    public void inflateContent() {
        ...
        if (bitmap != null) {
            ((ImageView) view.findViewById(16909581)).setImageDrawable(CircleFramedDrawable.getInstance(bitmap, res.getDimension(17104986)));
        }
        ((TextView) view.findViewById(16909580)).setText(res.getString(17039662));
        setView(view);
    }
