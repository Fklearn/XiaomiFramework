...
final class ConnectionRecord {
    private static final int[] BIND_ORIG_ENUMS = {1, 2, 4, DumpState.DUMP_VOLUMES, 8, 16, 32, 64, 128, DumpState.DUMP_APEX, BroadcastQueueInjector.FLAG_IMMUTABLE, 134217728, 268435456, 536870912, 1073741824, 256, 4096};
    ...
    public String toString() {
        ...
        if ((this.flags & BroadcastQueueInjector.FLAG_IMMUTABLE) != 0) {
            sb.append("FGS ");
        }
