...
public class EventLogTags {
    public static final int AM_ACTIVITY_LAUNCH_INFO = 30088;
    ...
    public static final int AM_LIFECYCLE_SAMPLE = 30100;
    ...
    public static final int AM_STARTING_WINDOW = 30090;
    ...
    public static final int CHOREOGRAPHER_CATON = 30089;
    ...
    public static void writeAmFocusedStack(int user, int displayId, int focusedStackId, int lastFocusedStackId, String reason) {
        EventLog.writeEvent(AM_FOCUSED_STACK, new Object[]{Integer.valueOf(user), Integer.valueOf(displayId), Integer.valueOf(focusedStackId), Integer.valueOf(lastFocusedStackId), reason});
    }
    ...
    public static void writeAmLifecycleSample(int user, String processName, int messagecode, int time) {
        EventLog.writeEvent(AM_LIFECYCLE_SAMPLE, new Object[]{Integer.valueOf(user), processName, Integer.valueOf(messagecode), Integer.valueOf(time)});
    }
    ...
    public static void writeAmCompact(int pid, String processName, String action, long beforersstotal, long beforerssfile, long beforerssanon, long beforerssswap, long deltarsstotal, long deltarssfile, long deltarssanon, long deltarssswap, long time, int lastaction, long lastactiontimestamp, int setadj, int procstate, long beforezramfree, long deltazramfree) {
        EventLog.writeEvent(AM_COMPACT, new Object[]{Integer.valueOf(pid), processName, action, Long.valueOf(beforersstotal), Long.valueOf(beforerssfile), Long.valueOf(beforerssanon), Long.valueOf(beforerssswap), Long.valueOf(deltarsstotal), Long.valueOf(deltarssfile), Long.valueOf(deltarssanon), Long.valueOf(deltarssswap), Long.valueOf(time), Integer.valueOf(lastaction), Long.valueOf(lastactiontimestamp), Integer.valueOf(setadj), Integer.valueOf(procstate), Long.valueOf(beforezramfree), Long.valueOf(deltazramfree)});
    }

    public static void writeAmOnTopResumedGainedCalled(int user, String componentName, String reason) {
        EventLog.writeEvent(AM_ON_TOP_RESUMED_GAINED_CALLED, new Object[]{Integer.valueOf(user), componentName, reason});
    }

    public static void writeAmOnTopResumedLostCalled(int user, String componentName, String reason) {
        EventLog.writeEvent(AM_ON_TOP_RESUMED_LOST_CALLED, new Object[]{Integer.valueOf(user), componentName, reason});
    }

    public static void writeAmAddToStopping(int user, int token, String componentName, String reason) {
        EventLog.writeEvent(AM_ADD_TO_STOPPING, new Object[]{Integer.valueOf(user), Integer.valueOf(token), componentName, reason});
    }

    public static void writeAmActivityLaunchInfo(int user, int token, String componentName, long thisTime, long totalTime, int pid) {
        EventLog.writeEvent(AM_ACTIVITY_LAUNCH_INFO, new Object[]{Integer.valueOf(user), Integer.valueOf(token), componentName, Long.valueOf(thisTime), Long.valueOf(totalTime), Integer.valueOf(pid)});
    }

    public static void writeChoreographerCaton(long skipFrames) {
        EventLog.writeEvent(CHOREOGRAPHER_CATON, skipFrames);
    }

    public static void writeAmStartingWindow(int window, long time) {
        EventLog.writeEvent(AM_STARTING_WINDOW, new Object[]{Integer.valueOf(window), Long.valueOf(time)});
    }
}
