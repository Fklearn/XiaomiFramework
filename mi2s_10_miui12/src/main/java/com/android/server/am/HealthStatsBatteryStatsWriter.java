...
public class HealthStatsBatteryStatsWriter {
    ...
    public void writeUid(HealthStatsWriter uidWriter, BatteryStats bs, BatteryStats.Uid uid) {
        ...
        if (controller != null) {
            healthStatsWriter.addMeasurement(10016, controller.getIdleTimeCounter().getCountLocked(0));
            healthStatsWriter.addMeasurement(10017, controller.getRxTimeCounter().getCountLocked(0));
            SparseArray<? extends BatteryStats.Uid.Pid> sparseArray = pids;
            long sum = 0;
            ...
            healthStatsWriter.addMeasurement(10019, controller.getPowerCounter().getCountLocked(0));
        }
        BatteryStats.ControllerActivityCounter controller2 = uid.getBluetoothControllerActivity();
        if (controller2 != null) {
            healthStatsWriter.addMeasurement(10020, controller2.getIdleTimeCounter().getCountLocked(0));
            healthStatsWriter.addMeasurement(10021, controller2.getRxTimeCounter().getCountLocked(0));
            long sum2 = 0;
            ...
            healthStatsWriter.addMeasurement(10023, controller2.getPowerCounter().getCountLocked(0));
        }
        BatteryStats.ControllerActivityCounter controller3 = uid.getModemControllerActivity();
        if (controller3 != null) {
            healthStatsWriter.addMeasurement(10024, controller3.getIdleTimeCounter().getCountLocked(0));
            healthStatsWriter.addMeasurement(10025, controller3.getRxTimeCounter().getCountLocked(0));
            long sum3 = 0;
            ...
            healthStatsWriter.addMeasurement(10027, controller3.getPowerCounter().getCountLocked(0));
        }
        healthStatsWriter.addMeasurement(10028, uid2.getWifiRunningTime(this.mNowRealtimeMs * 1000, 0) / 1000);
        healthStatsWriter.addMeasurement(10029, uid2.getFullWifiLockTime(this.mNowRealtimeMs * 1000, 0) / 1000);
        healthStatsWriter.addTimer(10030, uid2.getWifiScanCount(0), uid2.getWifiScanTime(this.mNowRealtimeMs * 1000, 0) / 1000);
        healthStatsWriter.addMeasurement(10031, uid2.getWifiMulticastTime(this.mNowRealtimeMs * 1000, 0) / 1000);
        ...
        healthStatsWriter.addMeasurement(10045, (long) uid2.getUserActivityCount(0, 0));
        healthStatsWriter.addMeasurement(10046, (long) uid2.getUserActivityCount(1, 0));
        healthStatsWriter.addMeasurement(10047, (long) uid2.getUserActivityCount(2, 0));
        healthStatsWriter.addMeasurement(10048, uid2.getNetworkActivityBytes(0, 0));
        healthStatsWriter.addMeasurement(10049, uid2.getNetworkActivityBytes(1, 0));
        healthStatsWriter.addMeasurement(10050, uid2.getNetworkActivityBytes(2, 0));
        healthStatsWriter.addMeasurement(10051, uid2.getNetworkActivityBytes(3, 0));
        healthStatsWriter.addMeasurement(10052, uid2.getNetworkActivityBytes(4, 0));
        healthStatsWriter.addMeasurement(10053, uid2.getNetworkActivityBytes(5, 0));
        healthStatsWriter.addMeasurement(10054, uid2.getNetworkActivityPackets(0, 0));
        healthStatsWriter.addMeasurement(10055, uid2.getNetworkActivityPackets(1, 0));
        healthStatsWriter.addMeasurement(10056, uid2.getNetworkActivityPackets(2, 0));
        healthStatsWriter.addMeasurement(10057, uid2.getNetworkActivityPackets(3, 0));
        healthStatsWriter.addMeasurement(10058, uid2.getNetworkActivityPackets(4, 0));
        healthStatsWriter.addMeasurement(10059, uid2.getNetworkActivityPackets(5, 0));
        healthStatsWriter.addTimer(10061, uid2.getMobileRadioActiveCount(0), uid2.getMobileRadioActiveTime(0));
        healthStatsWriter.addMeasurement(10062, uid2.getUserCpuTimeUs(0) / 1000);
        healthStatsWriter.addMeasurement(10063, uid2.getSystemCpuTimeUs(0) / 1000);
    ...
    public void writeProc(HealthStatsWriter procWriter, BatteryStats.Uid.Proc proc) {
        procWriter.addMeasurement(EventLogTags.AM_FINISH_ACTIVITY, proc.getUserTime(0));
        procWriter.addMeasurement(EventLogTags.AM_TASK_TO_FRONT, proc.getSystemTime(0));
        procWriter.addMeasurement(EventLogTags.AM_NEW_INTENT, (long) proc.getStarts(0));
        procWriter.addMeasurement(EventLogTags.AM_CREATE_TASK, (long) proc.getNumCrashes(0));
        procWriter.addMeasurement(EventLogTags.AM_CREATE_ACTIVITY, (long) proc.getNumAnrs(0));
        procWriter.addMeasurement(EventLogTags.AM_RESTART_ACTIVITY, proc.getForegroundTime(0));
    }
