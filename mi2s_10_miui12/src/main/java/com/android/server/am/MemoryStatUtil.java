...
public final class MemoryStatUtil {
    ...
    public static MemoryStat readMemoryStatFromProcfs(int pid) {
        return parseMemoryStatFromProcfs(readFileContents(String.format(Locale.US, PROC_STAT_FILE_FMT, new Object[]{Integer.valueOf(pid)})), readFileContents(String.format(Locale.US, PROC_STATUS_FILE_FMT, new Object[]{Integer.valueOf(pid)})));
    }

    public static long readRssHighWaterMarkFromProcfs(int pid) {
        return parseVmHWMFromProcfs(readFileContents(String.format(Locale.US, PROC_STATUS_FILE_FMT, new Object[]{Integer.valueOf(pid)})));
    }

    public static String readCmdlineFromProcfs(int pid) {
        return parseCmdlineFromProcfs(readFileContents(String.format(Locale.US, PROC_CMDLINE_FILE_FMT, new Object[]{Integer.valueOf(pid)})));
    }
    ...
    private static String readFileContents(String path) {
        ...
        try {
            return FileUtils.readTextFile(file, 0, (String) null);
        } catch (IOException e) {
    ...
    public static final class IonAllocations {
        ...
        public int hashCode() {
            return Objects.hash(new Object[]{Integer.valueOf(this.pid), Long.valueOf(this.totalSizeInBytes), Integer.valueOf(this.count), Long.valueOf(this.maxSizeInBytes)});
        }
