...
public class AppBindingService extends Binder {
    ...
    private AppBindingService(Injector injector, Context context) {
        ...
        this.mSettingsObserver = new ContentObserver((Handler) null) {
    ...
    private void onPhaseActivityManagerReady() {
        ...
        this.mContext.registerReceiverAsUser(this.mPackageUserMonitor, UserHandle.ALL, packageFilter, (String) null, this.mHandler);
        IntentFilter userFilter = new IntentFilter();
        userFilter.addAction("android.intent.action.USER_REMOVED");
        this.mContext.registerReceiverAsUser(this.mPackageUserMonitor, UserHandle.ALL, userFilter, (String) null, this.mHandler);
    ...
    public void onStartUser(int userId) {
        synchronized (this.mLock) {
            ...
            bindServicesLocked(userId, (AppServiceFinder) null, "user start");
        }
    }
    ...
    public void onUnlockUser(int userId) {
        synchronized (this.mLock) {
            bindServicesLocked(userId, (AppServiceFinder) null, "user unlock");
        }
    }
    ...
    public void onStopUser(int userId) {
        synchronized (this.mLock) {
            unbindServicesLocked(userId, (AppServiceFinder) null, "user stop");
    ...
    private void rebindAllLocked(String reason) {
        for (int i = 0; i < this.mRunningUsers.size(); i++) {
            if (this.mRunningUsers.valueAt(i)) {
                ...
                unbindServicesLocked(userId, (AppServiceFinder) null, reason);
                bindServicesLocked(userId, (AppServiceFinder) null, reason);
            }
        }
    }
    ...
    private static class AppServiceConnection extends PersistentConnection<IInterface> {
        ...
        AppServiceConnection(android.content.Context r17, int r18, com.android.server.appbinding.AppBindingConstants r19, android.os.Handler r20, com.android.server.appbinding.finders.AppServiceFinder r21, android.content.ComponentName r22) {
            /*
                r16 = this;
                r14 = r16
                r15 = r19
                long r6 = r15.SERVICE_RECONNECT_BACKOFF_SEC
                double r8 = r15.SERVICE_RECONNECT_BACKOFF_INCREASE
                long r10 = r15.SERVICE_RECONNECT_MAX_BACKOFF_SEC
                long r12 = r15.SERVICE_STABLE_CONNECTION_THRESHOLD_SEC
                java.lang.String r1 = "AppBindingService"
                r0 = r16
                r2 = r17
                r3 = r20
                r4 = r18
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.appbinding.AppBindingService.AppServiceConnection.<init>(android.content.Context, int, com.android.server.appbinding.AppBindingConstants, android.os.Handler, com.android.server.appbinding.finders.AppServiceFinder, android.content.ComponentName):void");
        }
