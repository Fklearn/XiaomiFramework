...
public final class PlaybackActivityMonitor implements AudioPlaybackConfiguration.PlayerDeathMonitor, PlayerFocusEnforcer {
    ...
    public void playerEvent(int r8, int r9, int r10) {
        /*
            r7 = this;
            java.lang.Object r0 = r7.mPlayerLock
            monitor-enter(r0)
            java.util.HashMap<java.lang.Integer, android.media.AudioPlaybackConfiguration> r1 = r7.mPlayers     // Catch:{ all -> 0x00a4 }
            java.lang.Integer r2 = new java.lang.Integer     // Catch:{ all -> 0x00a4 }
            r2.<init>(r8)     // Catch:{ all -> 0x00a4 }
            java.lang.Object r1 = r1.get(r2)     // Catch:{ all -> 0x00a4 }
            android.media.AudioPlaybackConfiguration r1 = (android.media.AudioPlaybackConfiguration) r1     // Catch:{ all -> 0x00a4 }
            if (r1 != 0) goto L_0x0014
            monitor-exit(r0)     // Catch:{ all -> 0x00a4 }
            return
        L_0x0014:
            com.android.server.audio.AudioEventLogger r2 = sEventLogger     // Catch:{ all -> 0x00a4 }
            com.android.server.audio.PlaybackActivityMonitor$PlayerEvent r3 = new com.android.server.audio.PlaybackActivityMonitor$PlayerEvent     // Catch:{ all -> 0x00a4 }
            r3.<init>(r8, r9)     // Catch:{ all -> 0x00a4 }
            r2.log(r3)     // Catch:{ all -> 0x00a4 }
            r2 = 2
            if (r9 != r2) goto L_0x0061
            java.util.ArrayList<java.lang.Integer> r3 = r7.mBannedUids     // Catch:{ all -> 0x00a4 }
            java.util.Iterator r3 = r3.iterator()     // Catch:{ all -> 0x00a4 }
        L_0x0027:
            boolean r4 = r3.hasNext()     // Catch:{ all -> 0x00a4 }
            if (r4 == 0) goto L_0x0061
            java.lang.Object r4 = r3.next()     // Catch:{ all -> 0x00a4 }
            java.lang.Integer r4 = (java.lang.Integer) r4     // Catch:{ all -> 0x00a4 }
            int r5 = r4.intValue()     // Catch:{ all -> 0x00a4 }
            boolean r5 = r7.checkBanPlayer(r1, r5)     // Catch:{ all -> 0x00a4 }
            if (r5 == 0) goto L_0x0060
            com.android.server.audio.AudioEventLogger r2 = sEventLogger     // Catch:{ all -> 0x00a4 }
            com.android.server.audio.AudioEventLogger$StringEvent r3 = new com.android.server.audio.AudioEventLogger$StringEvent     // Catch:{ all -> 0x00a4 }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x00a4 }
            r5.<init>()     // Catch:{ all -> 0x00a4 }
            java.lang.String r6 = "not starting piid:"
            r5.append(r6)     // Catch:{ all -> 0x00a4 }
            r5.append(r8)     // Catch:{ all -> 0x00a4 }
            java.lang.String r6 = " ,is banned"
            r5.append(r6)     // Catch:{ all -> 0x00a4 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x00a4 }
            r3.<init>(r5)     // Catch:{ all -> 0x00a4 }
            r2.log(r3)     // Catch:{ all -> 0x00a4 }
            monitor-exit(r0)     // Catch:{ all -> 0x00a4 }
            return
        L_0x0060:
            goto L_0x0027
        L_0x0061:
            int r3 = r1.getPlayerType()     // Catch:{ all -> 0x00a4 }
            r4 = 3
            if (r3 != r4) goto L_0x006a
            monitor-exit(r0)     // Catch:{ all -> 0x00a4 }
            return
        L_0x006a:
            boolean r3 = checkConfigurationCaller(r8, r1, r10)     // Catch:{ all -> 0x00a4 }
            if (r3 == 0) goto L_0x0078
            r7.checkVolumeForPrivilegedAlarm(r1, r9)     // Catch:{ all -> 0x00a4 }
            boolean r3 = r1.handleStateEvent(r9)     // Catch:{ all -> 0x00a4 }
            goto L_0x008f
        L_0x0078:
            java.lang.String r3 = "AudioService.PlaybackActivityMonitor"
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x00a4 }
            r4.<init>()     // Catch:{ all -> 0x00a4 }
            java.lang.String r5 = "Error handling event "
            r4.append(r5)     // Catch:{ all -> 0x00a4 }
            r4.append(r9)     // Catch:{ all -> 0x00a4 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x00a4 }
            android.util.Log.e(r3, r4)     // Catch:{ all -> 0x00a4 }
            r3 = 0
        L_0x008f:
            if (r3 == 0) goto L_0x0098
            if (r9 != r2) goto L_0x0098
            com.android.server.audio.PlaybackActivityMonitor$DuckingManager r2 = r7.mDuckingManager     // Catch:{ all -> 0x00a4 }
            r2.checkDuck(r1)     // Catch:{ all -> 0x00a4 }
        L_0x0098:
            monitor-exit(r0)     // Catch:{ all -> 0x00a4 }
        ...
        L_0x00a4:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.audio.PlaybackActivityMonitor.playerEvent(int, int, int):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0053, code lost:
        if (r4.mErrorCount >= 5) goto L_0x008d;
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void dispatchPlaybackChange(boolean r10) {
        /*
            r9 = this;
            java.util.ArrayList<com.android.server.audio.PlaybackActivityMonitor$PlayMonitorClient> r0 = r9.mClients
            monitor-enter(r0)
            java.util.ArrayList<com.android.server.audio.PlaybackActivityMonitor$PlayMonitorClient> r1 = r9.mClients     // Catch:{ all -> 0x0096 }
        ...
        L_0x000d:
            monitor-exit(r0)     // Catch:{ all -> 0x0096 }
            java.lang.Object r1 = r9.mPlayerLock
            monitor-enter(r1)
            java.util.HashMap<java.lang.Integer, android.media.AudioPlaybackConfiguration> r0 = r9.mPlayers     // Catch:{ all -> 0x0093 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x0093 }
            if (r0 == 0) goto L_0x001b
            monitor-exit(r1)     // Catch:{ all -> 0x0093 }
            return
        L_0x001b:
            java.util.ArrayList r0 = new java.util.ArrayList     // Catch:{ all -> 0x0093 }
            java.util.HashMap<java.lang.Integer, android.media.AudioPlaybackConfiguration> r2 = r9.mPlayers     // Catch:{ all -> 0x0093 }
            java.util.Collection r2 = r2.values()     // Catch:{ all -> 0x0093 }
            r0.<init>(r2)     // Catch:{ all -> 0x0093 }
            monitor-exit(r1)     // Catch:{ all -> 0x0093 }
            java.util.ArrayList<com.android.server.audio.PlaybackActivityMonitor$PlayMonitorClient> r2 = r9.mClients
            monitor-enter(r2)
            java.util.ArrayList<com.android.server.audio.PlaybackActivityMonitor$PlayMonitorClient> r1 = r9.mClients     // Catch:{ all -> 0x0090 }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x0090 }
            if (r1 == 0) goto L_0x0034
            monitor-exit(r2)     // Catch:{ all -> 0x0090 }
            return
        L_0x0034:
            boolean r1 = r9.mHasPublicClients     // Catch:{ all -> 0x0090 }
            if (r1 == 0) goto L_0x003d
            java.util.ArrayList r1 = r9.anonymizeForPublicConsumption(r0)     // Catch:{ all -> 0x0090 }
            goto L_0x003e
        L_0x003d:
            r1 = 0
        L_0x003e:
            java.util.ArrayList<com.android.server.audio.PlaybackActivityMonitor$PlayMonitorClient> r3 = r9.mClients     // Catch:{ all -> 0x0090 }
            java.util.Iterator r3 = r3.iterator()     // Catch:{ all -> 0x0090 }
        L_0x0044:
            boolean r4 = r3.hasNext()     // Catch:{ all -> 0x0090 }
            if (r4 == 0) goto L_0x008e
            java.lang.Object r4 = r3.next()     // Catch:{ all -> 0x0090 }
            com.android.server.audio.PlaybackActivityMonitor$PlayMonitorClient r4 = (com.android.server.audio.PlaybackActivityMonitor.PlayMonitorClient) r4     // Catch:{ all -> 0x0090 }
            int r5 = r4.mErrorCount     // Catch:{ RemoteException -> 0x0066 }
            r6 = 5
            if (r5 >= r6) goto L_0x0065
            boolean r5 = r4.mIsPrivileged     // Catch:{ RemoteException -> 0x0066 }
            if (r5 == 0) goto L_0x005f
            android.media.IPlaybackConfigDispatcher r5 = r4.mDispatcherCb     // Catch:{ RemoteException -> 0x0066 }
            r5.dispatchPlaybackConfigChange(r0, r10)     // Catch:{ RemoteException -> 0x0066 }
            goto L_0x0065
        L_0x005f:
            android.media.IPlaybackConfigDispatcher r5 = r4.mDispatcherCb     // Catch:{ RemoteException -> 0x0066 }
            r6 = 0
            r5.dispatchPlaybackConfigChange(r1, r6)     // Catch:{ RemoteException -> 0x0066 }
        L_0x0065:
            goto L_0x008d
        L_0x0066:
            r5 = move-exception
            int r6 = r4.mErrorCount     // Catch:{ all -> 0x0090 }
            int r6 = r6 + 1
            r4.mErrorCount = r6     // Catch:{ all -> 0x0090 }
            java.lang.String r6 = "AudioService.PlaybackActivityMonitor"
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ all -> 0x0090 }
            r7.<init>()     // Catch:{ all -> 0x0090 }
            java.lang.String r8 = "Error ("
            r7.append(r8)     // Catch:{ all -> 0x0090 }
            int r8 = r4.mErrorCount     // Catch:{ all -> 0x0090 }
            r7.append(r8)     // Catch:{ all -> 0x0090 }
            java.lang.String r8 = ") trying to dispatch playback config change to "
            r7.append(r8)     // Catch:{ all -> 0x0090 }
            r7.append(r4)     // Catch:{ all -> 0x0090 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0090 }
            android.util.Log.e(r6, r7, r5)     // Catch:{ all -> 0x0090 }
        L_0x008d:
            goto L_0x0044
        L_0x008e:
            monitor-exit(r2)     // Catch:{ all -> 0x0090 }
        ...
        L_0x0096:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.audio.PlaybackActivityMonitor.dispatchPlaybackChange(boolean):void");
    }
    ...
    public List<AudioPlaybackConfiguration> getActivePlaybackConfigurations(boolean isPrivileged) {
        ...
        List<AudioPlaybackConfiguration> configsPrivileged;
        synchronized (this.mPlayers) {
            if (isPrivileged) {
                synchronized (this.mPlayerLock) {
                    configsPrivileged = new ArrayList<>(this.mPlayers.values());
                }
                return configsPrivileged;
            }
            synchronized (this.mPlayerLock) {
