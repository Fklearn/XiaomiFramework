...
public final class AutoFillUI {
    ...
    public void showFillUi(AutofillId focusedId, FillResponse response, String filterText, String servicePackageName, ComponentName componentName, CharSequence serviceLabel, Drawable serviceIcon, AutoFillUiCallback callback, int sessionId, boolean compatMode) {
        ...
        $$Lambda$AutoFillUI$H0BWucCEHDp2_3FUpZ9CLDtxYQ r0 = new Runnable(callback, response, focusedId, filterText, serviceLabel, serviceIcon, log) {
            private final /* synthetic */ AutoFillUI.AutoFillUiCallback f$1;
    ...
    public /* synthetic */ void lambda$showFillUi$5$AutoFillUI(AutoFillUiCallback callback, FillResponse response, AutofillId focusedId, String filterText, CharSequence serviceLabel, Drawable serviceIcon, LogMaker log) {
        if (callback == this.mCallback) {
            ...
            FillUi fillUi = r8;
            FillUi fillUi2 = new FillUi(this.mContext, response, focusedId, filterText, this.mOverlayControl, serviceLabel, serviceIcon, this.mUiModeMgr.isNightMode(), new FillUi.Callback() {
    ...
    public void showSaveUi(CharSequence serviceLabel, Drawable serviceIcon, String servicePackageName, SaveInfo info, ValueFinder valueFinder, ComponentName componentName, AutoFillUiCallback callback, PendingUi pendingSaveUi, boolean isUpdate, boolean compatMode) {
        boolean z = isUpdate;
        if (Helper.sVerbose) {
            Slog.v(TAG, "showSaveUi(update=" + z + ") for " + componentName.toShortString() + ": " + info);
        } else {
        ...
        LogMaker log = Helper.newLogMaker(916, componentName2, servicePackageName, pendingSaveUi.sessionId, compatMode).addTaggedData(917, Integer.valueOf(numIds + i));
        if (z) {
            log.addTaggedData(1555, 1);
        }
        $$Lambda$AutoFillUI$_6s4RnleY3q9wMVHqQks_jl2KOA r13 = r0;
        Handler handler = this.mHandler;
        $$Lambda$AutoFillUI$_6s4RnleY3q9wMVHqQks_jl2KOA r0 = new Runnable(callback, pendingSaveUi, serviceLabel, serviceIcon, servicePackageName, componentName, info, valueFinder, log, isUpdate, compatMode) {
            private final /* synthetic */ AutoFillUI.AutoFillUiCallback f$1;
    ...
    public /* synthetic */ void lambda$showSaveUi$6$AutoFillUI(AutoFillUiCallback callback, PendingUi pendingSaveUi, CharSequence serviceLabel, Drawable serviceIcon, String servicePackageName, ComponentName componentName, SaveInfo info, ValueFinder valueFinder, LogMaker log, boolean isUpdate, boolean compatMode) {
        if (callback == this.mCallback) {
            lambda$hideAll$8$AutoFillUI(callback);
            ...
            this.mSaveUi = new SaveUi(this.mContext, pendingSaveUi, serviceLabel, serviceIcon, servicePackageName, componentName, info, valueFinder, this.mOverlayControl, new SaveUi.OnSaveListener() {
                ...
                public void onCancel(IntentSender listener) {
                    ...
                    if (listener != null) {
                        try {
                            listener.sendIntent(AutoFillUI.this.mContext, 0, (Intent) null, (IntentSender.OnFinished) null, (Handler) null);
