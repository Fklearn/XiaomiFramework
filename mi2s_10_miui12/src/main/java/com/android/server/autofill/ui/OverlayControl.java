...
class OverlayControl {
    ...
    private void setOverlayAllowed(boolean allowed) {
        ...
        if (appOpsManager != null) {
            appOpsManager.setUserRestrictionForUser(24, !allowed, this.mToken, (String[]) null, -1);
            this.mAppOpsManager.setUserRestrictionForUser(45, !allowed, this.mToken, (String[]) null, -1);
        }
    }
}
