...
public class BackupManagerService {
    ...
    private final BroadcastReceiver mUserRemovedReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            int userId;
            if ("android.intent.action.USER_REMOVED".equals(intent.getAction()) && (userId = intent.getIntExtra("android.intent.extra.user_handle", ScreenRotationAnimationInjector.BLACK_SURFACE_INVALID_POSITION)) > 0) {
    ...
    public static final class Lifecycle extends SystemService {
        ...
        /* JADX WARNING: type inference failed for: r0v0, types: [com.android.server.backup.Trampoline, android.os.IBinder] */
        public void onStart() {
    ...
    /* access modifiers changed from: package-private */
    public void cancelMiuiBackups(int userId) {
        UserBackupManagerService userBackupManagerService = getServiceForUserIfCallerHasPermission(userId, "cancelMiuiBackups()");
        if (userBackupManagerService != null) {
            userBackupManagerService.cancelMiuiBackups();
        }
    }
}
