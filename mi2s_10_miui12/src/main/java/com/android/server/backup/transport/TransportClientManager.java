...
public class TransportClientManager {
    ...
    private TransportClient getTransportClient(ComponentName transportComponent, String caller, Intent bindIntent) {
        ...
        synchronized (this.mTransportClientsLock) {
            ...
            TransportUtils.log(3, TAG, TransportUtils.formatMessage((String) null, caller, "Retrieving " + transportClient));
        }
    ...
    public void disposeOfTransportClient(TransportClient transportClient, String caller) {
        ...
        synchronized (this.mTransportClientsLock) {
            TransportUtils.log(3, TAG, TransportUtils.formatMessage((String) null, caller, "Disposing of " + transportClient));
