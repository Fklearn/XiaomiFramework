...
public class BiometricService extends SystemService {
    ...
    private final IBiometricServiceReceiverInternal mInternalReceiver = new IBiometricServiceReceiverInternal.Stub() {
        ...
        public void onAuthenticationFailed(int cookie, boolean requireConfirmation) throws RemoteException {
            BiometricService.this.mHandler.obtainMessage(3, BiometricService.this.getContext().getString(17039632)).sendToTarget();
        }
    ...
    private final class AuthSession implements IBinder.DeathRecipient {
        ...
        AuthSession(BiometricService biometricService, HashMap<Integer, Integer> modalities, IBinder token, long sessionId, int userId, IBiometricServiceReceiver receiver, String opPackageName, Bundle bundle, int callingUid, int callingPid, int callingUserId, int modality, boolean requireConfirmation, IBiometricConfirmDeviceCredentialCallback callback) {
    ...
    private final class BiometricServiceWrapper extends IBiometricService.Stub {
        ...
        public void authenticate(IBinder token, long sessionId, int userId, IBiometricServiceReceiver receiver, String opPackageName, Bundle bundle, IBiometricConfirmDeviceCredentialCallback callback) throws RemoteException {
            IBinder iBinder = token;
            int i = userId;
            IBiometricServiceReceiver iBiometricServiceReceiver = receiver;
            String str = opPackageName;
            Bundle bundle2 = bundle;
            IBiometricConfirmDeviceCredentialCallback iBiometricConfirmDeviceCredentialCallback = callback;
            ...
            if (i == callingUserId) {
                ...
                Slog.w(BiometricService.TAG, "User " + callingUserId + " is requesting authentication of userid: " + i);
                BiometricService.this.checkInternalPermission();
            }
            if (iBinder == null || iBiometricServiceReceiver == null || str == null || bundle2 == null) {
                Slog.e(BiometricService.TAG, "Unable to authenticate, one or more null arguments");
                return;
            }
            if (bundle2.getBoolean("from_confirm_device_credential", false)) {
                BiometricService.this.checkInternalPermission();
            }
            if (bundle2.getBoolean("use_default_title", false)) {
                BiometricService.this.checkInternalPermission();
                if (TextUtils.isEmpty(bundle2.getCharSequence("title"))) {
                    bundle2.putCharSequence("title", BiometricService.this.getContext().getString(17039627));
                }
            }
            if (bundle2.getBoolean("allow_device_credential")) {
                BiometricService.this.mHandler.post(new Runnable(iBiometricServiceReceiver, i, bundle2) {
            ...
            args.argi1 = i;
            args.arg3 = iBiometricServiceReceiver;
            args.arg4 = str;
            args.arg5 = bundle2;
            args.argi2 = callingUid;
            args.argi3 = callingPid;
            args.argi4 = callingUserId;
            args.arg6 = iBiometricConfirmDeviceCredentialCallback;
        ...
        public /* synthetic */ void lambda$authenticate$0$BiometricService$BiometricServiceWrapper(IBiometricServiceReceiver receiver, int userId, Bundle bundle) {
            ...
            if (!kgm.isDeviceSecure()) {
                try {
                    receiver.onError(14, BiometricService.this.getContext().getString(17039629));
                } catch (RemoteException e) {
                ...
                Intent intent = kgm.createConfirmDeviceCredentialIntent((CharSequence) null, (CharSequence) null, userId);
    ...
    /* JADX WARNING: type inference failed for: r0v8, types: [com.android.server.biometrics.BiometricService$BiometricServiceWrapper, android.os.IBinder] */
    public void onStart() {
        ...
        try {
            ...
            if (!runningTasks.isEmpty()) {
                ...
                if (this.mCurrentAuthSession != null && !topPackage.contentEquals(this.mCurrentAuthSession.mOpPackageName)) {
                    ...
                    this.mCurrentAuthSession.mClientReceiver.onError(5, getContext().getString(17039628));
    ...
    public void handleOnDismissed(int reason) {
        ...
        if (reason != 1) {
            try {
                ...
                cancelInternal((IBinder) null, (String) null, false);
            } catch (RemoteException e) {
                Slog.e(TAG, "Remote exception", e);
                return;
            }
        ...
        if (reason == 3) {
            this.mCurrentAuthSession.mClientReceiver.onError(10, getContext().getString(17039631));
        } else if (reason == 1) {
    ...
    public /* synthetic */ void lambda$handleAuthenticate$1$BiometricService(int userId, IBiometricServiceReceiver receiver, IBinder token, long sessionId, String opPackageName, Bundle bundle, int callingUid, int callingPid, int callingUserId, IBiometricConfirmDeviceCredentialCallback callback) {
        ...
        if (error != 0) {
            try {
                String hardwareUnavailable = getContext().getString(17039630);
                if (error == 1) {
                    iBiometricServiceReceiver.onError(error, hardwareUnavailable);
                } else if (error == 11) {
                    iBiometricServiceReceiver.onError(error, getErrorString(modality, error, 0));
                } else if (error != 12) {
    ...
    private void authenticateInternal(IBinder token, long sessionId, int userId, IBiometricServiceReceiver receiver, String opPackageName, Bundle bundle, int callingUid, int callingPid, int callingUserId, int modality, IBiometricConfirmDeviceCredentialCallback callback) {
        ...
        try {
            ...
            Slog.d(TAG, "Creating auth session. Modality: " + i + ", cookie: " + cookie);
            HashMap<Integer, Integer> authenticators = new HashMap<>();
            authenticators.put(Integer.valueOf(modality), Integer.valueOf(cookie));
            HashMap<Integer, Integer> hashMap = authenticators;
            IBinder iBinder = token;
            long j = sessionId;
            AuthSession authSession = r1;
            int i5 = userId;
            HashMap<Integer, Integer> hashMap2 = authenticators;
            IBiometricServiceReceiver iBiometricServiceReceiver = receiver;
            int cookie2 = cookie;
            ...
            String str3 = TAG;
            try {
                AuthSession authSession2 = new AuthSession(this, hashMap, iBinder, j, i5, iBiometricServiceReceiver, str2, bundle2, i6, i7, callingUserId, modality, requireConfirmation, callback);
            } catch (RemoteException e2) {
                e = e2;
                str = str3;
                Slog.e(str, "Unable to start authentication", e);
            ...
            try {
                this.mPendingAuthSession = authSession;
                int unused = this.mPendingAuthSession.mState = 1;
                if ((modality & 1) != 0) {
                    this.mFingerprintService.prepareForAuthentication(token, sessionId, userId, this.mInternalReceiver, opPackageName, cookie2, callingUid, callingPid, callingUserId);
                }
                if ((modality & 2) != 0) {
                    str = str3;
                    try {
                ...
                if ((modality & 4) != 0) {
                    this.mFaceService.prepareForAuthentication(requireConfirmation, token, sessionId, userId, this.mInternalReceiver, opPackageName, cookie2, callingUid, callingPid, callingUserId);
                }
    ...
    public void handleCancelAuthentication(IBinder token, String opPackageName) {
        ...
        if (authSession == null || authSession.mState != 6) {
            ...
            try {
                this.mCurrentAuthSession.mClientReceiver.onError(5, getContext().getString(17039631));
                int unused = this.mCurrentAuthSession.mState = 0;
                this.mCurrentAuthSession = null;
                this.mStatusBarService.hideBiometricDialog();
            } catch (RemoteException e) {
            ...
            handleOnConfirmDeviceCredentialError(5, getContext().getString(17039628));
        }
    }
