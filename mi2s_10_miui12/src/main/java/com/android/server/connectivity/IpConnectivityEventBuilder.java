...
public final class IpConnectivityEventBuilder {
    ...
    public static IpConnectivityLogClass.IpConnectivityEvent toProto(ConnectStats in) {
        ...
        IpConnectivityLogClass.IpConnectivityEvent out = buildEvent(in.netId, in.transports, (String) null);
    ...
    public static IpConnectivityLogClass.IpConnectivityEvent toProto(DefaultNetworkEvent in) {
        ...
        IpConnectivityLogClass.IpConnectivityEvent out = buildEvent(in.netId, (long) in.transports, (String) null);
        if (in.transports == 0) {
            out.linkLayer = 5;
        }
