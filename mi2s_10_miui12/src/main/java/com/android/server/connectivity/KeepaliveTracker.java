...
public class KeepaliveTracker {
    ...
    public KeepaliveTracker(Context context, Handler handler) {
        ...
        this.mReservedPrivilegedSlots = this.mContext.getResources().getInteger(17694880);
    ...
    public void startNattKeepalive(NetworkAgentInfo nai, FileDescriptor fd, int intervalSeconds, ISocketKeepaliveCallback cb, String srcAddrString, int srcPort, String dstAddrString, int dstPort) {
        ISocketKeepaliveCallback iSocketKeepaliveCallback = cb;
        if (nai == null) {
        ...
        try {
            try {
                try {
                    KeepaliveInfo keepaliveInfo = new KeepaliveInfo(cb, nai, NattKeepalivePacketData.nattKeepalivePacket(NetworkUtils.numericToInetAddress(srcAddrString), srcPort, NetworkUtils.numericToInetAddress(dstAddrString), 4500), intervalSeconds, 1, fd);
                ...
                notifyErrorCallback(iSocketKeepaliveCallback, e2.error);
            }
