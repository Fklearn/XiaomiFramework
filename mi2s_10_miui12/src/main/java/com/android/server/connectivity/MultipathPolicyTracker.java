...
public class MultipathPolicyTracker {
    ...
    public void start() {
        ...
        this.mContext.registerReceiverAsUser(this.mConfigChangeReceiver, UserHandle.ALL, intentFilter, (String) null, this.mHandler);
    }
    ...
    public long getDefaultDailyMultipathQuotaBytes() {
        ...
        return (long) this.mContext.getResources().getInteger(17694853);
    }
