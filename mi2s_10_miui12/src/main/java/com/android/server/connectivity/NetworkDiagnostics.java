    ...
    private class SimpleSocketCheck implements Closeable {
        ...
        protected SimpleSocketCheck(java.net.InetAddress r5, java.net.InetAddress r6, com.android.server.connectivity.NetworkDiagnostics.Measurement r7) {
            /*
                ...
                java.lang.Integer r1 = r4.mInterfaceIndex
                if (r1 == 0) goto L_0x0034
                r1 = 0
                byte[] r2 = r6.getAddress()     // Catch:{ UnknownHostException -> 0x002a }
                java.lang.Integer r4 = r4.mInterfaceIndex     // Catch:{ UnknownHostException -> 0x002a }
                int r4 = r4.intValue()     // Catch:{ UnknownHostException -> 0x002a }
                java.net.Inet6Address r4 = java.net.Inet6Address.getByAddress(r1, r2, r4)     // Catch:{ UnknownHostException -> 0x002a }
                goto L_0x0035
            L_0x002a:
                r4 = move-exception
        ...
        protected SimpleSocketCheck(NetworkDiagnostics networkDiagnostics, InetAddress target, Measurement measurement) {
            this((InetAddress) null, target, measurement);
        }
