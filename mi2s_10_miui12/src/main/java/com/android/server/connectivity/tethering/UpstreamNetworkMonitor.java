...
public class UpstreamNetworkMonitor {
    ...
    public void handleLost(Network network) {
        if (this.mNetworkMap.containsKey(network)) {
            notifyTarget(3, (Object) this.mNetworkMap.remove(network));
        }
    }
    ...
    private TypeStatePair findFirstAvailableUpstreamByType(Iterable<NetworkState> netStates, Iterable<Integer> preferredTypes, boolean isCellularUpstreamPermitted) {
