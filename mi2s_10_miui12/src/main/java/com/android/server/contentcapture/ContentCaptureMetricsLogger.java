...
public final class ContentCaptureMetricsLogger {
    ...
    public static void writeSessionFlush(int sessionId, ComponentName service, ComponentName app, FlushMetrics fm, ContentCaptureOptions options, int flushReason) {
        FlushMetrics flushMetrics = fm;
        ContentCaptureOptions contentCaptureOptions = options;
        StatsLog.write(209, sessionId, ComponentName.flattenToShortString(service), ComponentName.flattenToShortString(app), flushMetrics.sessionStarted, flushMetrics.sessionFinished, flushMetrics.viewAppearedCount, flushMetrics.viewDisappearedCount, flushMetrics.viewTextChangedCount, contentCaptureOptions.maxBufferSize, contentCaptureOptions.idleFlushingFrequencyMs, contentCaptureOptions.textChangeFlushingFrequencyMs, flushReason);
    }
}
