...
class AbUpdateInstaller extends UpdateInstaller {
    ...
    private void updatePropertiesForEntry(java.util.zip.ZipEntry r5) throws java.io.IOException {
        /*
            r4 = this;
            java.io.BufferedReader r0 = new java.io.BufferedReader
            java.io.InputStreamReader r1 = new java.io.InputStreamReader
            java.util.zip.ZipFile r2 = r4.mPackedUpdateFile
            java.io.InputStream r2 = r2.getInputStream(r5)
            r1.<init>(r2)
            r0.<init>(r1)
        L_0x0011:
            java.lang.String r1 = r0.readLine()     // Catch:{ all -> 0x0022 }
            r2 = r1
            if (r1 == 0) goto L_0x001e
            java.util.List<java.lang.String> r1 = r4.mProperties     // Catch:{ all -> 0x0022 }
            r1.add(r2)     // Catch:{ all -> 0x0022 }
            goto L_0x0011
        L_0x001e:
            r0.close()
            return
        ...
        L_0x002d:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.devicepolicy.AbUpdateInstaller.updatePropertiesForEntry(java.util.zip.ZipEntry):void");
    }
