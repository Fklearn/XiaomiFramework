...
class Owners {
    ...
    public void transferProfileOwner(ComponentName target, int userId) {
        synchronized (this.mLock) {
            ...
            arrayMap.put(valueOf, new OwnerInfo(target.getPackageName(), target, ownerInfo.userRestrictionsMigrated, ownerInfo.remoteBugreportUri, ownerInfo.remoteBugreportHash, ownerInfo.canAccessDeviceIds));
            pushToPackageManagerLocked();
            pushToAppOpsLocked();
        }
    }
    ...
    public void setProfileOwnerCanAccessDeviceIds(int userId) {
        synchronized (this.mLock) {
            ...
            if (profileOwner != null) {
                ...
                Slog.e(TAG, String.format("Cannot grant Device IDs access for user %d, no profile owner.", new Object[]{Integer.valueOf(userId)}));
            }
            writeProfileOwner(userId);
        }
    }
                ...
                while (true) {
                    ...
                    if (next == 1) {
                        ...
                        if (tag.equals(TAG_DEVICE_OWNER)) {
                            this.mDeviceOwner = new OwnerInfo(parser.getAttributeValue((String) null, "name"), parser.getAttributeValue((String) null, "package"), false, (String) null, (String) null, true);
                            this.mDeviceOwnerUserId = 0;
                        } else if (!tag.equals(TAG_DEVICE_INITIALIZER)) {
                            if (tag.equals(TAG_PROFILE_OWNER)) {
                                String profileOwnerPackageName = parser.getAttributeValue((String) null, "package");
                                String profileOwnerName = parser.getAttributeValue((String) null, "name");
                                String profileOwnerComponentStr = parser.getAttributeValue((String) null, ATTR_COMPONENT_NAME);
                                int userId = Integer.parseInt(parser.getAttributeValue((String) null, ATTR_USERID));
        ...
        public void writeToFileLocked() {
            if (shouldWrite()) {
                ...
                try {
                    ...
                    out.startTag((String) null, Owners.TAG_ROOT);
                    writeInner(out);
                    out.endTag((String) null, Owners.TAG_ROOT);
                    out.endDocument();
                    out.flush();
    ...
    private class DeviceOwnerReadWriter extends FileReadWriter {
        ...
        public void writeInner(XmlSerializer out) throws IOException {
            if (Owners.this.mDeviceOwner != null) {
                ...
                out.startTag((String) null, Owners.TAG_DEVICE_OWNER_CONTEXT);
                out.attribute((String) null, Owners.ATTR_USERID, String.valueOf(Owners.this.mDeviceOwnerUserId));
                out.endTag((String) null, Owners.TAG_DEVICE_OWNER_CONTEXT);
            }
            if (Owners.this.mSystemUpdatePolicy != null) {
                out.startTag((String) null, Owners.TAG_SYSTEM_UPDATE_POLICY);
                Owners.this.mSystemUpdatePolicy.saveToXml(out);
                out.endTag((String) null, Owners.TAG_SYSTEM_UPDATE_POLICY);
            }
            ...
            if (Owners.this.mSystemUpdateFreezeStart != null || Owners.this.mSystemUpdateFreezeEnd != null) {
                out.startTag((String) null, Owners.TAG_FREEZE_PERIOD_RECORD);
                if (Owners.this.mSystemUpdateFreezeStart != null) {
                    out.attribute((String) null, Owners.ATTR_FREEZE_RECORD_START, Owners.this.mSystemUpdateFreezeStart.toString());
                }
                if (Owners.this.mSystemUpdateFreezeEnd != null) {
                    out.attribute((String) null, Owners.ATTR_FREEZE_RECORD_END, Owners.this.mSystemUpdateFreezeEnd.toString());
                }
                out.endTag((String) null, Owners.TAG_FREEZE_PERIOD_RECORD);
            }
        }
        ...
        public boolean readInner(XmlPullParser parser, int depth, String tag) {
            ...
            if (c == 0) {
                ...
                String userIdString = parser.getAttributeValue((String) null, Owners.ATTR_USERID);
                try {
                ...
                if (c == 3) {
                    ...
                    String startDate = parser.getAttributeValue((String) null, Owners.ATTR_FREEZE_RECORD_START);
                    String endDate = parser.getAttributeValue((String) null, Owners.ATTR_FREEZE_RECORD_END);
    ...
    static class OwnerInfo {
        ...
        public void writeToXml(XmlSerializer out, String tag) throws IOException {
            ...
            out.attribute((String) null, "package", this.packageName);
            ...
            if (componentName != null) {
                out.attribute((String) null, Owners.ATTR_COMPONENT_NAME, componentName.flattenToString());
            }
            out.attribute((String) null, Owners.ATTR_USER_RESTRICTIONS_MIGRATED, String.valueOf(this.userRestrictionsMigrated));
            String str2 = this.remoteBugreportUri;
            if (str2 != null) {
                out.attribute((String) null, Owners.ATTR_REMOTE_BUGREPORT_URI, str2);
            }
            String str3 = this.remoteBugreportHash;
            if (str3 != null) {
                out.attribute((String) null, Owners.ATTR_REMOTE_BUGREPORT_HASH, str3);
            }
            boolean z = this.canAccessDeviceIds;
            if (z) {
                out.attribute((String) null, Owners.ATTR_CAN_ACCESS_DEVICE_IDS, String.valueOf(z));
            }
        ...
        public static OwnerInfo readFromXml(XmlPullParser parser) {
            ...
            String packageName2 = xmlPullParser.getAttributeValue((String) null, "package");
            String name2 = xmlPullParser.getAttributeValue((String) null, "name");
            String componentName = xmlPullParser.getAttributeValue((String) null, Owners.ATTR_COMPONENT_NAME);
            boolean userRestrictionsMigrated2 = "true".equals(xmlPullParser.getAttributeValue((String) null, Owners.ATTR_USER_RESTRICTIONS_MIGRATED));
            String remoteBugreportUri2 = xmlPullParser.getAttributeValue((String) null, Owners.ATTR_REMOTE_BUGREPORT_URI);
            String remoteBugreportHash2 = xmlPullParser.getAttributeValue((String) null, Owners.ATTR_REMOTE_BUGREPORT_HASH);
            boolean canAccessDeviceIds2 = "true".equals(xmlPullParser.getAttributeValue((String) null, Owners.ATTR_CAN_ACCESS_DEVICE_IDS));
            if (componentName != null) {
