...
class SecurityLogMonitor implements Runnable {
        ...
        try {
            if (!this.mPaused) {
                ...
                if (allowRetrievalAndNotifyDO) {
                    ...
                    this.mService.sendDeviceOwnerCommand("android.app.action.SECURITY_LOGS_AVAILABLE", (Bundle) null);
                }
            }
        } finally {
            this.mLock.unlock();
    ...
    public long forceLogs() {
        /*
            ...
            java.util.concurrent.Semaphore r2 = r9.mForceSemaphore
            monitor-enter(r2)
            long r3 = r9.mLastForceNanos     // Catch:{ all -> 0x002f }
            long r5 = FORCE_FETCH_THROTTLE_NS     // Catch:{ all -> 0x002f }
            long r3 = r3 + r5
            long r3 = r3 - r0
            r5 = 0
            int r7 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r7 <= 0) goto L_0x001e
            java.util.concurrent.TimeUnit r5 = java.util.concurrent.TimeUnit.NANOSECONDS     // Catch:{ all -> 0x002f }
            long r5 = r5.toMillis(r3)     // Catch:{ all -> 0x002f }
            r7 = 1
            long r5 = r5 + r7
            monitor-exit(r2)     // Catch:{ all -> 0x002f }
            return r5
        L_0x001e:
            r9.mLastForceNanos = r0     // Catch:{ all -> 0x002f }
            java.util.concurrent.Semaphore r7 = r9.mForceSemaphore     // Catch:{ all -> 0x002f }
            int r7 = r7.availablePermits()     // Catch:{ all -> 0x002f }
            if (r7 != 0) goto L_0x002d
            java.util.concurrent.Semaphore r7 = r9.mForceSemaphore     // Catch:{ all -> 0x002f }
            r7.release()     // Catch:{ all -> 0x002f }
        L_0x002d:
            monitor-exit(r2)     // Catch:{ all -> 0x002f }
            return r5
        L_0x002f:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.devicepolicy.SecurityLogMonitor.forceLogs():long");
    }
}
