...
abstract class DisplayDevice {
    ...
    public final void setDiffScreenProjection(SurfaceControl.Transaction t, boolean isScreenProjection) {
        t.setDiffScreenProjection(this.mDisplayToken, isScreenProjection);
    }
