    ...
    private static class SaturationController {
        ...
        private boolean updateState() {
            ...
            while (iterator.hasNext()) {
                ColorDisplayService.ColorTransformController controller = (ColorDisplayService.ColorTransformController) iterator.next().get();
                if (controller != null) {
        ...
        private void clearExpiredReferences() {
            Iterator<WeakReference<ColorDisplayService.ColorTransformController>> iterator = this.mControllerRefs.iterator();
            while (iterator.hasNext()) {
                if (((ColorDisplayService.ColorTransformController) iterator.next().get()) == null) {
                    iterator.remove();
                }
            }
        }
