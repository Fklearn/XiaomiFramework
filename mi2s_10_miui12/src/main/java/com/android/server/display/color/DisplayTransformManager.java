...
public class DisplayTransformManager {
    ...
    private static void applyColorMatrix(float[] m) {
        ...
        if (flinger != null) {
            ...
            try {
                flinger.transact(SURFACE_FLINGER_TRANSACTION_COLOR_MATRIX, data, (Parcel) null, 0);
    ...
    private static void applyDaltonizerMode(int mode) {
        ...
        if (flinger != null) {
            ...
            data.writeInt(mode);
            try {
                flinger.transact(SURFACE_FLINGER_TRANSACTION_DALTONIZER, data, (Parcel) null, 0);
            } catch (RemoteException ex) {
    ...
    private void applySaturation(float saturation) {
        ...
        if (flinger != null) {
            ...
            try {
                flinger.transact(SURFACE_FLINGER_TRANSACTION_SATURATION, data, (Parcel) null, 0);
            } catch (RemoteException ex) {
