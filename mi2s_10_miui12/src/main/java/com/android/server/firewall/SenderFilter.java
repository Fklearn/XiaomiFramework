...
class SenderFilter {
    ...
    public static final FilterFactory FACTORY = new FilterFactory("sender") {
        public Filter newFilter(XmlPullParser parser) throws IOException, XmlPullParserException {
            String typeString = parser.getAttributeValue((String) null, "type");
            if (typeString == null) {
                throw new XmlPullParserException("type attribute must be specified for <sender>", parser, (Throwable) null);
                ...
                throw new XmlPullParserException("Invalid type attribute for <sender>: " + typeString, parser, (Throwable) null);
            }
        }
    };
    ...
    public static final Filter USER_ID = new Filter() {
        public boolean matches(IntentFirewall ifw, ComponentName resolvedComponent, Intent intent, int callerUid, int callerPid, String resolvedType, int receivingUid) {
            return ifw.checkComponentPermission((String) null, callerPid, callerUid, receivingUid, false);
        }
    };
