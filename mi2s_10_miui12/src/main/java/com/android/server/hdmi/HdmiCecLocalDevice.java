...
abstract class HdmiCecLocalDevice {
    ...
    static class ActiveSource {
        ...
        public String toString() {
            ...
            if (i == -1) {
                ...
                logicalAddressString = String.format("0x%02x", new Object[]{Integer.valueOf(i)});
            }
            s.append("(");
            s.append(logicalAddressString);
            int i2 = this.physicalAddress;
            if (i2 != 65535) {
                physicalAddressString = String.format("0x%04x", new Object[]{Integer.valueOf(i2)});
            }
            s.append(", ");
                ...
                switch (opcode) {
                    ...
                    default:
                        switch (opcode) {
                            ...
                            case MiuiSecurityInputMethodHelper.TEXT_PASSWORD /*129*/:
                                return handleRoutingInformation(message);
                            case 130:
                                return handleActiveSource(message);
                            case 131:
                                return handleGivePhysicalAddress((HdmiControlService.SendMessageCallback) null);
                            case 132:
                            ...
                            default:
                                switch (opcode) {
                                    case 140:
                                        return handleGiveDeviceVendorId((HdmiControlService.SendMessageCallback) null);
                                    case 141:
    ...
    static void injectKeyEvent(long time, int action, int keycode, int repeat) {
        KeyEvent keyEvent = KeyEvent.obtain(time, time, action, keycode, repeat, 0, -1, 0, 8, 33554433, (String) null);
    ...
    public <T extends HdmiCecFeatureAction> void removeAction(Class<T> clazz) {
        assertRunOnServiceThread();
        removeActionExcept(clazz, (HdmiCecFeatureAction) null);
    }
