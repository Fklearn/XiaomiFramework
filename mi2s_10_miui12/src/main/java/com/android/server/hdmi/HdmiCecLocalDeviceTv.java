...
final class HdmiCecLocalDeviceTv extends HdmiCecLocalDevice {
    ...
    public boolean handleActiveSource(HdmiCecMessage message) {
        ...
        if (info == null) {
            ...
            ActiveSourceHandler.create(this, (IHdmiControlCallback) null).process(HdmiCecLocalDevice.ActiveSource.of(logicalAddress, physicalAddress), info.getDeviceType());
        } else {
    ...
    public boolean handleInactiveSource(HdmiCecMessage message) {
        ...
        if (portId != -1) {
            ...
            doManualPortSwitching(portId, (IHdmiControlCallback) null);
            setPrevPortId(-1);
        } else {
            getActiveSource().invalidate();
            setActivePath(65535);
    ...
    private boolean handleNewDeviceAtTheTailOfActivePath(int path) {
        ...
        startRoutingControl(getActivePath(), newPath, false, (IHdmiControlCallback) null);
        return true;
    }
    ...
    public boolean handleRoutingChange(HdmiCecMessage message) {
        ...
        if (HdmiUtils.isAffectingActiveRoutingPath(getActivePath(), HdmiUtils.twoBytesToInt(params))) {
            getActiveSource().invalidate();
            removeAction(RoutingControlAction.class);
            addAndStartAction(new RoutingControlAction(this, HdmiUtils.twoBytesToInt(params, 2), true, (IHdmiControlCallback) null));
        }
        return true;
    }
    ...
    public boolean handleSetOsdName(HdmiCecMessage message) {
        HdmiCecMessage hdmiCecMessage = message;
    ...
    public void setSystemAudioControlFeatureEnabled(boolean enabled) {
        ...
        if (hasSystemAudioDevice()) {
            changeSystemAudioMode(enabled, (IHdmiControlCallback) null);
        }
    }
    ...
    private void notifyArcStatusToAudioService(boolean enabled) {
        this.mService.getAudioManager().setWiredDeviceConnectionState(DumpState.DUMP_DOMAIN_PREFERRED, enabled, "", "");
    }
    ...
    public void changeVolume(int r8, int r9, int r10) {
        /*
            r7 = this;
            r7.assertRunOnServiceThread()
            android.hardware.hdmi.HdmiDeviceInfo r0 = r7.getAvrDeviceInfo()
            if (r0 != 0) goto L_0x000a
            return
        L_0x000a:
            if (r9 == 0) goto L_0x0060
            boolean r0 = r7.isSystemAudioActivated()
            if (r0 != 0) goto L_0x0013
            goto L_0x0060
        L_0x0013:
            int r0 = r8 + r9
            int r1 = com.android.server.hdmi.VolumeControlAction.scaleToCecVolume(r0, r10)
            java.lang.Object r2 = r7.mLock
            monitor-enter(r2)
            int r3 = r7.mSystemAudioVolume     // Catch:{ all -> 0x005d }
            r4 = 0
            if (r1 != r3) goto L_0x002e
            com.android.server.hdmi.HdmiControlService r3 = r7.mService     // Catch:{ all -> 0x005d }
            int r5 = r7.mSystemAudioVolume     // Catch:{ all -> 0x005d }
            int r5 = com.android.server.hdmi.VolumeControlAction.scaleToCustomVolume(r5, r10)     // Catch:{ all -> 0x005d }
            r3.setAudioStatus(r4, r5)     // Catch:{ all -> 0x005d }
            monitor-exit(r2)     // Catch:{ all -> 0x005d }
            return
        L_0x002e:
            monitor-exit(r2)     // Catch:{ all -> 0x005d }
            java.lang.Class<com.android.server.hdmi.VolumeControlAction> r2 = com.android.server.hdmi.VolumeControlAction.class
            java.util.List r2 = r7.getActions(r2)
            boolean r3 = r2.isEmpty()
            r5 = 1
            if (r3 == 0) goto L_0x0050
            com.android.server.hdmi.VolumeControlAction r3 = new com.android.server.hdmi.VolumeControlAction
            android.hardware.hdmi.HdmiDeviceInfo r6 = r7.getAvrDeviceInfo()
            int r6 = r6.getLogicalAddress()
            if (r9 <= 0) goto L_0x0049
            r4 = r5
        L_0x0049:
            r3.<init>(r7, r6, r4)
            r7.addAndStartAction(r3)
            goto L_0x005c
        L_0x0050:
            java.lang.Object r3 = r2.get(r4)
            com.android.server.hdmi.VolumeControlAction r3 = (com.android.server.hdmi.VolumeControlAction) r3
            if (r9 <= 0) goto L_0x0059
            r4 = r5
        L_0x0059:
            r3.handleVolumeChange(r4)
        ...
        L_0x0060:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.hdmi.HdmiCecLocalDeviceTv.changeVolume(int, int, int):void");
    }
    ...
    @com.android.server.hdmi.HdmiAnnotations.ServiceThreadOnly
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void changeMute(boolean r4) {
        /*
            r3 = this;
            r3.assertRunOnServiceThread()
            android.hardware.hdmi.HdmiDeviceInfo r0 = r3.getAvrDeviceInfo()
            if (r0 != 0) goto L_0x000a
            return
        L_0x000a:
            r0 = 1
            ...
            r2 = 0
            r0[r2] = r1
            java.lang.String r1 = "[A]:Change mute:%b"
            com.android.server.hdmi.HdmiLogger.debug(r1, r0)
            java.lang.Object r0 = r3.mLock
            monitor-enter(r0)
            boolean r1 = r3.mSystemAudioMute     // Catch:{ all -> 0x004d }
            if (r1 != r4) goto L_0x0029
            java.lang.String r1 = "No need to change mute."
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ all -> 0x004d }
            com.android.server.hdmi.HdmiLogger.debug(r1, r2)     // Catch:{ all -> 0x004d }
            monitor-exit(r0)     // Catch:{ all -> 0x004d }
            return
        L_0x0029:
            monitor-exit(r0)     // Catch:{ all -> 0x004d }
            boolean r0 = r3.isSystemAudioActivated()
            if (r0 != 0) goto L_0x0038
            java.lang.Object[] r0 = new java.lang.Object[r2]
            java.lang.String r1 = "[A]:System audio is not activated."
            com.android.server.hdmi.HdmiLogger.debug(r1, r0)
            return
        L_0x0038:
            java.lang.Class<com.android.server.hdmi.VolumeControlAction> r0 = com.android.server.hdmi.VolumeControlAction.class
            r3.removeAction(r0)
            android.hardware.hdmi.HdmiDeviceInfo r0 = r3.getAvrDeviceInfo()
            int r0 = r0.getLogicalAddress()
            int r1 = com.android.server.hdmi.HdmiCecKeycode.getMuteKey(r4)
            r3.sendUserControlPressedAndReleased(r0, r1)
            return
        L_0x004d:
            r1 = move-exception
            monitor-exit(r0)     // Catch:{ all -> 0x004d }
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.hdmi.HdmiCecLocalDeviceTv.changeMute(boolean):void");
    }
    ...
    public boolean handleSetSystemAudioMode(HdmiCecMessage message) {
        ...
        if (!isMessageForSystemAudio(message)) {
            ...
            addAndStartAction(new SystemAudioActionFromAvr(this, message.getSource(), systemAudioStatus, (IHdmiControlCallback) null));
            return true;
        } else {
    ...
    public void handleRemoveActiveRoutingPath(int path) {
        assertRunOnServiceThread();
        if (isTailOfActivePath(path, getActivePath())) {
            startRoutingControl(getActivePath(), this.mService.portIdToPath(getActivePortId()), true, (IHdmiControlCallback) null);
        }
    }
    ...
    public void launchRoutingControl(boolean routingForBootup) {
        ...
        if (getActivePortId() == -1) {
            ...
            int newPath = this.mService.portIdToPath(getActivePortId());
            setActivePath(newPath);
            startRoutingControl(getActivePath(), newPath, routingForBootup, (IHdmiControlCallback) null);
        }
    }
