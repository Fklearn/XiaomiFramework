...
public class IncidentCompanionService extends SystemService {
    ...
    private final class BinderService extends IIncidentCompanion.Stub {
        ...
        public List<String> getIncidentReportList(String pkg, String cls) throws RemoteException {
            enforceAccessReportsPermissions((String) null);
            long ident = Binder.clearCallingIdentity();
            try {
        ...
        private void dumpRestrictedImages(FileDescriptor fd) {
            if (Build.IS_ENG || Build.IS_USERDEBUG) {
                for (String name : IncidentCompanionService.this.getContext().getResources().getStringArray(17236055)) {
        ...
        private void enforceRequestAuthorizationPermission() {
            IncidentCompanionService.this.getContext().enforceCallingOrSelfPermission("android.permission.REQUEST_INCIDENT_REPORT_APPROVAL", (String) null);
        }

        private void enforceAuthorizePermission() {
            IncidentCompanionService.this.getContext().enforceCallingOrSelfPermission("android.permission.APPROVE_INCIDENT_REPORTS", (String) null);
        }
        ...
        private void enforceAccessReportsPermissions(String pkg) {
            if (IncidentCompanionService.this.getContext().checkCallingPermission("android.permission.APPROVE_INCIDENT_REPORTS") != 0) {
                IncidentCompanionService.this.getContext().enforceCallingOrSelfPermission("android.permission.DUMP", (String) null);
                IncidentCompanionService.this.getContext().enforceCallingOrSelfPermission("android.permission.PACKAGE_USAGE_STATS", (String) null);
                if (pkg != null) {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.android.server.incident.IncidentCompanionService$BinderService, android.os.IBinder] */
    public void onStart() {
