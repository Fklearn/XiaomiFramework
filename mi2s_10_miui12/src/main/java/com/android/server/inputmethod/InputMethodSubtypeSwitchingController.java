        ...
        public List<ImeSubtypeListItem> getSortedInputMethodAndSubtypeList(boolean includeAuxiliarySubtypes, boolean isScreenLocked) {
            ...
            while (i < numImes) {
                ...
                for (InputMethodSubtype subtype : explicitlyOrImplicitlyEnabledSubtypeList) {
                    arraySet.add(String.valueOf(subtype.hashCode()));
                }
                ...
                if (arraySet.size() > 0) {
                    ...
                    while (j2 < subtypeCount2) {
                        ...
                        if (!arraySet.contains(subtypeHashCode)) {
                            imis2 = imis3;
                            includeAuxiliarySubtypes4 = includeAuxiliarySubtypes2;
                            String str = subtypeHashCode;
                            ...
                            includeAuxiliarySubtypes4 = includeAuxiliarySubtypes2;
                            InputMethodSubtype inputMethodSubtype2 = subtype2;
                            int i2 = j2;
                            j = j2;
                            String str2 = locale;
                            subtypeCount = subtypeCount2;
                            ImeSubtypeListItem imeSubtypeListItem2 = new ImeSubtypeListItem(imeLabel, subtypeLabel, imi, i2, str2, this.mSystemLocaleStr);
                            imList.add(imeSubtypeListItem);
                            arraySet.remove(subtypeHashCode);
                        } else {
                            imis2 = imis3;
                            includeAuxiliarySubtypes4 = includeAuxiliarySubtypes2;
                            j = j2;
                    ...
                    int i3 = j2;
                    int i4 = subtypeCount2;
                } else {
                    imis = imis3;
                    includeAuxiliarySubtypes3 = includeAuxiliarySubtypes2;
                    imList.add(new ImeSubtypeListItem(imeLabel, (CharSequence) null, imi, -1, (String) null, this.mSystemLocaleStr));
                }
                i++;
