...
public final class InputMethodUtils {
    ...
    static java.util.ArrayList<android.view.inputmethod.InputMethodSubtype> getImplicitlyApplicableSubtypesLocked(android.content.res.Resources r4, android.view.inputmethod.InputMethodInfo r5) {
        /*
            android.content.res.Configuration r0 = r4.getConfiguration()
            android.os.LocaleList r0 = r0.getLocales()
            java.lang.Object r1 = sCacheLock
            monitor-enter(r1)
            android.os.LocaleList r2 = sCachedSystemLocales     // Catch:{ all -> 0x0039 }
            boolean r2 = r0.equals(r2)     // Catch:{ all -> 0x0039 }
            if (r2 == 0) goto L_0x0020
            android.view.inputmethod.InputMethodInfo r2 = sCachedInputMethodInfo     // Catch:{ all -> 0x0039 }
            if (r2 != r5) goto L_0x0020
            java.util.ArrayList r2 = new java.util.ArrayList     // Catch:{ all -> 0x0039 }
            java.util.ArrayList<android.view.inputmethod.InputMethodSubtype> r3 = sCachedResult     // Catch:{ all -> 0x0039 }
            r2.<init>(r3)     // Catch:{ all -> 0x0039 }
            monitor-exit(r1)     // Catch:{ all -> 0x0039 }
            return r2
        L_0x0020:
            monitor-exit(r1)     // Catch:{ all -> 0x0039 }
            java.util.ArrayList r2 = getImplicitlyApplicableSubtypesLockedImpl(r4, r5)
            java.lang.Object r3 = sCacheLock
            monitor-enter(r3)
            sCachedSystemLocales = r0     // Catch:{ all -> 0x0036 }
            sCachedInputMethodInfo = r5     // Catch:{ all -> 0x0036 }
            java.util.ArrayList r1 = new java.util.ArrayList     // Catch:{ all -> 0x0036 }
            r1.<init>(r2)     // Catch:{ all -> 0x0036 }
            sCachedResult = r1     // Catch:{ all -> 0x0036 }
        ...
        L_0x0039:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.inputmethod.InputMethodUtils.getImplicitlyApplicableSubtypesLocked(android.content.res.Resources, android.view.inputmethod.InputMethodInfo):java.util.ArrayList");
    }
    ...
    public static class InputMethodSettings {
        ...
        public void putEnabledInputMethodsStr(String str) {
            if (TextUtils.isEmpty(str)) {
                putString("enabled_input_methods", (String) null);
            } else {
        ...
        public String getEnabledInputMethodsStr() {
            ...
            String str = this.mEnabledInputMethodsStrCache;
            if (str != null) {
                return str;
            }
            return "";
        ...
        private void putSubtypeHistoryStr(String str) {
            if (TextUtils.isEmpty(str)) {
                putString("input_methods_subtype_history", (String) null);
            } else {
        ...
        public String getSelectedInputMethod() {
            return getString("default_input_method", (String) null);
        }
