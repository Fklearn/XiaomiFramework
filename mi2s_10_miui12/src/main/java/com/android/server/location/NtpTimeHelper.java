    ...
    public void blockingGetNtpTimeAndInject() {
        ...
        synchronized (this) {
            ...
            if (this.mNtpTime.getCacheAge() < 86400000) {
                ...
                $$Lambda$NtpTimeHelper$xPxgficKWFyuwUj60WMuiGEEjdg r0 = r1;
                long j = certainty;
                $$Lambda$NtpTimeHelper$xPxgficKWFyuwUj60WMuiGEEjdg r1 = new Runnable(time, timeReference, certainty) {
            ...
            if (DEBUG) {
                Log.d("NtpTimeHelper", String.format("onDemandTimeInjection=%s, refreshSuccess=%s, delay=%s", new Object[]{Boolean.valueOf(this.mOnDemandTimeInjection), Boolean.valueOf(refreshSuccess), Long.valueOf(delay)}));
            }
