...
public class LockSettingsStrongAuth {
    ...
    public void handleScheduleStrongAuthTimeout(int userId) {
        long when = SystemClock.elapsedRealtime() + ((DevicePolicyManager) this.mContext.getSystemService("device_policy")).getRequiredStrongAuthTimeout((ComponentName) null, userId);
