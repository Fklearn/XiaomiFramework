...
public class RecoverableKeyStoreManager {
        ...
        synchronized (RecoverableKeyStoreManager.class) {
            if (mInstance == null) {
                ...
                try {
                    ...
                    RecoverableKeyStoreDb recoverableKeyStoreDb = db;
                    RecoverySnapshotStorage recoverySnapshotStorage = snapshotStorage;
                    ApplicationKeyStorage applicationKeyStorage2 = applicationKeyStorage;
                    mInstance = new RecoverableKeyStoreManager(context.getApplicationContext(), recoverableKeyStoreDb, new RecoverySessionStorage(), Executors.newSingleThreadExecutor(), recoverySnapshotStorage, new RecoverySnapshotListenersStorage(), platformKeyManager, applicationKeyStorage2, new TestOnlyInsecureCertificateHelper(), CleanupManager.getInstance(context.getApplicationContext(), snapshotStorage, db, applicationKeyStorage));
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (updatedCertPathRows > 0) {
                                    ...
                                    X509Certificate x509Certificate = rootCert;
                                    try {
                                    ...
                                    X509Certificate x509Certificate2 = rootCert;
                                    if (updatedCertPathRows < 0) {
                                ...
                                X509Certificate x509Certificate3 = rootCert;
                                Log.e(TAG, "Failed to encode CertPath", e);
                                throw new ServiceSpecificException(25, e.getMessage());
                            }
                            ...
                            X509Certificate x509Certificate4 = rootCert;
    ...
    public String generateKey(String alias) throws RemoteException {
        return generateKeyWithMetadata(alias, (byte[]) null);
    }
    ...
    public String importKey(String alias, byte[] keyBytes) throws RemoteException {
        return importKeyWithMetadata(alias, keyBytes, (byte[]) null);
    }
