...
public final class MediaRouterService extends IMediaRouterService.Stub implements Watchdog.Monitor {
    ...
    public MediaRouterService(Context context) {
        ...
        context2.registerReceiverAsUser(this.mReceiver, UserHandle.ALL, new IntentFilter("android.bluetooth.a2dp.profile.action.ACTIVE_DEVICE_CHANGED"), (String) null, (Handler) null);
    }
    ...
    private void registerClientLocked(IMediaRouterClient client, int uid, int pid, String packageName, int userId, boolean trusted) {
        ...
        if (this.mAllClientRecords.get(binder) == null) {
            UserRecord userRecord2 = this.mUserRecords.get(i);
            if (userRecord2 == null) {
                newUser = true;
    ...
    static final class UserHandler extends Handler implements RemoteDisplayProviderWatcher.Callback, RemoteDisplayProviderProxy.Callback {
        ...
        private void unselectSelectedRoute() {
            if (this.mSelectedRouteRecord != null) {
                ...
                this.mSelectedRouteRecord.getProvider().setSelectedDisplay((String) null);
        ...
        public void addProvider(RemoteDisplayProviderProxy provider) {
            ...
            provider.setSelectedDisplay((String) null);
        ...
        public void removeProvider(RemoteDisplayProviderProxy provider) {
            ...
            if (index >= 0) {
                this.mProviderRecords.remove(index).updateDescriptor((RemoteDisplayState) null);
                provider.setCallback((RemoteDisplayProviderProxy.Callback) null);
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:?, code lost:
            r8.mTempClients.get(r2).onSelectedRouteChanged(r0);
         */
        ...
        private void updateSelectedRoute(java.lang.String r9) {
            /*
                r8 = this;
                r0 = 0
                com.android.server.media.MediaRouterService r1 = r8.mService     // Catch:{ all -> 0x006e }
                java.lang.Object r1 = r1.mLock     // Catch:{ all -> 0x006e }
                monitor-enter(r1)     // Catch:{ all -> 0x006e }
                com.android.server.media.MediaRouterService$UserRecord r2 = r8.mUserRecord     // Catch:{ all -> 0x006b }
                android.util.ArrayMap r2 = r2.mClientGroupMap     // Catch:{ all -> 0x006b }
                java.lang.Object r2 = r2.get(r9)     // Catch:{ all -> 0x006b }
                com.android.server.media.MediaRouterService$ClientGroup r2 = (com.android.server.media.MediaRouterService.ClientGroup) r2     // Catch:{ all -> 0x006b }
                if (r2 != 0) goto L_0x001d
                monitor-exit(r1)     // Catch:{ all -> 0x006b }
                java.util.ArrayList<android.media.IMediaRouterClient> r1 = r8.mTempClients
                r1.clear()
                return
            L_0x001d:
                java.lang.String r3 = r2.mSelectedRouteId     // Catch:{ all -> 0x006b }
                r0 = r3
                java.util.List<com.android.server.media.MediaRouterService$ClientRecord> r3 = r2.mClientRecords     // Catch:{ all -> 0x006b }
                int r3 = r3.size()     // Catch:{ all -> 0x006b }
                r4 = 0
            L_0x0027:
                if (r4 >= r3) goto L_0x0043
                java.util.List<com.android.server.media.MediaRouterService$ClientRecord> r5 = r2.mClientRecords     // Catch:{ all -> 0x006b }
                java.lang.Object r5 = r5.get(r4)     // Catch:{ all -> 0x006b }
                com.android.server.media.MediaRouterService$ClientRecord r5 = (com.android.server.media.MediaRouterService.ClientRecord) r5     // Catch:{ all -> 0x006b }
                java.lang.String r6 = r5.mSelectedRouteId     // Catch:{ all -> 0x006b }
                boolean r6 = android.text.TextUtils.equals(r0, r6)     // Catch:{ all -> 0x006b }
                if (r6 != 0) goto L_0x0040
                java.util.ArrayList<android.media.IMediaRouterClient> r6 = r8.mTempClients     // Catch:{ all -> 0x006b }
                android.media.IMediaRouterClient r7 = r5.mClient     // Catch:{ all -> 0x006b }
                r6.add(r7)     // Catch:{ all -> 0x006b }
            L_0x0040:
                int r4 = r4 + 1
                goto L_0x0027
            L_0x0043:
                monitor-exit(r1)     // Catch:{ all -> 0x006b }
                java.util.ArrayList<android.media.IMediaRouterClient> r1 = r8.mTempClients     // Catch:{ all -> 0x006e }
                int r1 = r1.size()     // Catch:{ all -> 0x006e }
                r2 = 0
            L_0x004b:
                if (r2 >= r1) goto L_0x0064
                java.util.ArrayList<android.media.IMediaRouterClient> r3 = r8.mTempClients     // Catch:{ RemoteException -> 0x0059 }
                java.lang.Object r3 = r3.get(r2)     // Catch:{ RemoteException -> 0x0059 }
                android.media.IMediaRouterClient r3 = (android.media.IMediaRouterClient) r3     // Catch:{ RemoteException -> 0x0059 }
                r3.onSelectedRouteChanged(r0)     // Catch:{ RemoteException -> 0x0059 }
                goto L_0x0061
            L_0x0059:
                r3 = move-exception
                java.lang.String r4 = "MediaRouterService"
                java.lang.String r5 = "Failed to call onSelectedRouteChanged. Client probably died."
                android.util.Slog.w(r4, r5)     // Catch:{ all -> 0x006e }
            L_0x0061:
                int r2 = r2 + 1
                goto L_0x004b
            L_0x0064:
                java.util.ArrayList<android.media.IMediaRouterClient> r0 = r8.mTempClients
                r0.clear()
                return
            L_0x006b:
                r2 = move-exception
            ...
            L_0x006e:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.media.MediaRouterService.UserHandler.updateSelectedRoute(java.lang.String):void");
        }
            ...
            public boolean updateDescriptor(RemoteDisplayState descriptor) {
                ...
                if (this.mDescriptor != descriptor) {
                    ...
                    for (int i2 = this.mRoutes.size() - 1; i2 >= targetIndex; i2--) {
                        this.mRoutes.remove(i2).updateDescriptor((RemoteDisplayState.RemoteDisplayInfo) null);
                        changed = true;
                    }
                }
                return changed;
