...
public class NetworkStatsFactory {
    ...
    public NetworkStats readNetworkStatsDetail() throws IOException {
        return readNetworkStatsDetail(-1, (String[]) null, -1, (NetworkStats) null);
    }
        ...
        if (this.mUseBpfStats) {
            synchronized (this.mPersistSnapshot) {
                try {
                    ...
                    if (nativeReadNetworkStatsDetail(stats, this.mStatsXtUid.getAbsolutePath(), -1, (String[]) null, -1, this.mUseBpfStats) == 0) {
