...
class NetworkStatsObservers {
    ...
    private static class NetworkUsageRequestInfo extends RequestInfo {
        ...
        public void recordSample(StatsContext statsContext) {
            this.mRecorder.recordSnapshotLocked(statsContext.mXtSnapshot, statsContext.mActiveIfaces, (VpnInfo[]) null, statsContext.mCurrentTime);
        }
    ...
    private static class UserUsageRequestInfo extends RequestInfo {
        ...
        private long getTotalBytesForNetworkUid(NetworkTemplate template, int uid) {
            try {
                return this.mCollection.getHistory(template, (SubscriptionPlan) null, uid, -1, 0, -1, Long.MIN_VALUE, JobStatus.NO_LATEST_RUNTIME, this.mAccessLevel, this.mCallingUid).getTotalBytes();
