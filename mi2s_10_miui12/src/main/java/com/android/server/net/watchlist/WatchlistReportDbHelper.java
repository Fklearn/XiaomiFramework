...
class WatchlistReportDbHelper extends SQLiteOpenHelper {
    ...
    public boolean insertNewRecord(byte[] appDigest, String cncDomain, long timestamp) {
        ...
        return db.insert("records", (String) null, values) != -1;
    }

    public AggregatedResult getAggregatedRecords(long untilTimestamp) {
        Cursor c = null;
        try {
            c = getReadableDatabase().query(true, "records", DIGEST_DOMAIN_PROJECTION, "timestamp < ?", new String[]{Long.toString(untilTimestamp)}, (String) null, (String) null, (String) null, (String) null);
    ...
    public boolean cleanup(long untilTimestamp) {
        ...
        return db.delete("records", sb.toString(), (String[]) null) != 0;
    }
}
