...
public class KeySetManagerService {
    ...
    public void assertScannedPackageValid(PackageParser.Package pkg) throws PackageManagerException {
        ...
        if (signingKeys == null || signingKeys.size() <= 0 || signingKeys.contains((Object) null)) {
        ...
        if (definedMapping != null) {
            if (definedMapping.containsKey((Object) null) || definedMapping.containsValue((Object) null)) {
                throw new PackageManagerException(-2, "Package has null defined key set.");
            }
            int defMapSize = definedMapping.size();
            for (int i = 0; i < defMapSize; i++) {
                if (definedMapping.valueAt(i).size() <= 0 || definedMapping.valueAt(i).contains((Object) null)) {
                ...
                if (pkg.keySetData != null) {
                    ...
                    if (pkg.keySetData.isUsingDefinedKeySets()) {
                        ...
                        for (int i = 0; i < dksSize; i++) {
                            ...
                            printWriter.print(Long.toString(definedKeySets.valueAt(i).longValue()));
                        }
                    }
                    if (printedLabel2) {
                        printWriter.println("");
    ...
    public void writeKeySetManagerServiceLPr(XmlSerializer serializer) throws IOException {
        ...
        serializer.attribute((String) null, "version", Integer.toString(1));
        writePublicKeysLPr(serializer);
        writeKeySetsLPr(serializer);
        serializer.startTag((String) null, "lastIssuedKeyId");
        serializer.attribute((String) null, "value", Long.toString(this.lastIssuedKeyId));
        serializer.endTag((String) null, "lastIssuedKeyId");
        serializer.startTag((String) null, "lastIssuedKeySetId");
        serializer.attribute((String) null, "value", Long.toString(this.lastIssuedKeySetId));
    ...
    public void writePublicKeysLPr(XmlSerializer serializer) throws IOException {
        ...
        for (int pKeyIndex = 0; pKeyIndex < this.mPublicKeys.size(); pKeyIndex++) {
            ...
            serializer.attribute((String) null, "value", encodedKey);
    ...
    public void writeKeySetsLPr(XmlSerializer serializer) throws IOException {
        ...
        for (int keySetIndex = 0; keySetIndex < this.mKeySetMapping.size(); keySetIndex++) {
            ...
            while (it.hasNext()) {
                ...
                serializer.attribute((String) null, "identifier", Long.toString(keyId));
        ...
        while (true) {
            ...
            if (next2 == 1 || (type3 == 3 && parser.getDepth() <= outerDepth)) {
                ...
                if (tagName.equals("keys")) {
                    ...
                    this.lastIssuedKeyId = Long.parseLong(parser.getAttributeValue((String) null, "value"));
                } else if (tagName.equals("lastIssuedKeySetId")) {
                    this.lastIssuedKeySetId = Long.parseLong(parser.getAttributeValue((String) null, "value"));
                }
            }
        }
        addRefCountsFromSavedPackagesLPw(keySetRefCounts);
        ...
        while (true) {
            ...
            if (!(type == 3 || type == 4)) {
                ...
                if (tagName.equals("keyset")) {
                    currentKeySetId = Long.parseLong(parser.getAttributeValue((String) null, "identifier"));
                    ...
                    this.mKeySetMapping.get(currentKeySetId).add(Long.valueOf(Long.parseLong(parser.getAttributeValue((String) null, "identifier"))));
                }
            }
        }
    }
    ...
    public void readPublicKeyLPw(XmlPullParser parser) throws XmlPullParserException {
        long identifier = Long.parseLong(parser.getAttributeValue((String) null, "identifier"));
        PublicKey pub = PackageParser.parsePublicKey(parser.getAttributeValue((String) null, "value"));
        if (pub != null) {
