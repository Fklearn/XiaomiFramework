...
public class LauncherAppsService extends SystemService {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.android.server.pm.LauncherAppsService$LauncherAppsImpl, android.os.IBinder] */
    public void onStart() {
    ...
    static class LauncherAppsImpl extends ILauncherApps.Stub {
        ...
        public void registerPackageInstallerCallback(String callingPackage, IPackageInstallerCallback callback) {
            verifyCallingPackage(callingPackage);
            getPackageInstallerService().registerCallback(callback, (IntPredicate) new IntPredicate(new UserHandle(getCallingUserId())) {
        ...
        public IntentSender getShortcutConfigActivityIntent(String callingPackage, ComponentName component, UserHandle user) throws RemoteException {
            ...
            try {
                PendingIntent pi = PendingIntent.getActivityAsUser(this.mContext, 0, intent, 1409286144, (Bundle) null, user);
                if (pi != null) {
        ...
        public boolean startShortcut(String callingPackage, String packageName, String shortcutId, Rect sourceBounds, Bundle startActivityOptions, int targetUserId) {
            ...
            if (intents == null) {
                ...
                Rect rect2 = sourceBounds;
                Bundle bundle2 = startActivityOptions;
            } else {
                intents[0].addFlags(268435456);
                Rect rect3 = sourceBounds;
                intents[0].setSourceBounds(sourceBounds);
                intents[0].addMiuiFlags(2);
        ...
        public void showAppDetailsAsUser(IApplicationThread caller, String callingPackage, ComponentName component, Rect sourceBounds, Bundle opts, UserHandle user) throws RemoteException {
            if (canAccessProfile(user.getIdentifier(), "Cannot show app details")) {
                long ident = Binder.clearCallingIdentity();
                try {
                    Intent intent = new Intent("android.settings.APPLICATION_DETAILS_SETTINGS", Uri.fromParts(Settings.ATTR_PACKAGE, component.getPackageName(), (String) null));
            ...
            public void onShortcutChanged(String packageName, int userId) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0007: INVOKE  
                      (wrap: com.android.server.pm.LauncherAppsService$LauncherAppsImpl : 0x0000: IGET  (r0v0 com.android.server.pm.LauncherAppsService$LauncherAppsImpl) = 
                      (r2v0 'this' com.android.server.pm.LauncherAppsService$LauncherAppsImpl$MyPackageMonitor A[THIS])
                     com.android.server.pm.LauncherAppsService.LauncherAppsImpl.MyPackageMonitor.this$0 com.android.server.pm.LauncherAppsService$LauncherAppsImpl)
                      (wrap: com.android.server.pm.-$$Lambda$LauncherAppsService$LauncherAppsImpl$MyPackageMonitor$eTair5Mvr14v4M0nq9aQEW2cp-Y : 0x0004: CONSTRUCTOR  (r1v0 com.android.server.pm.-$$Lambda$LauncherAppsService$LauncherAppsImpl$MyPackageMonitor$eTair5Mvr14v4M0nq9aQEW2cp-Y) = 
                      (r2v0 'this' com.android.server.pm.LauncherAppsService$LauncherAppsImpl$MyPackageMonitor A[THIS])
                      (r3v0 'packageName' java.lang.String)
                      (r4v0 'userId' int)
                     call: com.android.server.pm.-$$Lambda$LauncherAppsService$LauncherAppsImpl$MyPackageMonitor$eTair5Mvr14v4M0nq9aQEW2cp-Y.<init>(com.android.server.pm.LauncherAppsService$LauncherAppsImpl$MyPackageMonitor, java.lang.String, int):void type: CONSTRUCTOR)
                     com.android.server.pm.LauncherAppsService.LauncherAppsImpl.postToPackageMonitorHandler(java.lang.Runnable):void type: VIRTUAL in method: com.android.server.pm.LauncherAppsService.LauncherAppsImpl.MyPackageMonitor.onShortcutChanged(java.lang.String, int):void, dex: classes.dex
                    ...
                    Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0004: CONSTRUCTOR  (r1v0 com.android.server.pm.-$$Lambda$LauncherAppsService$LauncherAppsImpl$MyPackageMonitor$eTair5Mvr14v4M0nq9aQEW2cp-Y) = 
                      (r2v0 'this' com.android.server.pm.LauncherAppsService$LauncherAppsImpl$MyPackageMonitor A[THIS])
                      (r3v0 'packageName' java.lang.String)
                      (r4v0 'userId' int)
                     call: com.android.server.pm.-$$Lambda$LauncherAppsService$LauncherAppsImpl$MyPackageMonitor$eTair5Mvr14v4M0nq9aQEW2cp-Y.<init>(com.android.server.pm.LauncherAppsService$LauncherAppsImpl$MyPackageMonitor, java.lang.String, int):void type: CONSTRUCTOR in method: com.android.server.pm.LauncherAppsService.LauncherAppsImpl.MyPackageMonitor.onShortcutChanged(java.lang.String, int):void, dex: classes.dex
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:256)
