...
public class ModuleInfoProvider {
    ...
    public void systemReady() {
        this.mPackageName = this.mContext.getResources().getString(17039729);
        ...
        try {
            ...
            while (true) {
                ...
                if (parser.getEventType() == 1) {
                    ...
                    CharSequence moduleName = packageResources.getText(Integer.parseInt(parser.getAttributeValue((String) null, Settings.ATTR_NAME).substring(1)));
