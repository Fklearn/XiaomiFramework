...
public class OtaDexoptService extends IOtaDexopt.Stub {
    ...
    public void onShellCommand(java.io.FileDescriptor r9, java.io.FileDescriptor r10, java.io.FileDescriptor r11, java.lang.String[] r12, android.os.ShellCallback r13, android.os.ResultReceiver r14) {
        /*
            r8 = this;
            com.android.server.pm.OtaDexoptShellCommand r0 = new com.android.server.pm.OtaDexoptShellCommand
            r0.<init>(r8)
            r1 = r8
            r2 = r9
            r3 = r10
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.pm.OtaDexoptService.onShellCommand(java.io.FileDescriptor, java.io.FileDescriptor, java.io.FileDescriptor, java.lang.String[], android.os.ShellCallback, android.os.ResultReceiver):void");
    }
    ...
    private synchronized List<String> generatePackageDexopts(PackageParser.Package pkg, int compilationReason) {
        ...
        }, this.mPackageManagerService.mInstallLock, this.mContext).performDexOpt(pkg, (String[]) null, (CompilerStats.PackageStats) null, this.mPackageManagerService.getDexManager().getPackageUseInfoOrDefault(pkg.packageName), new DexoptOptions(pkg.packageName, compilationReason, 4));
        return commands;
    }
                ...
                if (pkg != null && PackageDexOptimizer.canOptimizePackage(pkg)) {
                    if (pkg.codePath == null) {
                        ...
                        while (i < length) {
                            ...
                            Collection<PackageParser.Package> pkgs3 = pkgs;
                            Installer installer3 = installer;
                            i++;
                            pkgs = pkgs3;
                        }
                        Collection<PackageParser.Package> pkgs4 = pkgs;
                        Installer installer4 = installer;
                        pkgs = pkgs4;
                    }
                }
                Collection<PackageParser.Package> pkgs5 = pkgs;
