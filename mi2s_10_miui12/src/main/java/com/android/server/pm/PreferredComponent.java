...
public class PreferredComponent {
    ...
    public PreferredComponent(Callbacks callbacks, XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        this.mCallbacks = callbacks;
        String str3 = "name";
        this.mShortComponent = xmlPullParser.getAttributeValue((String) null, str3);
        ...
        String matchStr2 = xmlPullParser.getAttributeValue((String) null, ATTR_MATCH);
        int setCount = 0;
        this.mMatch = matchStr2 != null ? Integer.parseInt(matchStr2, 16) : 0;
        String str4 = "set";
        String setCountStr = xmlPullParser.getAttributeValue((String) null, str4);
        setCount = setCountStr != null ? Integer.parseInt(setCountStr) : setCount;
        String alwaysStr = xmlPullParser.getAttributeValue((String) null, ATTR_ALWAYS);
        int type = 1;
        ...
        while (true) {
            ...
            if (type3 == 3 && parser.getDepth() <= outerDepth) {
                ...
                if (tagName.equals(str4)) {
                    matchStr = matchStr2;
                    String name = xmlPullParser.getAttributeValue((String) null, str3);
                    if (name != null) {
                        str2 = str3;
                        if (setPos < setCount) {
    ...
    public void writeToXml(XmlSerializer serializer, boolean full) throws IOException {
        ...
        if (full) {
            int i = this.mMatch;
            if (i != 0) {
                serializer.attribute((String) null, ATTR_MATCH, Integer.toHexString(i));
            }
            serializer.attribute((String) null, ATTR_ALWAYS, Boolean.toString(this.mAlways));
            serializer.attribute((String) null, "set", Integer.toString(NS));
            for (int s = 0; s < NS; s++) {
