...
public class EventLogTags {
    ...
    public static void writeScreenToggled(int screenState) {
        EventLog.writeEvent(SCREEN_TOGGLED, screenState);
    }

    public static void writeInterceptPower(String action, int mpowerkeyhandled, int mpowerkeypresscounter) {
        EventLog.writeEvent(INTERCEPT_POWER, new Object[]{action, Integer.valueOf(mpowerkeyhandled), Integer.valueOf(mpowerkeypresscounter)});
    }
}
