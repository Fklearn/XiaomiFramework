...
final class GlobalKeyManager {
    ...
    public boolean handleGlobalKey(Context context, int keyCode, KeyEvent event) {
        ...
        context.sendBroadcastAsUser(new Intent("android.intent.action.GLOBAL_BUTTON").setComponent(component).setFlags(268435456).putExtra("android.intent.extra.KEY_EVENT", event), UserHandle.CURRENT, (String) null);
        return true;
    }
    ...
    private void loadGlobalKeys(Context context) {
        ...
        try {
            ...
            if (1 == parser.getAttributeIntValue((String) null, ATTR_VERSION, 0)) {
                while (true) {
                    ...
                    if (element == null) {
                        ...
                        String keyCodeName = parser.getAttributeValue((String) null, ATTR_KEY_CODE);
                        String componentName = parser.getAttributeValue((String) null, ATTR_COMPONENT);
