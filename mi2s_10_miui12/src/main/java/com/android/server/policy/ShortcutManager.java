            ...
            while (true) {
                ...
                if (parser2.getEventType() != 1) {
                    if (TAG_BOOKMARK.equals(parser2.getName())) {
                        String packageName = parser2.getAttributeValue((String) null, "package");
                        String className = parser2.getAttributeValue((String) null, ATTRIBUTE_CLASS);
                        String shortcutName = parser2.getAttributeValue((String) null, ATTRIBUTE_SHORTCUT);
                        String categoryName = parser2.getAttributeValue((String) null, ATTRIBUTE_CATEGORY);
                        String shiftName = parser2.getAttributeValue((String) null, ATTRIBUTE_SHIFT);
                            ...
                            if (packageName == null || className == null) {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        Log.w(TAG, "Unable to add bookmark: " + packageName + SliceClientPermissions.SliceAuthority.DELIMITER + className, e2);
                                        parser2 = parser;
                                    }
                                }
