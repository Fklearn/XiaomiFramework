...
public interface WindowManagerPolicy extends WindowManagerPolicyConstants {
    ...
    Animation createHiddenByKeyguardExitForAppWindow(boolean z, boolean z2);
    ...
    void finishLayoutLw(DisplayFrames displayFrames);
    ...
    void notifyFpClientState(boolean z, boolean z2);
    ...
    void setHangUpEnable(boolean z);
    ...
    public interface WindowManagerFuncs {
        ...
        void onFpClientStateChanged(boolean z, boolean z2);
    ...
    int getSubWindowLayerFromTypeLw(int type) {
        switch (type) {
            ...
            case 1005:
                return 3;
            default:
                Slog.e(DisplayPolicy.TAG, "Unknown sub-window type: " + type);
                return 0;
        }
    }
    ...
    void onDefaultDisplayFocusChangedLw(WindowState newFocus) {
    }
}
