...
public class ThermalManagerService extends SystemService {
    ...
    public ThermalManagerService(Context context) {
        this(context, (ThermalHalWrapper) null);
    }
    ...
    ThermalManagerService(Context context, ThermalHalWrapper halWrapper) {
        ...
        this.mService = new IThermalService.Stub() {
            ...
            public boolean registerThermalEventListener(IThermalEventListener listener) {
                ThermalManagerService.this.getContext().enforceCallingOrSelfPermission("android.permission.DEVICE_POWER", (String) null);
                synchronized (ThermalManagerService.this.mLock) {
                    long token = Binder.clearCallingIdentity();
                    try {
                        if (!ThermalManagerService.this.mThermalEventListeners.register(listener, (Object) null)) {
                            return false;
                        }
                        ThermalManagerService.this.postEventListenerCurrentTemperatures(listener, (Integer) null);
            ...
            private void dumpItemsLocked(PrintWriter pw, String prefix, Collection<?> items) {
                for (Object obj : items) {
                    pw.println(prefix + obj.toString());
                }
            }
            ...
            /* JADX WARNING: type inference failed for: r3v0, types: [android.os.Binder] */
            /* JADX WARNING: Multi-variable type inference failed */
            /* Code decompiled incorrectly, please refer to instructions dump. */
            public void onShellCommand(java.io.FileDescriptor r11, java.io.FileDescriptor r12, java.io.FileDescriptor r13, java.lang.String[] r14, android.os.ShellCallback r15, android.os.ResultReceiver r16) {
                /*
                    r10 = this;
                    boolean r0 = r10.isCallerShell()
                    if (r0 != 0) goto L_0x0010
                    java.lang.String r0 = com.android.server.power.ThermalManagerService.TAG
                    java.lang.String r1 = "Only shell is allowed to call thermalservice shell commands"
                    android.util.Slog.w(r0, r1)
                    return
                L_0x0010:
                    com.android.server.power.ThermalManagerService$ThermalShellCommand r2 = new com.android.server.power.ThermalManagerService$ThermalShellCommand
                    r0 = r10
                    com.android.server.power.ThermalManagerService r1 = com.android.server.power.ThermalManagerService.this
                    r2.<init>()
                    r3 = r10
                    r4 = r11
                    r5 = r12
                    ...
                    r8 = r15
                    r9 = r16
                    r2.exec(r3, r4, r5, r6, r7, r8, r9)
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.android.server.power.ThermalManagerService.AnonymousClass1.onShellCommand(java.io.FileDescriptor, java.io.FileDescriptor, java.io.FileDescriptor, java.lang.String[], android.os.ShellCallback, android.os.ResultReceiver):void");
            }
        };
