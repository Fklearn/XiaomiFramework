...
final class RemotePrintService implements IBinder.DeathRecipient {
    ...
    public void handleStopPrinterStateTracking(final android.print.PrinterId r4) {
        /*
            r3 = this;
            java.lang.Object r0 = r3.mLock
            monitor-enter(r0)
            java.util.List<android.print.PrinterId> r1 = r3.mTrackedPrinterList     // Catch:{ all -> 0x0041 }
            if (r1 == 0) goto L_0x003f
            java.util.List<android.print.PrinterId> r1 = r3.mTrackedPrinterList     // Catch:{ all -> 0x0041 }
            boolean r1 = r1.remove(r4)     // Catch:{ all -> 0x0041 }
        ...
        L_0x0010:
            ...
            r1 = 0
            r3.mTrackedPrinterList = r1     // Catch:{ all -> 0x0041 }
        L_0x001b:
            monitor-exit(r0)     // Catch:{ all -> 0x0041 }
            boolean r0 = r3.isBound()
            if (r0 != 0) goto L_0x0030
            r3.ensureBound()
            java.util.List<java.lang.Runnable> r0 = r3.mPendingCommands
            com.android.server.print.RemotePrintService$10 r1 = new com.android.server.print.RemotePrintService$10
            r1.<init>(r4)
            r0.add(r1)
            goto L_0x003e
        L_0x0030:
            android.printservice.IPrintService r0 = r3.mPrintService     // Catch:{ RemoteException -> 0x0036 }
            r0.stopPrinterStateTracking(r4)     // Catch:{ RemoteException -> 0x0036 }
            goto L_0x003e
        L_0x0036:
            r0 = move-exception
            java.lang.String r1 = "RemotePrintService"
            java.lang.String r2 = "Error requesting stop printer tracking."
        ...
        L_0x0041:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.print.RemotePrintService.handleStopPrinterStateTracking(android.print.PrinterId):void");
    }
