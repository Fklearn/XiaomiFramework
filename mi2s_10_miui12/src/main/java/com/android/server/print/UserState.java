...
final class UserState implements RemotePrintSpooler.PrintSpoolerCallbacks, RemotePrintService.PrintServiceCallbacks, RemotePrintServiceRecommendationService.RemotePrintServiceRecommendationServiceCallbacks {
    ...
    public void onPrintJobQueued(PrintJobInfo printJob) {
        ...
        if (service != null) {
            ...
            this.mSpooler.setPrintJobState(printJob.getId(), 6, this.mContext.getString(17040984));
        }
    }
    ...
    public Bundle print(String printJobName, IPrintDocumentAdapter adapter, PrintAttributes attributes, String packageName, int appId) {
        ...
        boolean injected = MiuiPrintManager.ensureInjected(printJob);
        ...
        try {
            ...
            intent.setData(Uri.fromParts("printjob", printJob.getId().flattenToString(), (String) null));
            ...
            try {
                ...
                MiuiPrintManager.printInject(injected, intent);
                IntentSender intentSender = PendingIntent.getActivityAsUser(this.mContext, 0, intent, 1409286144, (Bundle) null, new UserHandle(this.mUserId)).getIntentSender();
    ...
    public List<PrintJobInfo> getPrintJobInfos(int appId) {
        ...
        for (int i = 0; i < cachedPrintJobCount; i++) {
            ...
            cachedPrintJob.setTag((String) null);
            cachedPrintJob.setAdvancedOptions((Bundle) null);
        }
        List<PrintJobInfo> printJobs = this.mSpooler.getPrintJobInfos((ComponentName) null, -1, appId);
        if (printJobs != null) {
            ...
            for (int i2 = 0; i2 < printJobCount; i2++) {
                ...
                printJob.setTag((String) null);
                printJob.setAdvancedOptions((Bundle) null);
            }
        }
    ...
    public void cancelPrintJob(PrintJobId printJobId, int appId) {
        ...
        if (printJobInfo != null) {
            ...
            this.mSpooler.setPrintJobState(printJobId, 7, (String) null);
        }
    }
    ...
    public void restartPrintJob(PrintJobId printJobId, int appId) {
        ...
        if (printJobInfo != null && printJobInfo.getState() == 6) {
            this.mSpooler.setPrintJobState(printJobId, 2, (String) null);
        }
    }
    ...
    public void removePrintJobStateChangeListener(android.print.IPrintJobStateChangeListener r7) {
        /*
            r6 = this;
            java.lang.Object r0 = r6.mLock
            monitor-enter(r0)
            r6.throwIfDestroyedLocked()     // Catch:{ all -> 0x0046 }
            java.util.List<com.android.server.print.UserState$PrintJobStateChangeListenerRecord> r1 = r6.mPrintJobStateChangeListenerRecords     // Catch:{ all -> 0x0046 }
        ...
        L_0x0013:
            ...
            java.util.List<com.android.server.print.UserState$PrintJobStateChangeListenerRecord> r3 = r6.mPrintJobStateChangeListenerRecords     // Catch:{ all -> 0x0046 }
            java.lang.Object r3 = r3.get(r2)     // Catch:{ all -> 0x0046 }
            com.android.server.print.UserState$PrintJobStateChangeListenerRecord r3 = (com.android.server.print.UserState.PrintJobStateChangeListenerRecord) r3     // Catch:{ all -> 0x0046 }
            android.print.IPrintJobStateChangeListener r4 = r3.listener     // Catch:{ all -> 0x0046 }
            android.os.IBinder r4 = r4.asBinder()     // Catch:{ all -> 0x0046 }
            android.os.IBinder r5 = r7.asBinder()     // Catch:{ all -> 0x0046 }
            boolean r4 = r4.equals(r5)     // Catch:{ all -> 0x0046 }
            if (r4 == 0) goto L_0x0036
            r3.destroy()     // Catch:{ all -> 0x0046 }
            java.util.List<com.android.server.print.UserState$PrintJobStateChangeListenerRecord> r4 = r6.mPrintJobStateChangeListenerRecords     // Catch:{ all -> 0x0046 }
            r4.remove(r2)     // Catch:{ all -> 0x0046 }
            goto L_0x0039
        L_0x0036:
            int r2 = r2 + 1
            goto L_0x0013
        L_0x0039:
            java.util.List<com.android.server.print.UserState$PrintJobStateChangeListenerRecord> r2 = r6.mPrintJobStateChangeListenerRecords     // Catch:{ all -> 0x0046 }
            boolean r2 = r2.isEmpty()     // Catch:{ all -> 0x0046 }
            if (r2 == 0) goto L_0x0044
            r2 = 0
            r6.mPrintJobStateChangeListenerRecords = r2     // Catch:{ all -> 0x0046 }
        L_0x0044:
            monitor-exit(r0)     // Catch:{ all -> 0x0046 }
            return
        L_0x0046:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.print.UserState.removePrintJobStateChangeListener(android.print.IPrintJobStateChangeListener):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void removePrintServicesChangeListener(android.print.IPrintServicesChangeListener r7) {
        /*
            r6 = this;
            java.lang.Object r0 = r6.mLock
            monitor-enter(r0)
            r6.throwIfDestroyedLocked()     // Catch:{ all -> 0x0048 }
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.print.IPrintServicesChangeListener>> r1 = r6.mPrintServicesChangeListenerRecords     // Catch:{ all -> 0x0048 }
            if (r1 != 0) goto L_0x000c
            monitor-exit(r0)     // Catch:{ all -> 0x0048 }
            return
        L_0x000c:
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.print.IPrintServicesChangeListener>> r1 = r6.mPrintServicesChangeListenerRecords     // Catch:{ all -> 0x0048 }
            int r1 = r1.size()     // Catch:{ all -> 0x0048 }
            r2 = 0
        L_0x0013:
            if (r2 >= r1) goto L_0x003b
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.print.IPrintServicesChangeListener>> r3 = r6.mPrintServicesChangeListenerRecords     // Catch:{ all -> 0x0048 }
            java.lang.Object r3 = r3.get(r2)     // Catch:{ all -> 0x0048 }
            com.android.server.print.UserState$ListenerRecord r3 = (com.android.server.print.UserState.ListenerRecord) r3     // Catch:{ all -> 0x0048 }
            T r4 = r3.listener     // Catch:{ all -> 0x0048 }
            android.print.IPrintServicesChangeListener r4 = (android.print.IPrintServicesChangeListener) r4     // Catch:{ all -> 0x0048 }
            android.os.IBinder r4 = r4.asBinder()     // Catch:{ all -> 0x0048 }
            android.os.IBinder r5 = r7.asBinder()     // Catch:{ all -> 0x0048 }
            boolean r4 = r4.equals(r5)     // Catch:{ all -> 0x0048 }
            if (r4 == 0) goto L_0x0038
            r3.destroy()     // Catch:{ all -> 0x0048 }
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.print.IPrintServicesChangeListener>> r4 = r6.mPrintServicesChangeListenerRecords     // Catch:{ all -> 0x0048 }
            r4.remove(r2)     // Catch:{ all -> 0x0048 }
            goto L_0x003b
        L_0x0038:
            int r2 = r2 + 1
            goto L_0x0013
        L_0x003b:
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.print.IPrintServicesChangeListener>> r2 = r6.mPrintServicesChangeListenerRecords     // Catch:{ all -> 0x0048 }
            boolean r2 = r2.isEmpty()     // Catch:{ all -> 0x0048 }
            if (r2 == 0) goto L_0x0046
            r2 = 0
            r6.mPrintServicesChangeListenerRecords = r2     // Catch:{ all -> 0x0048 }
        L_0x0046:
            monitor-exit(r0)     // Catch:{ all -> 0x0048 }
            return
        L_0x0048:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.print.UserState.removePrintServicesChangeListener(android.print.IPrintServicesChangeListener):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void removePrintServiceRecommendationsChangeListener(android.printservice.recommendation.IRecommendationsChangeListener r7) {
        /*
            r6 = this;
            java.lang.Object r0 = r6.mLock
            monitor-enter(r0)
            r6.throwIfDestroyedLocked()     // Catch:{ all -> 0x0051 }
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.printservice.recommendation.IRecommendationsChangeListener>> r1 = r6.mPrintServiceRecommendationsChangeListenerRecords     // Catch:{ all -> 0x0051 }
            if (r1 != 0) goto L_0x000c
        ...
        L_0x0013:
            if (r2 >= r1) goto L_0x003b
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.printservice.recommendation.IRecommendationsChangeListener>> r3 = r6.mPrintServiceRecommendationsChangeListenerRecords     // Catch:{ all -> 0x0051 }
            java.lang.Object r3 = r3.get(r2)     // Catch:{ all -> 0x0051 }
            com.android.server.print.UserState$ListenerRecord r3 = (com.android.server.print.UserState.ListenerRecord) r3     // Catch:{ all -> 0x0051 }
            T r4 = r3.listener     // Catch:{ all -> 0x0051 }
            android.printservice.recommendation.IRecommendationsChangeListener r4 = (android.printservice.recommendation.IRecommendationsChangeListener) r4     // Catch:{ all -> 0x0051 }
            android.os.IBinder r4 = r4.asBinder()     // Catch:{ all -> 0x0051 }
            android.os.IBinder r5 = r7.asBinder()     // Catch:{ all -> 0x0051 }
            boolean r4 = r4.equals(r5)     // Catch:{ all -> 0x0051 }
            if (r4 == 0) goto L_0x0038
            r3.destroy()     // Catch:{ all -> 0x0051 }
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.printservice.recommendation.IRecommendationsChangeListener>> r4 = r6.mPrintServiceRecommendationsChangeListenerRecords     // Catch:{ all -> 0x0051 }
            r4.remove(r2)     // Catch:{ all -> 0x0051 }
            goto L_0x003b
        L_0x0038:
            int r2 = r2 + 1
            goto L_0x0013
        L_0x003b:
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.printservice.recommendation.IRecommendationsChangeListener>> r2 = r6.mPrintServiceRecommendationsChangeListenerRecords     // Catch:{ all -> 0x0051 }
            boolean r2 = r2.isEmpty()     // Catch:{ all -> 0x0051 }
            if (r2 == 0) goto L_0x004f
            r2 = 0
            r6.mPrintServiceRecommendationsChangeListenerRecords = r2     // Catch:{ all -> 0x0051 }
            r6.mPrintServiceRecommendations = r2     // Catch:{ all -> 0x0051 }
            com.android.server.print.RemotePrintServiceRecommendationService r3 = r6.mPrintServiceRecommendationsService     // Catch:{ all -> 0x0051 }
            r3.close()     // Catch:{ all -> 0x0051 }
            r6.mPrintServiceRecommendationsService = r2     // Catch:{ all -> 0x0051 }
        L_0x004f:
            monitor-exit(r0)     // Catch:{ all -> 0x0051 }
            return
        L_0x0051:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.print.UserState.removePrintServiceRecommendationsChangeListener(android.printservice.recommendation.IRecommendationsChangeListener):void");
    }
    ...
    private void upgradePersistentStateIfNeeded() {
        if (Settings.Secure.getStringForUser(this.mContext.getContentResolver(), "enabled_print_services", this.mUserId) != null) {
            ...
            Settings.Secure.putStringForUser(this.mContext.getContentResolver(), "enabled_print_services", (String) null, this.mUserId);
        }
    }
        ...
        if (printJobs != null) {
            ...
            try {
                ...
                for (int i = 0; i < printJobCount; i++) {
                    this.mSpooler.setPrintJobState(printJobs.get(i).getId(), 6, this.mContext.getString(17040984));
                }
            } finally {
                Binder.restoreCallingIdentity(identity);
            }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void handleDispatchPrintJobStateChanged(android.print.PrintJobId r9, java.util.function.IntSupplier r10) {
        /*
            r8 = this;
            int r0 = r10.getAsInt()
            java.lang.Object r1 = r8.mLock
            monitor-enter(r1)
            java.util.List<com.android.server.print.UserState$PrintJobStateChangeListenerRecord> r2 = r8.mPrintJobStateChangeListenerRecords     // Catch:{ all -> 0x003d }
            if (r2 != 0) goto L_0x000d
            monitor-exit(r1)     // Catch:{ all -> 0x003d }
            return
        L_0x000d:
            java.util.ArrayList r2 = new java.util.ArrayList     // Catch:{ all -> 0x003d }
            java.util.List<com.android.server.print.UserState$PrintJobStateChangeListenerRecord> r3 = r8.mPrintJobStateChangeListenerRecords     // Catch:{ all -> 0x003d }
        ...
        L_0x001a:
            ...
            com.android.server.print.UserState$PrintJobStateChangeListenerRecord r4 = (com.android.server.print.UserState.PrintJobStateChangeListenerRecord) r4
            int r5 = r4.appId
            r6 = -2
        ...
        L_0x002b:
            android.print.IPrintJobStateChangeListener r5 = r4.listener     // Catch:{ RemoteException -> 0x0031 }
            r5.onPrintJobStateChanged(r9)     // Catch:{ RemoteException -> 0x0031 }
            goto L_0x0039
        L_0x0031:
            r5 = move-exception
            java.lang.String r6 = "UserState"
            java.lang.String r7 = "Error notifying for print job state change"
        ...
        L_0x003d:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.print.UserState.handleDispatchPrintJobStateChanged(android.print.PrintJobId, java.util.function.IntSupplier):void");
    }
    ...
    public void handleDispatchPrintServicesChanged() {
        /*
            ...
            monitor-enter(r0)
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.print.IPrintServicesChangeListener>> r1 = r7.mPrintServicesChangeListenerRecords     // Catch:{ all -> 0x0032 }
            if (r1 != 0) goto L_0x0009
            monitor-exit(r0)     // Catch:{ all -> 0x0032 }
            return
        L_0x0009:
            java.util.ArrayList r1 = new java.util.ArrayList     // Catch:{ all -> 0x0032 }
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.print.IPrintServicesChangeListener>> r2 = r7.mPrintServicesChangeListenerRecords     // Catch:{ all -> 0x0032 }
        ...
        L_0x0016:
            ...
            com.android.server.print.UserState$ListenerRecord r3 = (com.android.server.print.UserState.ListenerRecord) r3
            T r4 = r3.listener     // Catch:{ RemoteException -> 0x0026 }
            android.print.IPrintServicesChangeListener r4 = (android.print.IPrintServicesChangeListener) r4     // Catch:{ RemoteException -> 0x0026 }
            r4.onPrintServicesChanged()     // Catch:{ RemoteException -> 0x0026 }
            goto L_0x002e
        L_0x0026:
            r4 = move-exception
            java.lang.String r5 = "UserState"
            java.lang.String r6 = "Error notifying for print services change"
        ...
        L_0x0032:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.print.UserState.handleDispatchPrintServicesChanged():void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void handleDispatchPrintServiceRecommendationsUpdated(java.util.List<android.printservice.recommendation.RecommendationInfo> r8) {
        /*
            r7 = this;
            java.lang.Object r0 = r7.mLock
            monitor-enter(r0)
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.printservice.recommendation.IRecommendationsChangeListener>> r1 = r7.mPrintServiceRecommendationsChangeListenerRecords     // Catch:{ all -> 0x0034 }
            if (r1 != 0) goto L_0x0009
            monitor-exit(r0)     // Catch:{ all -> 0x0034 }
            return
        L_0x0009:
            java.util.ArrayList r1 = new java.util.ArrayList     // Catch:{ all -> 0x0034 }
            java.util.List<com.android.server.print.UserState$ListenerRecord<android.printservice.recommendation.IRecommendationsChangeListener>> r2 = r7.mPrintServiceRecommendationsChangeListenerRecords     // Catch:{ all -> 0x0034 }
            r1.<init>(r2)     // Catch:{ all -> 0x0034 }
            r7.mPrintServiceRecommendations = r8     // Catch:{ all -> 0x0034 }
            monitor-exit(r0)     // Catch:{ all -> 0x0034 }
            int r0 = r1.size()
            r2 = 0
        L_0x0018:
            ...
            java.lang.Object r3 = r1.get(r2)
            com.android.server.print.UserState$ListenerRecord r3 = (com.android.server.print.UserState.ListenerRecord) r3
            T r4 = r3.listener     // Catch:{ RemoteException -> 0x0028 }
            android.printservice.recommendation.IRecommendationsChangeListener r4 = (android.printservice.recommendation.IRecommendationsChangeListener) r4     // Catch:{ RemoteException -> 0x0028 }
            r4.onRecommendationsChanged()     // Catch:{ RemoteException -> 0x0028 }
            goto L_0x0030
        L_0x0028:
            r4 = move-exception
            java.lang.String r5 = "UserState"
            java.lang.String r6 = "Error notifying for print service recommendations change"
            android.util.Log.e(r5, r6, r4)
        L_0x0030:
            int r2 = r2 + 1
            goto L_0x0018
        ...
        L_0x0034:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.print.UserState.handleDispatchPrintServiceRecommendationsUpdated(java.util.List):void");
    }
    ...
    private class PrinterDiscoverySessionMediator {
        ...
        /* access modifiers changed from: private */
        public void handleDispatchCreatePrinterDiscoverySession(List<RemotePrintService> services2) {
            int serviceCount = services2.size();
            for (int i = 0; i < serviceCount; i++) {
                services2.get(i).createPrinterDiscoverySession();
            }
        }

        /* access modifiers changed from: private */
        public void handleDispatchDestroyPrinterDiscoverySession(List<RemotePrintService> services2) {
            int serviceCount = services2.size();
            for (int i = 0; i < serviceCount; i++) {
                services2.get(i).destroyPrinterDiscoverySession();
            }
            onDestroyed();
        }

        /* access modifiers changed from: private */
        public void handleDispatchStartPrinterDiscovery(List<RemotePrintService> services2, List<PrinterId> printerIds) {
            int serviceCount = services2.size();
            for (int i = 0; i < serviceCount; i++) {
                services2.get(i).startPrinterDiscovery(printerIds);
            }
        }

        /* access modifiers changed from: private */
        public void handleDispatchStopPrinterDiscovery(List<RemotePrintService> services2) {
            int serviceCount = services2.size();
            for (int i = 0; i < serviceCount; i++) {
                services2.get(i).stopPrinterDiscovery();
            }
        }
