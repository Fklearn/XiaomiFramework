...
public final class RestrictionsManagerService extends SystemService {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.android.server.restrictions.RestrictionsManagerService$RestrictionsManagerImpl, android.os.IBinder] */
    public void onStart() {
