...
public class SearchManagerService extends ISearchManager.Stub {
    ...
    public static class Lifecycle extends SystemService {
        ...
        /* JADX WARNING: type inference failed for: r0v1, types: [com.android.server.search.SearchManagerService, android.os.IBinder] */
        public void onStart() {
    ...
    private ComponentName getLegacyAssistComponent(int userHandle) {
        try {
            List<ResolveInfo> infoListVis = this.mContext.getPackageManager().queryIntentServicesAsUser(new Intent("android.service.voice.VoiceInteractionService"), DumpState.DUMP_DEXOPT, ActivityManager.handleIncomingUser(Binder.getCallingPid(), Binder.getCallingUid(), userHandle, true, false, "getLegacyAssistComponent", (String) null));
            if (infoListVis != null) {
