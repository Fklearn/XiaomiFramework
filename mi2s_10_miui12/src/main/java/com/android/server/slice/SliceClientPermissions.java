...
public class SliceClientPermissions implements DirtyTracker, DirtyTracker.Persistable {
    ...
    public synchronized boolean hasPermission(android.net.Uri r4, int r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            java.lang.String r0 = "content"
            java.lang.String r1 = r4.getScheme()     // Catch:{ all -> 0x002c }
            boolean r0 = java.util.Objects.equals(r0, r1)     // Catch:{ all -> 0x002c }
            r1 = 0
            if (r0 != 0) goto L_0x0010
            monitor-exit(r3)
            return r1
        L_0x0010:
            com.android.server.slice.SlicePermissionManager$PkgUser r0 = new com.android.server.slice.SlicePermissionManager$PkgUser     // Catch:{ all -> 0x002c }
            java.lang.String r2 = r4.getAuthority()     // Catch:{ all -> 0x002c }
            r0.<init>(r2, r5)     // Catch:{ all -> 0x002c }
            com.android.server.slice.SliceClientPermissions$SliceAuthority r0 = r3.getAuthority(r0)     // Catch:{ all -> 0x002c }
            if (r0 == 0) goto L_0x002a
            java.util.List r2 = r4.getPathSegments()     // Catch:{ all -> 0x002c }
            boolean r2 = r0.hasPermission(r2)     // Catch:{ all -> 0x002c }
        ...
        L_0x002c:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.slice.SliceClientPermissions.hasPermission(android.net.Uri, int):boolean");
    }
    ...
    public synchronized void writeTo(XmlSerializer out) throws IOException {
        ...
        out.attribute(NAMESPACE, ATTR_FULL_ACCESS, this.mHasFullAccess ? SplitScreenReporter.ACTION_ENTER_SPLIT : "0");
