...
public class TrustAgentWrapper {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (message.what) {
                case 1:
                    ...
                    CharSequence unused2 = TrustAgentWrapper.this.mMessage = (CharSequence) message.obj;
    ...
    public TrustAgentWrapper(Context context, TrustManagerService trustManagerService, Intent intent, UserHandle user) {
        ...
        if (this.mBound) {
            this.mContext.registerReceiver(this.mBroadcastReceiver, alarmFilter, PERMISSION, (Handler) null);
            return;
        }
    ...
    public boolean updateDevicePolicyFeatures() {
        ...
        try {
            if (this.mTrustAgentService != null) {
                ...
                if ((dpm.getKeyguardDisabledFeatures((ComponentName) null, this.mUserId) & 16) != 0) {
                    List<PersistableBundle> config = dpm.getTrustAgentConfiguration((ComponentName) null, this.mName, this.mUserId);
                    trustDisabled = true;
                    if (DEBUG) {
                ...
                long maxTimeToLock = dpm.getMaximumTimeToLock((ComponentName) null, this.mUserId);
