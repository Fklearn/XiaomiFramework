...
final class TvRemoteProviderWatcher {
    ...
    public TvRemoteProviderWatcher(Context context, ProviderMethods provider, Handler handler) {
        ...
        this.mUnbundledServicePackage = context.getString(17039797);
    }
    ...
    public void start() {
        ...
        if (!this.mRunning) {
            ...
            this.mContext.registerReceiverAsUser(this.mScanPackagesReceiver, new UserHandle(this.mUserId), filter, (String) null, this.mHandler);
