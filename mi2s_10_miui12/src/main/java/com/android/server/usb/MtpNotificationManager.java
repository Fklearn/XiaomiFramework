...
class MtpNotificationManager {
    ...
    public void showNotification(UsbDevice device) {
        ...
        Notification.Builder builder = new Notification.Builder(this.mContext, SystemNotificationChannels.USB).setContentTitle(resources.getString(17041274, new Object[]{device.getProductName()})).setContentText(resources.getString(17041273)).setSmallIcon(17303601).setCategory("sys");
    ...
    private class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            UsbDevice device = (UsbDevice) intent.getExtras().getParcelable(CloudControlPreinstallService.ConnectEntity.DEVICE);
            if (device != null) {
