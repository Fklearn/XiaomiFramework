...
public final class UsbAlsaDevice {
    ...
    public synchronized void dump(DualDumpOutputStream dump, String idName, long id) {
        ...
        dump.write(CloudControlPreinstallService.ConnectEntity.DEVICE, 1120986464258L, this.mDeviceNum);
    ...
    public int hashCode() {
        return (((((((((((1 * 31) + this.mCardNum) * 31) + this.mDeviceNum) * 31) + (this.mHasOutput ^ true ? 1 : 0)) * 31) + (this.mHasInput ^ true ? 1 : 0)) * 31) + (this.mIsInputHeadset ^ true ? 1 : 0)) * 31) + (this.mIsOutputHeadset ^ true ? 1 : 0);
    }
}
