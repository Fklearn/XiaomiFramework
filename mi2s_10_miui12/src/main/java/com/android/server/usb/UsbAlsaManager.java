...
public final class UsbAlsaManager {
    ...
    static final List<BlackListEntry> sDeviceBlacklist = Arrays.asList(new BlackListEntry[]{new BlackListEntry(USB_VENDORID_SONY, USB_PRODUCTID_PS4CONTROLLER_ZCT1, 1), new BlackListEntry(USB_VENDORID_SONY, USB_PRODUCTID_PS4CONTROLLER_ZCT2, 1)});
    ...
    public void setPeripheralMidiState(boolean enabled, int card, int device) {
        ...
        if (this.mHasMidiFeature) {
            if (enabled && this.mPeripheralMidiDevice == null) {
                ...
                properties.putString(com.android.server.pm.Settings.ATTR_NAME, r.getString(17041271));
                properties.putString("manufacturer", r.getString(17041270));
                properties.putString("product", r.getString(17041272));
