...
public final class UsbMidiDevice implements Closeable {
    ...
    private boolean register(Context context, Bundle properties) {
        ...
        this.mServer = midiManager.createDeviceServer(this.mInputPortReceivers, this.mSubdeviceCount, (String[]) null, (String[]) null, properties, 1, this.mCallback);
    ...
    public void closeLocked() {
        for (int i = 0; i < this.mEventSchedulers.length; i++) {
            this.mInputPortReceivers[i].setReceiver((MidiReceiver) null);
    ...
    public void dump(String deviceAddr, DualDumpOutputStream dump, String idName, long id) {
        ...
        dump.write(CloudControlPreinstallService.ConnectEntity.DEVICE, 1120986464258L, this.mAlsaDevice);
        dump.end(token);
    }
}
