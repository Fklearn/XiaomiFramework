...
public class NetworkSuggestionEvaluator implements WifiNetworkSelector.NetworkEvaluator {
    ...
    private class MatchMetaInfo {
        ...
        public PerNetworkSuggestionMatchMetaInfo findConnectableNetworksAndPickBest(WifiNetworkSelector.NetworkEvaluator.OnConnectableListener onConnectableListener) {
            ...
            PerNetworkSuggestionMatchMetaInfo networkInfo = (PerNetworkSuggestionMatchMetaInfo) allMatchedNetworkInfos.stream().max(Comparator.comparing($$Lambda$NetworkSuggestionEvaluator$MatchMetaInfo$Z5L6mK_zEDnbf0FAnqkVI8uBr0.INSTANCE)).orElse((Object) null);
            if (networkInfo != null) {
                return networkInfo;
            }
