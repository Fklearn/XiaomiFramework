...
public class SarManager {
    ...
    private void readSarConfigs() {
        this.mSupportSarTxPowerLimit = this.mContext.getResources().getBoolean(17891593);
        if (!this.mSupportSarTxPowerLimit) {
        ...
        this.mSupportSarSoftAp = this.mContext.getResources().getBoolean(17891594);
        this.mSupportSarSensor = this.mContext.getResources().getBoolean(17891592);
        if (this.mSupportSarSensor) {
            this.mSarSensorEventFreeSpace = this.mContext.getResources().getInteger(17694942);
            this.mSarSensorEventNearBody = this.mContext.getResources().getInteger(17694943);
            this.mSarSensorEventNearHand = this.mContext.getResources().getInteger(17694944);
            this.mSarSensorEventNearHead = this.mContext.getResources().getInteger(17694945);
        }
    }
    ...
    private class SarSensorEventListener implements SensorEventListener {
        ...
        public boolean register() {
            String sensorType = SarManager.this.mContext.getResources().getString(17039804);
