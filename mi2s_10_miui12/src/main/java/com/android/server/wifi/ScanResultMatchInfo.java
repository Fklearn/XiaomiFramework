...
public class ScanResultMatchInfo {
    ...
    public static int getNetworkType(WifiConfiguration config) {
        ...
        if (WifiConfigurationUtil.isConfigForSha256Network(config)) {
            return 7;
        }
        if (WifiConfigurationUtil.isConfigForSha384Network(config)) {
            return 8;
        }
    ...
    public static int getNetworkType(ScanResult scanResult) {
        ...
        if (ScanResultUtil.isScanResultForFilsSha384Network(scanResult)) {
            return 8;
        }
