...
public class ScoringParams {
    ...
    private class Values {
        ...
        public void parseString(String kvList) throws IllegalArgumentException {
            ...
            if (size == (Prefix.EMPTY + kvList).split(",").length) {
    ...
    private void loadResources(Context context) {
        this.mVal.rssi2[0] = context.getResources().getInteger(17694948);
        this.mVal.rssi2[1] = context.getResources().getInteger(17694950);
        this.mVal.rssi2[2] = context.getResources().getInteger(17694954);
        this.mVal.rssi2[3] = context.getResources().getInteger(17694952);
        this.mVal.rssi5[0] = context.getResources().getInteger(17694949);
        this.mVal.rssi5[1] = context.getResources().getInteger(17694951);
        this.mVal.rssi5[2] = context.getResources().getInteger(17694955);
        this.mVal.rssi5[3] = context.getResources().getInteger(17694953);
        try {
            this.mVal.validate();
    ...
    public boolean update(String kvList) {
        if (kvList == null || Prefix.EMPTY.equals(kvList)) {
            return true;
        }
