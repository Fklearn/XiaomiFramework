...
public class SupplicantStateTracker extends StateMachine {
    ...
    /* access modifiers changed from: private */
    public int mAuthenticationFailuresCount = 0;
    ...
    static /* synthetic */ int access$108(SupplicantStateTracker x0) {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 151553:
                    ...
                    SupplicantStateTrackerInjector.handleConnectNetwork(message.arg1);
                    break;
                default:
    ...
    class DisconnectedState extends State {
        ...
        public void enter() {
            ...
            SupplicantStateTracker supplicantStateTracker = SupplicantStateTracker.this;
            int unused = supplicantStateTracker.mAuthenticationFailuresCount = SupplicantStateTrackerInjector.handleNetworkConnectionFailure(supplicantStateTracker.mContext, SupplicantStateTracker.this.mWifiConfigManager, ((StateChangeResult) SupplicantStateTracker.this.getCurrentMessage().obj).wifiSsid, SupplicantStateTracker.this.mAuthenticationFailuresCount);
        }
    }
