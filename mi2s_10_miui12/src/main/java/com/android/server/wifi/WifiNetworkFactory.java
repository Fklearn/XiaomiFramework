...
public class WifiNetworkFactory extends NetworkFactory {
    ...
    public Pair<Integer, String> getSpecificNetworkRequestUidAndPackageName(WifiConfiguration connectedNetwork) {
        if (this.mUserSelectedNetwork == null || connectedNetwork == null) {
            return Pair.create(-1, Prefix.EMPTY);
        }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public android.net.wifi.ScanResult findUserApprovedAccessPointForActiveRequestFromActiveMatchedScanResults() {
        /*
            r10 = this;
        ...
        L_0x0067:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wifi.WifiNetworkFactory.findUserApprovedAccessPointForActiveRequestFromActiveMatchedScanResults():android.net.wifi.ScanResult");
    }
