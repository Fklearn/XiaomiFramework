...
public class WifiVendorHal {
    private static final int[][] sChipFeatureCapabilityTranslation = {new int[]{MiuiWindowManager.LayoutParams.EXTRA_FLAG_FULLSCREEN_BLURSURFACE, 256}, new int[]{128, 512}, new int[]{256, 1024}};
    private static final long[][] sChipFeatureCapabilityTranslation13 = {new long[]{1073741824, MiuiConfiguration.THEME_FLAG_LOCKSTYLE}, new long[]{4294967296L, MiuiConfiguration.THEME_FLAG_STATUSBAR}};
    ...
    private static final int[][] sStaFeatureCapabilityTranslation = {new int[]{2, 128}, new int[]{4, 256}, new int[]{32, 2}, new int[]{1024, 512}, new int[]{4096, 1024}, new int[]{8192, 2048}, new int[]{ISupplicantVendorStaNetwork.VendorKeyMgmtMask.IEEE8021X_SUITEB, 4}, new int[]{ISupplicantVendorStaNetwork.VendorKeyMgmtMask.FILS_SHA384, 8}, new int[]{1048576, 8192}, new int[]{2097152, 4096}, new int[]{8388608, 16}, new int[]{MiuiWindowManager.LayoutParams.EXTRA_FLAG_IS_SCREEN_PROJECTION, 32}, new int[]{MiuiWindowManager.LayoutParams.EXTRA_FLAG_IS_PIP_SCREEN_PROJECTION, 64}};
    /* access modifiers changed from: private */
    ...
    private class ChipEventCallback extends IWifiChipEventCallback.Stub {
        ...
        public /* synthetic */ void lambda$onDebugRingBufferDataAvailable$0$WifiVendorHal$ChipEventCallback(android.hardware.wifi.V1_0.WifiDebugRingBufferStatus r6, java.util.ArrayList r7) {
            /*
                r5 = this;
            ...
            L_0x0059:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.wifi.WifiVendorHal.ChipEventCallback.lambda$onDebugRingBufferDataAvailable$0$WifiVendorHal$ChipEventCallback(android.hardware.wifi.V1_0.WifiDebugRingBufferStatus, java.util.ArrayList):void");
        }
    ...
    public class HalDeviceManagerStatusListener implements HalDeviceManager.ManagerStatusListener {
        ...
        public void onStatusChanged() {
            WifiVendorHal.this.mHalEventHandler.post(new Runnable() {
                public final void run() {
                    WifiVendorHal.HalDeviceManagerStatusListener.this.lambda$onStatusChanged$0$WifiVendorHal$HalDeviceManagerStatusListener();
                }
            });
        }

        public /* synthetic */ void lambda$onStatusChanged$0$WifiVendorHal$HalDeviceManagerStatusListener() {
