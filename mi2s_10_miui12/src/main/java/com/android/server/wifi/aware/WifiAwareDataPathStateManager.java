...
public class WifiAwareDataPathStateManager {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v11, resolved type: android.net.wifi.aware.WifiAwareNetworkSpecifier} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v22, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v20, resolved type: com.android.server.wifi.aware.WifiAwareDataPathStateManager$AwareNetworkRequestInformation} */
    ...
    public android.net.wifi.aware.WifiAwareNetworkSpecifier onDataPathRequest(int r17, byte[] r18, int r19, byte[] r20) {
        /*
            ...
            r3 = 0
            r4 = 0
            java.util.Map<android.net.wifi.aware.WifiAwareNetworkSpecifier, com.android.server.wifi.aware.WifiAwareDataPathStateManager$AwareNetworkRequestInformation> r5 = r0.mNetworkRequestsCache
        ...
        L_0x0014:
            ...
            com.android.server.wifi.aware.WifiAwareDataPathStateManager$AwareNetworkRequestInformation r7 = (com.android.server.wifi.aware.WifiAwareDataPathStateManager.AwareNetworkRequestInformation) r7
            int r7 = r7.pubSubId
        ...
        L_0x00a7:
            return r15
        L_0x00a8:
            java.lang.String r3 = "WifiAwareDataPathStMgr"
            if (r12 != 0) goto L_0x00df
            java.lang.StringBuilder r4 = new java.lang.StringBuilder
            r4.<init>()
            java.lang.String r5 = "onDataPathRequest: can't find a request with specified pubSubId="
            r4.append(r5)
            r4.append(r1)
            ...
            return r15
        L_0x00df:
            byte[] r4 = r12.peerDiscoveryMac
            if (r4 != 0) goto L_0x00e5
            r12.peerDiscoveryMac = r2
        L_0x00e5:
            java.lang.String r4 = r0.selectInterfaceForRequest(r12)
            r12.interfaceName = r4
            java.lang.String r4 = r12.interfaceName
            if (r4 != 0) goto L_0x0121
            java.lang.StringBuilder r4 = new java.lang.StringBuilder
            r4.<init>()
            java.lang.String r5 = "onDataPathRequest: request "
            r4.append(r5)
            r4.append(r13)
            java.lang.String r5 = " no interface available"
            r4.append(r5)
            java.lang.String r4 = r4.toString()
            android.util.Log.w(r3, r4)
            com.android.server.wifi.aware.WifiAwareStateManager r3 = r0.mMgr
    ...
    public void onRespondToDataPathRequest(int r7, boolean r8, int r9) {
        /*
            ...
            r0 = 0
            r1 = 0
            java.util.Map<android.net.wifi.aware.WifiAwareNetworkSpecifier, com.android.server.wifi.aware.WifiAwareDataPathStateManager$AwareNetworkRequestInformation> r2 = r6.mNetworkRequestsCache
        ...
        L_0x000c:
            ...
            r1 = r2
            com.android.server.wifi.aware.WifiAwareDataPathStateManager$AwareNetworkRequestInformation r1 = (com.android.server.wifi.aware.WifiAwareDataPathStateManager.AwareNetworkRequestInformation) r1
            goto L_0x0032
        L_0x0031:
            goto L_0x000c
        L_0x0032:
            java.lang.String r2 = "WifiAwareDataPathStMgr"
        ...
        L_0x004b:
            ...
            android.util.Log.w(r2, r3)
            com.android.server.wifi.aware.WifiAwareStateManager r2 = r6.mMgr
            r2.endDataPath(r7)
            java.util.Map<android.net.wifi.aware.WifiAwareNetworkSpecifier, com.android.server.wifi.aware.WifiAwareDataPathStateManager$AwareNetworkRequestInformation> r2 = r6.mNetworkRequestsCache
            r2.remove(r0)
            com.android.server.wifi.aware.WifiAwareDataPathStateManager$WifiAwareNetworkFactory r2 = r6.mNetworkFactory
            r2.letAppKnowThatRequestsAreUnavailable(r1)
            com.android.server.wifi.aware.WifiAwareMetrics r2 = r6.mAwareMetrics
            boolean r3 = r0.isOutOfBand()
            long r4 = r1.startTimestamp
            r2.recordNdpStatus(r9, r3, r4)
            return
        L_0x0081:
            int r4 = r1.state
    ...
    public WifiAwareNetworkSpecifier onDataPathConfirm(int ndpId, byte[] mac, boolean accept, int reason, byte[] message, List<NanDataPathChannelInfo> channelInfo) {
        ...
        if (nnri.state != 101) {
            ...
            NetworkInfo networkInfo = new NetworkInfo(-1, 0, NETWORK_TAG, Prefix.EMPTY);
            ...
            if (!this.mNiWrapper.configureAgentProperties(nnri, nnri.equivalentRequests, ndpId, networkInfo, networkCapabilities2, linkProperties)) {
                declareUnfullfillableAndEndDp(nnri, i);
                return networkSpecifier;
            }
            ...
            nnri2.networkAgent = new WifiAwareNetworkAgent(this, looper, context, AGENT_TAG_PREFIX + nnri.ndpId, new NetworkInfo(-1, 0, NETWORK_TAG, Prefix.EMPTY), networkCapabilities2, linkProperties, 1, nnri2);
            ...
            this.mAwareMetrics.recordNdpStatus(reason, networkSpecifier3.isOutOfBand(), nnri3.startTimestamp);
    ...
    public class WifiAwareNetworkAgent extends NetworkAgent {
        ...
        public void reconfigureAgentAsDisconnected() {
            this.mNetworkInfo.setDetailedState(NetworkInfo.DetailedState.DISCONNECTED, (String) null, Prefix.EMPTY);
            ...
            if (b != bArr[0] || tlv[1] != bArr[1] || tlv[2] != bArr[2]) {
                ...
                while (it.hasNext()) {
                    ...
                    if (i != 0) {
                        ...
                        if (port < 0) {
                            port += ISupplicantVendorStaNetwork.VendorKeyMgmtMask.IEEE8021X_SUITEB;
                        }
                        if (port == 0) {
