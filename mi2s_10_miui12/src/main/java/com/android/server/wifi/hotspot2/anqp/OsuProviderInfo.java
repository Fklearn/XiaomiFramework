...
public class OsuProviderInfo {
    ...
    public static OsuProviderInfo parse(ByteBuffer payload) throws ProtocolException {
        ...
        if (length >= 9) {
            ...
            return new OsuProviderInfo(friendlyNameList, serverUri, methodList, arrayList, ByteBufferReader.readStringWithByteLength(byteBuffer, StandardCharsets.UTF_8), parseI18Names(getSubBuffer(byteBuffer, ((int) ByteBufferReader.readInteger(byteBuffer, ByteOrder.LITTLE_ENDIAN, 2)) & Constants.SHORT_MASK)));
        }
