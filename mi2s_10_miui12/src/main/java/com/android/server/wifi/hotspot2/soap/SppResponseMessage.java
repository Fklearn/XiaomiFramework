...
public class SppResponseMessage {
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(this.mMessageType), this.mVersion, this.mSessionID, Integer.valueOf(this.mStatus), Integer.valueOf(this.mError), this.mAttributes});
    }
