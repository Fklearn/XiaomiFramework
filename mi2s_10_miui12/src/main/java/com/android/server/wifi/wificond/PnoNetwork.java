...
public class PnoNetwork implements Parcelable {
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{Boolean.valueOf(this.isHidden), Integer.valueOf(Arrays.hashCode(this.ssid)), Integer.valueOf(Arrays.hashCode(this.frequencies))});
    }
