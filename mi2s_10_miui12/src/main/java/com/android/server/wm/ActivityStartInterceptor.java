...
class ActivityStartInterceptor {
    ...
    private IntentSender createIntentSenderForOriginalIntent(int callingUid, int flags) {
        ...
        return new IntentSender(this.mService.getIntentSenderLocked(2, this.mCallingPackage, callingUid, this.mUserId, (IBinder) null, (String) null, 0, new Intent[]{this.mIntent}, new String[]{this.mResolvedType}, flags, activityOptions));
    }
    ...
    private Intent interceptWithConfirmCredentialsIfNeeded(ActivityInfo aInfo, int userId) {
        ...
        Intent newIntent = ((KeyguardManager) this.mServiceContext.getSystemService("keyguard")).createConfirmDeviceCredentialIntent((CharSequence) null, (CharSequence) null, userId);
        if (newIntent == null) {
            return null;
        }
