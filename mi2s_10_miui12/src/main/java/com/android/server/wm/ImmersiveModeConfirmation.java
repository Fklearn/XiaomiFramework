...
public class ImmersiveModeConfirmation {
    ...
    ImmersiveModeConfirmation(Context context, Looper looper, boolean vrModeEnabled) {
        ...
        this.mPanicThresholdMs = (long) context.getResources().getInteger(17694813);
    ...
    private class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            this.mClingLayout = (ViewGroup) View.inflate(getContext(), 17367165, (ViewGroup) null);
            ((Button) this.mClingLayout.findViewById(16909217)).setOnClickListener(new View.OnClickListener() {
