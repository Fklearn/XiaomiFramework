...
class LaunchParamsPersister {
    ...
    private void loadLaunchParams(int userId) {
        ...
        ArrayMap arrayMap = new ArrayMap(paramsFiles2.length);
        this.mMap.put(i, arrayMap);
        int length = paramsFiles2.length;
        int i2 = 0;
        int i3 = 0;
        while (i3 < length) {
            File paramsFile = paramsFiles2[i3];
            if (!paramsFile.isFile()) {
                ...
                ComponentName name = ComponentName.unflattenFromString(paramsFileName.substring(i2, paramsFileName.length() - LAUNCH_PARAMS_FILE_SUFFIX.length()).replace(ESCAPED_COMPONENT_SEPARATOR, ORIGINAL_COMPONENT_SEPARATOR));
                if (name == null) {
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                File[] fileArr2 = paramsFiles2;
                                IoUtils.closeQuietly(reader);
                                throw th;
                            }
                        }
                        arrayMap.put(name, params);
                    } catch (Exception e4) {
                        e = e4;
                        launchParamsFolder2 = launchParamsFolder;
                        packages2 = packages;
                        ...
                        th = th4;
                        File file = launchParamsFolder;
                        Set<String> set2 = packages;
                        File[] fileArr3 = paramsFiles2;
                        IoUtils.closeQuietly(reader);
                        throw th;
                    }
                    IoUtils.closeQuietly(reader);
        ...
        Set<String> set3 = packages;
        File[] fileArr4 = paramsFiles2;
    ...
    private class LaunchParamsWriteQueueItem implements PersisterQueue.WriteQueueItem<LaunchParamsWriteQueueItem> {
        /* access modifiers changed from: private */
    ...
    private class PersistableLaunchParams {
        ...
        public void saveToXml(XmlSerializer serializer) throws IOException {
            ...
            serializer.attribute((String) null, ATTR_WINDOWING_MODE, Integer.toString(this.mWindowingMode));
