...
public class LockTaskController {
    ...
    /* access modifiers changed from: private */
    public int mPendingDisableFromDismiss = ScreenRotationAnimationInjector.BLACK_SURFACE_INVALID_POSITION;
    @VisibleForTesting
    ...
    private void setLockTaskMode(TaskRecord task, int lockTaskModeState, String reason, boolean andResume) {
        if (task.mLockTaskAuth != 0) {
            ...
            if (andResume) {
                this.mSupervisor.findTaskToMoveToFront(task, 0, (ActivityOptions) null, reason, lockTaskModeState != 0);
                this.mSupervisor.mRootActivityContainer.resumeFocusedStacksTopActivities();
    ...
    private void setKeyguardState(int lockTaskModeState, final int userId) {
        this.mPendingDisableFromDismiss = ScreenRotationAnimationInjector.BLACK_SURFACE_INVALID_POSITION;
            ...
            this.mWindowManager.dismissKeyguard(new IKeyguardDismissCallback.Stub() {
                ...
                public /* synthetic */ void lambda$onDismissSucceeded$0$LockTaskController$1(int userId) {
                    if (LockTaskController.this.mPendingDisableFromDismiss == userId) {
                        ...
                        int unused = LockTaskController.this.mPendingDisableFromDismiss = ScreenRotationAnimationInjector.BLACK_SURFACE_INVALID_POSITION;
                    }
                }
    ...
    private boolean shouldLockKeyguard() {
        try {
            ...
            EventLog.writeEvent(1397638484, new Object[]{"127605586", -1, ""});
    ...
    public void dump(PrintWriter pw, String prefix) {
        ...
        for (int i2 = 0; i2 < this.mLockTaskPackages.size(); i2++) {
            pw.println(prefix2 + "  u" + this.mLockTaskPackages.keyAt(i2) + ":" + Arrays.toString((Object[]) this.mLockTaskPackages.valueAt(i2)));
        }
    }
