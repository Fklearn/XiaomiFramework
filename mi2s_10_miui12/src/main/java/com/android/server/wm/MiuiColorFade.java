...
public final class MiuiColorFade {
    private static final int COLOR_FADE_LAYER = 1073741825;
    private static final boolean DEBUG = false;
    private static final int DEJANK_FRAMES = 3;
    public static final int MODE_BUFFER_LAYER = 0;
    public static final int MODE_COOL_DOWN = 1;
    public static final int MODE_FADE = 2;
    private static final String TAG = "MiuiColorFade";
    private int mAlphaLoc;
    private final Choreographer mChoreographer = Choreographer.getInstance();
    /* access modifiers changed from: private */
    public float mColorFadeLevel = 0.0f;
    ...
    private int mMode;
    private final Runnable mNightColorFadeDrawRunnable = new Runnable() {
        public void run() {
            if (MiuiColorFade.this.mPrepared) {
                MiuiColorFade miuiColorFade = MiuiColorFade.this;
                miuiColorFade.draw(miuiColorFade.mColorFadeLevel);
            }
        }
    };
    /* access modifiers changed from: private */
    ...
    public MiuiColorFade(int displayId) {
        this.mDisplayId = displayId;
        this.mIWindowManager = IWindowManager.Stub.asInterface(ServiceManager.getService("window"));
        this.mDisplayManagerInternal = (DisplayManagerInternal) LocalServices.getService(DisplayManagerInternal.class);
    }

    public void setColorFadeAlphaLevel(float level) {
        if (this.mColorFadeLevel != level) {
            this.mColorFadeLevel = level;
            if (this.mColorFadeLevel == 0.0f) {
                dismiss();
            }
            if (this.mPrepared) {
    ...
    public float getColorFadeAlphaLevel() {
        return this.mColorFadeLevel;
    }

    private void scheduleColorFadeDraw() {
        this.mChoreographer.postCallback(3, this.mNightColorFadeDrawRunnable, (Object) null);
    }
    ...
    public boolean prepare(int mode) {
        ...
        if (!createSurface() || !createEglContext() || !createEglSurface() || !captureScreenshotTextureAndSetViewport()) {
            ...
            try {
                if (!initGLShaders() || !initGLBuffers() || checkGlErrors("prepare")) {
                    detachEglContext();
                    dismiss();
                    detachEglContext();
                    return false;
    ...
    private boolean initGLShaders() {
        ...
        this.mAlphaLoc = GLES20.glGetUniformLocation(this.mProgram, "alpha");
    ...
    public boolean draw(float level) {
        ...
        try {
            ...
            drawFaded(((float) (-Math.pow((double) (1.0f - level), 2.0d))) + 1.0f);
    ...
    private void drawFaded(float alpha) {
        GLES20.glUseProgram(this.mProgram);
        ...
        GLES20.glUniform1f(this.mAlphaLoc, alpha);
    ...
    private boolean captureScreenshotTextureAndSetViewport() {
        ...
        try {
            ...
            SurfaceControl.screenshot(token, s, false);
            st.updateTexImage();
    ...
    private boolean createSurface() {
        ...
        if (this.mSurfaceControl == null) {
            ...
            try {
                parent = this.mIWindowManager.getTaskStackContainersSurfaceControl();
            } catch (RemoteException e) {
                Slog.e(TAG, "getTaskStackContainersSurfaceControl" + e);
            }
            try {
                SurfaceControl.Builder builder = new SurfaceControl.Builder(this.mSurfaceSession).setName("MiuiColorAnimFade");
                if (this.mMode == 2) {
    ...
    private void destroySurface() {
        if (this.mSurfaceControl != null) {
            ...
            try {
                this.mSurfaceControl.reparent((SurfaceControl) null);
    ...
    private static final class NaturalSurfaceLayout implements DisplayManagerInternal.DisplayTransactionListener {
        ...
        public void onDisplayTransaction(android.view.SurfaceControl.Transaction r11) {
            ...
            L_0x0074:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.wm.MiuiColorFade.NaturalSurfaceLayout.onDisplayTransaction(android.view.SurfaceControl$Transaction):void");
        }
    }
}
