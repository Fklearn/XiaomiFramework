...
class PinnedStackController {
    ...
    private void reloadResources() {
        ...
        this.mDefaultMinSize = res.getDimensionPixelSize(17105123);
        this.mCurrentMinSize = this.mDefaultMinSize;
        this.mDefaultAspectRatio = res.getFloat(17105067);
        String screenEdgeInsetsDpString = res.getString(17039732);
        ...
        this.mMinAspectRatio = res.getFloat(17105070);
        this.mMaxAspectRatio = res.getFloat(17105069);
    }
