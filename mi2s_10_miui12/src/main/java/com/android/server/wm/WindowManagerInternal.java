...
public abstract class WindowManagerInternal extends MiuiWindowManagerInternal {
    ...
    public abstract boolean getCastRotationMode();
    ...
    public abstract void setBsInputFilter(IInputFilter iInputFilter);
    ...
    public abstract void setTalkbackMode(boolean z);
