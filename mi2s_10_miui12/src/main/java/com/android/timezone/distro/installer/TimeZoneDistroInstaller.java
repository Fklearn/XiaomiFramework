    ...
    public int stageInstallWithErrorCode(TimeZoneDistro distro) throws IOException {
        ...
        try {
            ...
            try {
                ...
                } catch (TzDataSetVersion.TzDataSetException e2) {
                    Slog.i(this.logTag, "Update not applied: Distro version could not be converted", e2);
                    deleteBestEffort(this.oldStagedDataDir);
                    deleteBestEffort(this.workingDir);
                    return 1;
                }
                ...
                Slog.i(str9, "Invalid distro version: " + e3.getMessage());
                deleteBestEffort(this.oldStagedDataDir);
                deleteBestEffort(this.workingDir);
                return 1;
            }
            ...
            Slog.i(str10, "Update not applied: " + tzLookupFile + " failed validation", e4);
            deleteBestEffort(this.oldStagedDataDir);
            deleteBestEffort(this.workingDir);
            return 4;
        } catch (Throwable e5) {
