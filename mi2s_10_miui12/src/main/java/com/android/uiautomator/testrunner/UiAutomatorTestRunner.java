...
public class UiAutomatorTestRunner {
    ...
    public final IAutomationSupport mAutomationSupport = new IAutomationSupport() {
        public void sendStatus(int resultCode, Bundle status) {
            UiAutomatorTestRunner.this.mWatcher.instrumentationStatus((ComponentName) null, resultCode, status);
        }
    };
    ...
    public void run(List<String> testClasses, Bundle params, boolean debug, boolean monkey) {
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
            public void uncaughtException(Thread thread, Throwable ex) {
                ...
                UiAutomatorTestRunner.this.mWatcher.instrumentationFinished((ComponentName) null, UiAutomatorTestRunner.EXIT_OK, results);
