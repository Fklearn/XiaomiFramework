...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public final ByteString concat(ByteString other) {
        ...
        throw new IllegalArgumentException("ByteString would be too long: " + size() + CountryCode.GSM_GENERAL_IDD_CODE + other.size());
    }
    ...
    public final String toString(Charset charset) {
        return size() == 0 ? Prefix.EMPTY : toStringInternal(charset);
    }
