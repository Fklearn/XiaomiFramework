...
public class MiuiCenterHorizontalClock extends MiuiBaseClock {
    ...
    public MiuiCenterHorizontalClock(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void updateViewsLayoutParams() {
        ...
        dateInfoLayoutParams.topMargin = (int) (this.mScaleRatio * ((float) this.mResources.getDimensionPixelSize(R.dimen.miui_clock_date_info_top_margin)));
