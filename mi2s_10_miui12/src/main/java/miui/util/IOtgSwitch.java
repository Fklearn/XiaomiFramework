...
public class IOtgSwitch
{
  ...
  public static IOtgSwitch getInstance()
  {
    if (INSTANCE == null) {
      try
      {
        if (INSTANCE == null)
        {
          IOtgSwitch localIOtgSwitch = new miui/util/IOtgSwitch;
          localIOtgSwitch.<init>();
          INSTANCE = localIOtgSwitch;
        }
      }
      finally {}
    }
  ...
  public int getOtgStatus()
  {
    ...
    //   0	205	0	this	IOtgSwitch
    //   7	193	1	localHwParcel	android.os.HwParcel
    //   15	20	2	localIHwBinder	android.os.IHwBinder
    //   154	18	2	localException	Exception
    //   23	106	3	localObject1	Object
    //   150	1	3	localObject2	Object
    //   158	46	3	localStringBuilder	StringBuilder
    //   56	85	4	i	int
    // Exception table:
    //   from	to	target	type
    //   8	16	150	finally
  ...
  /* Error */
  public int setOtgEnabled(boolean paramBoolean)
  {
    // Byte code:
    //   0: new 50	android/os/HwParcel
    //   3: dup
    ...
    //   37: aload 4
    //   39: iload_1
    //   40: invokevirtual 125	android/os/HwParcel:writeBool	(Z)V
    //   43: aload_3
    //   44: iconst_2
    //   45: aload 4
    //   47: aload_2
    ...
    //   92: aload 4
    //   94: iload_1
    //   95: invokevirtual 130	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   98: pop
    //   99: aload 4
    //   101: ldc -124
...
/* Location:              /Users/sanbo/Desktop/framework/miui/framework/classes4-dex2jar.jar!/miui/util/IOtgSwitch.class
