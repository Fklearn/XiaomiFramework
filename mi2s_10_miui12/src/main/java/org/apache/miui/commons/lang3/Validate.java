  ...
  public static void isAssignableFrom(Class<?> paramClass1, Class<?> paramClass2)
  {
    if (!paramClass1.isAssignableFrom(paramClass2))
    {
      if (paramClass2 == null) {
        ...
        paramClass2 = paramClass2.getName();
      }
  ...
  public static void isInstanceOf(Class<?> paramClass, Object paramObject)
  {
    if (!paramClass.isInstance(paramObject))
    {
      ...
      if (paramObject == null) {
        ...
        paramClass = paramObject.getClass().getName();
      }
...
/* Location:              /Users/sanbo/Desktop/framework/miui/framework/classes4-dex2jar.jar!/org/apache/miui/commons/lang3/Validate.class
