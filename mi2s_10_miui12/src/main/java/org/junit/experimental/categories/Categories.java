    ...
    public static class CategoryFilter extends Filter {
        ...
        public static CategoryFilter include(boolean matchAny, Class<?>... categories) {
            if (!hasNull(categories)) {
                return categoryFilter(matchAny, Categories.createSet(categories), true, (Set<Class<?>>) null);
            }
        ...
        public static CategoryFilter exclude(boolean matchAny, Class<?>... categories) {
            if (!hasNull(categories)) {
                return categoryFilter(true, (Set<Class<?>>) null, matchAny, Categories.createSet(categories));
            }
            throw new NullPointerException("has null category");
        }
