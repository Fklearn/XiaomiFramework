...
public interface IHostapdVendor extends IBase {
    public static final String kInterfaceName = "vendor.qti.hardware.wifi.hostapd@1.0::IHostapdVendor";

    HostapdStatus addVendorAccessPoint(VendorIfaceParams vendorIfaceParams, IHostapd.NetworkParams networkParams) throws RemoteException;
    ...
    HostapdStatus registerVendorCallback(String str, IHostapdVendorIfaceCallback iHostapdVendorIfaceCallback) throws RemoteException;

    HostapdStatus removeVendorAccessPoint(String str) throws RemoteException;

    void setHALInstrumentation() throws RemoteException;

    HostapdStatus setHostapdParams(String str) throws RemoteException;
    ...
    public static final class VendorIfaceParams {
        public String bridgeIfaceName = new String();
        public String countryCode = new String();
        public IHostapd.IfaceParams ifaceParams = new IHostapd.IfaceParams();
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (HidlSupport.deepEquals(this.countryCode, other.countryCode) && HidlSupport.deepEquals(this.bridgeIfaceName, other.bridgeIfaceName) && HidlSupport.deepEquals(this.ifaceParams, other.ifaceParams)) {
                return true;
            }
            return false;
        }
        ...
        public final int hashCode() {
            return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.countryCode)), Integer.valueOf(HidlSupport.deepHashCode(this.bridgeIfaceName)), Integer.valueOf(HidlSupport.deepHashCode(this.ifaceParams))});
        }

        public final String toString() {
            return "{" + ".countryCode = " + this.countryCode + ", .bridgeIfaceName = " + this.bridgeIfaceName + ", .ifaceParams = " + this.ifaceParams + "}";
        }
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            this.countryCode = hwBlob.getString(_hidl_offset + 0);
            parcel.readEmbeddedBuffer((long) (this.countryCode.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 0 + 0, false);
            this.bridgeIfaceName = hwBlob.getString(_hidl_offset + 16);
            parcel.readEmbeddedBuffer((long) (this.bridgeIfaceName.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
            this.ifaceParams.readEmbeddedFromParcel(parcel, hwBlob, _hidl_offset + 32);
        }
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            _hidl_blob.putString(0 + _hidl_offset, this.countryCode);
            _hidl_blob.putString(16 + _hidl_offset, this.bridgeIfaceName);
            this.ifaceParams.writeEmbeddedToBlob(_hidl_blob, 32 + _hidl_offset);
        }
    }
    ...
    public static final class Proxy implements IHostapdVendor {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.qti.hardware.wifi.hostapd@1.0::IHostapdVendor]@Proxy";
            }
        }
        ...
        public HostapdStatus addVendorAccessPoint(VendorIfaceParams ifaceParams, IHostapd.NetworkParams nwParams) throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IHostapdVendor {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IHostapdVendor.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{80, -17, 75, -53, -82, -74, 121, -36, -52, -121, -121, MiServiceData.CAPABILITY_IO, 98, -18, 110, -67, 19, 8, -9, -29, -121, -77, 105, 32, -91, -105, -39, -27, 32, 114, 65, -67}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, MiServiceData.CAPABILITY_IO, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                VendorIfaceParams ifaceParams = new VendorIfaceParams();
