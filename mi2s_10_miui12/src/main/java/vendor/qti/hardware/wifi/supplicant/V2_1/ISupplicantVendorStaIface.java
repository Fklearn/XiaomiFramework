...
public interface ISupplicantVendorStaIface extends vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface {
    public static final String kInterfaceName = "vendor.qti.hardware.wifi.supplicant@2.1::ISupplicantVendorStaIface";

    @FunctionalInterface
    public interface getWifiGenerationStatusCallback {
        void onValues(SupplicantStatus supplicantStatus, WifiGenerationStatus wifiGenerationStatus);
    }
    ...
    void getWifiGenerationStatus(getWifiGenerationStatusCallback getwifigenerationstatuscallback) throws RemoteException;
    ...
    public static final class Proxy implements ISupplicantVendorStaIface {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.qti.hardware.wifi.supplicant@2.1::ISupplicantVendorStaIface]@Proxy";
            }
        }
        ...
        public SupplicantStatus registerVendorCallback(ISupplicantVendorStaIfaceCallback callback) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
        ...
        public void getCapabilities(String capaType, ISupplicantVendorStaIface.getCapabilitiesCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
        ...
        public void dppAddBootstrapQrcode(String uri, ISupplicantVendorStaIface.dppAddBootstrapQrcodeCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
        ...
        public void dppBootstrapGenerate(int type, String chan_list, byte[] mac_addr, String info, String curve, String key, ISupplicantVendorStaIface.dppBootstrapGenerateCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
        ...
        public void dppBootstrapRemove(int id, ISupplicantVendorStaIface.dppBootstrapRemoveCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
            _hidl_request.writeInt32(id);
            HwParcel _hidl_reply = new HwParcel();
        ...
        public void dppGetUri(int id, ISupplicantVendorStaIface.dppGetUriCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
            _hidl_request.writeInt32(id);
            HwParcel _hidl_reply = new HwParcel();
        ...
        public void dppStartListen(String frequency, int dpp_role, boolean qr_mutual, boolean netrole_ap, ISupplicantVendorStaIface.dppStartListenCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
        ...
        public void dppConfiguratorAdd(String curve, String key, int expiry, ISupplicantVendorStaIface.dppConfiguratorAddCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
            _hidl_request.writeString(curve);
            _hidl_request.writeString(key);
        ...
        public void dppConfiguratorRemove(int id, ISupplicantVendorStaIface.dppConfiguratorRemoveCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
            _hidl_request.writeInt32(id);
            HwParcel _hidl_reply = new HwParcel();
        ...
        public void dppStartAuth(int peer_bootstrap_id, int own_bootstrap_id, int dpp_role, String ssid, String password, boolean isAp, boolean isDpp, int conf_id, int expiry, ISupplicantVendorStaIface.dppStartAuthCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
        ...
        public void dppConfiguratorGetKey(int id, ISupplicantVendorStaIface.dppConfiguratorGetKeyCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
            _hidl_request.writeInt32(id);
            HwParcel _hidl_reply = new HwParcel();
        ...
        public void doSupplicantCommand(String command, ISupplicantVendorStaIface.doSupplicantCommandCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
        ...
        public void getWifiGenerationStatus(getWifiGenerationStatusCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            ...
            try {
                ...
                SupplicantStatus _hidl_out_status = new SupplicantStatus();
                _hidl_out_status.readFromParcel(_hidl_reply);
                WifiGenerationStatus _hidl_out_generationStatus = new WifiGenerationStatus();
                _hidl_out_generationStatus.readFromParcel(_hidl_reply);
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_generationStatus);
            } finally {
                _hidl_reply.release();
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantVendorStaIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISupplicantVendorStaIface.kInterfaceName, vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName, ISupplicantVendorIface.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 2:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                ...
                case 5:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    getCapabilities(_hidl_request.readString(), new ISupplicantVendorStaIface.getCapabilitiesCallback() {
                ...
                case 6:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    dppAddBootstrapQrcode(_hidl_request.readString(), new ISupplicantVendorStaIface.dppAddBootstrapQrcodeCallback() {
                ...
                case 7:
                    ...
                    dppBootstrapGenerate(type, chan_list, mac_addr, _hidl_request.readString(), _hidl_request.readString(), _hidl_request.readString(), new ISupplicantVendorStaIface.dppBootstrapGenerateCallback() {
                        public void onValues(SupplicantStatus status, int id) {
                            hwParcel2.writeStatus(0);
                            status.writeToParcel(hwParcel2);
                            hwParcel2.writeInt32(id);
                ...
                case 8:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    dppBootstrapRemove(_hidl_request.readInt32(), new ISupplicantVendorStaIface.dppBootstrapRemoveCallback() {
                ...
                case 9:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    dppGetUri(_hidl_request.readInt32(), new ISupplicantVendorStaIface.dppGetUriCallback() {
                ...
                case 10:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    dppStartListen(_hidl_request.readString(), _hidl_request.readInt32(), _hidl_request.readBool(), _hidl_request.readBool(), new ISupplicantVendorStaIface.dppStartListenCallback() {
                ...
                case 12:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    dppConfiguratorAdd(_hidl_request.readString(), _hidl_request.readString(), _hidl_request.readInt32(), new ISupplicantVendorStaIface.dppConfiguratorAddCallback() {
                        public void onValues(SupplicantStatus status, int id) {
                            hwParcel2.writeStatus(0);
                            status.writeToParcel(hwParcel2);
                            hwParcel2.writeInt32(id);
                ...
                case 13:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    dppConfiguratorRemove(_hidl_request.readInt32(), new ISupplicantVendorStaIface.dppConfiguratorRemoveCallback() {
                ...
                case 14:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    dppStartAuth(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readString(), _hidl_request.readString(), _hidl_request.readBool(), _hidl_request.readBool(), _hidl_request.readInt32(), _hidl_request.readInt32(), new ISupplicantVendorStaIface.dppStartAuthCallback() {
                ...
                case 15:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    dppConfiguratorGetKey(_hidl_request.readInt32(), new ISupplicantVendorStaIface.dppConfiguratorGetKeyCallback() {
                ...
                case 16:
                    ...
                    hwParcel.enforceInterface(vendor.qti.hardware.wifi.supplicant.V2_0.ISupplicantVendorStaIface.kInterfaceName);
                    doSupplicantCommand(_hidl_request.readString(), new ISupplicantVendorStaIface.doSupplicantCommandCallback() {
                ...
                case 17:
                    ...
                    getWifiGenerationStatus(new getWifiGenerationStatusCallback() {
                        public void onValues(SupplicantStatus status, WifiGenerationStatus generationStatus) {
                            hwParcel2.writeStatus(0);
                            status.writeToParcel(hwParcel2);
                            generationStatus.writeToParcel(hwParcel2);
                            hwParcel2.send();
                        }
                    });
                    return;
