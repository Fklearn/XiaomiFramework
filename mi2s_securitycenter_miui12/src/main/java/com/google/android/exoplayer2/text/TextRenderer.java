...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public int supportsFormat(Format format) {
        return this.decoderFactory.supportsFormat(format) ? BaseRenderer.supportsFormatDrm((DrmSessionManager<?>) null, format.drmInitData) ? 4 : 2 : MimeTypes.isText(format.sampleMimeType) ? 1 : 0;
    }
}
