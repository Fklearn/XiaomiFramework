...
public class WhiteListActivity extends z {
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.miui.antispam.ui.activity.WhiteListActivity] */
    public e e() {
    ...
    public android.content.Loader<android.database.Cursor> onCreateLoader(int r8, android.os.Bundle r9) {
        /*
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.miui.antispam.ui.activity.WhiteListActivity.onCreateLoader(int, android.os.Bundle):android.content.Loader");
    }
}
