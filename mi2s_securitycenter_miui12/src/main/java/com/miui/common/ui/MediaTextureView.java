...
public class MediaTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    private class a implements SurfaceTexture.OnFrameAvailableListener, MediaPlayer.OnVideoSizeChangedListener {
        ...
        public void c() {
            ...
            SurfaceTexture surfaceTexture = MediaTextureView.this.getSurfaceTexture();
            if (surfaceTexture != null) {
                ...
                if (i2 != 0) {
                    ...
                    this.f3861b = ByteBuffer.allocateDirect(this.f3860a.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
                    this.f3861b.put(this.f3860a).position(0);
        ...
        public void e() {
            ...
            a("glUseProgram");
            this.f3861b.position(0);
            GLES20.glVertexAttribPointer(this.k, 3, 5126, false, 20, this.f3861b);
            a("glVertexAttribPointer maPosition");
            GLES20.glEnableVertexAttribArray(this.k);
            a("glEnableVertexAttribArray maPositionHandle");
            this.f3861b.position(3);
            GLES20.glVertexAttribPointer(this.l, 3, 5126, false, 20, this.f3861b);
    ...
    public MediaTextureView(Context context, AttributeSet attributeSet, int i, int i2) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension((int) getContext().getResources().getDimension(R.dimen.pc_main_card_first_top_size), (int) getContext().getResources().getDimension(R.dimen.pc_main_card_first_top_size));
    }

    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        this.f3859b.a(surfaceTexture, i, i2);
    }
    ...
    public void setPlayer(MediaPlayer mediaPlayer) {
        MediaPlayer unused = this.f3859b.q = mediaPlayer;
    }
