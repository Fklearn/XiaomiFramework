...
public class BlockCallsFromContactsModel extends AbsModel {
    ...
    private void setMultiSimState() {
        boolean z = false;
        boolean z2 = c.b(getContext(), 1) && (d.a(getContext(), "contact_call_mode", 1, 1) == 0);
        boolean b2 = c.b(getContext(), 2);
        int a2 = d.a(getContext(), "contact_call_mode", 2, 1);
    ...
    private void setSingleSimState(int i) {
        ...
        boolean z = false;
        boolean z2 = d.a(getContext(), "contact_call_mode", i, 1) == 0;
        if (b2 && z2) {
            z = true;
        }
