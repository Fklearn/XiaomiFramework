...
public final class i {
    ...
    public static final int[] BallView = {R.attr.layoutHeight, R.attr.layoutWidth};
    public static final int BallView_layoutHeight = 0;
    public static final int BallView_layoutWidth = 1;
    ...
    public static final int[] CircleView = {R.attr.radius, R.attr.reductionRate, R.attr.shaderHeight, R.attr.shaderWidth};
    public static final int CircleView_radius = 0;
    public static final int CircleView_reductionRate = 1;
    public static final int CircleView_shaderHeight = 2;
    public static final int CircleView_shaderWidth = 3;
    public static final int[] Clock = {R.attr.format12Hour, R.attr.format24Hour};
    public static final int Clock_format12Hour = 0;
    public static final int Clock_format24Hour = 1;
    ...
    public static final int[] CustomAttributes = {R.attr.clickable, R.attr.label};
    public static final int CustomAttributes_clickable = 0;
    public static final int CustomAttributes_label = 1;
    public static final int[] CustomSwitchButton = {R.attr.backDrawable, R.attr.thumbDrawable};
    public static final int CustomSwitchButton_backDrawable = 0;
    public static final int CustomSwitchButton_thumbDrawable = 1;
    ...
    @Deprecated
    public static final int[] ExpandableLayout = {16842948, R.attr.el_duration, R.attr.el_expanded, R.attr.el_parallax, R.attr.el_translate_children, R.attr.layout_expandable};
    ...
    public static final int[] FolderTextView = {R.attr.canClick, R.attr.canFoldAgain, R.attr.foldLine, R.attr.foldText, R.attr.needLine, R.attr.tailTextColor, R.attr.unFoldText};
    public static final int FolderTextView_canClick = 0;
    public static final int FolderTextView_canFoldAgain = 1;
    public static final int FolderTextView_foldLine = 2;
    public static final int FolderTextView_foldText = 3;
    public static final int FolderTextView_needLine = 4;
    ...
    public static final int[] GBFourSwitchSelector = {R.attr.gbsiOptionAText, R.attr.gbsiOptionBText, R.attr.gbsiOptionCText, R.attr.gbsiOptionDText};
    public static final int GBFourSwitchSelector_gbsiOptionAText = 0;
    public static final int GBFourSwitchSelector_gbsiOptionBText = 1;
    public static final int GBFourSwitchSelector_gbsiOptionCText = 2;
    public static final int GBFourSwitchSelector_gbsiOptionDText = 3;
    public static final int[] GBRecordVolumView = {R.attr.lineBgColor, R.attr.lineFgColor, R.attr.lineSpace, R.attr.line_Height, R.attr.line_Width, R.attr.textAreaWith, R.attr.timeText, R.attr.timeTextColor, R.attr.timeTextSize, R.attr.totalLineCount};
    public static final int GBRecordVolumView_lineBgColor = 0;
    public static final int GBRecordVolumView_lineFgColor = 1;
    public static final int GBRecordVolumView_lineSpace = 2;
    public static final int GBRecordVolumView_line_Height = 3;
    public static final int GBRecordVolumView_line_Width = 4;
    public static final int GBRecordVolumView_textAreaWith = 5;
    public static final int GBRecordVolumView_timeText = 6;
    public static final int GBRecordVolumView_timeTextColor = 7;
    public static final int GBRecordVolumView_timeTextSize = 8;
    public static final int GBRecordVolumView_totalLineCount = 9;
    public static final int[] GBSettingItemView = {R.attr.gbnopadding, R.attr.gbsiBottomImg, R.attr.gbsiCustomLayout, R.attr.gbsiSubtitle, R.attr.gbsiTitle, R.attr.gbsiValue, R.attr.hasMinHeight, R.attr.multiLine};
    public static final int GBSettingItemView_gbnopadding = 0;
    public static final int GBSettingItemView_gbsiBottomImg = 1;
    public static final int GBSettingItemView_gbsiCustomLayout = 2;
    public static final int GBSettingItemView_gbsiSubtitle = 3;
    public static final int GBSettingItemView_gbsiTitle = 4;
    public static final int GBSettingItemView_gbsiValue = 5;
    public static final int GBSettingItemView_hasMinHeight = 6;
    public static final int GBSettingItemView_multiLine = 7;
    public static final int[] GBSlidingButton = {16842964, R.attr.bar, R.attr.barOff, R.attr.barOn, R.attr.frame, R.attr.isClickable, R.attr.mask, R.attr.sliderOff, R.attr.sliderOn};
    public static final int GBSlidingButton_android_background = 0;
    public static final int GBSlidingButton_bar = 1;
    public static final int GBSlidingButton_barOff = 2;
    public static final int GBSlidingButton_barOn = 3;
    public static final int GBSlidingButton_frame = 4;
    public static final int GBSlidingButton_isClickable = 5;
    public static final int GBSlidingButton_mask = 6;
    public static final int GBSlidingButton_sliderOff = 7;
    public static final int GBSlidingButton_sliderOn = 8;
    public static final int[] GameItemView = {R.attr.type};
    public static final int GameItemView_type = 0;
    ...
    public static final int[] MovableLayout = {R.attr.headerHeight, R.attr.scrollRange};
    public static final int MovableLayout_headerHeight = 0;
    public static final int MovableLayout_scrollRange = 1;
    ...
    public static final int[] NumberPasswordEditText = {R.attr.circleColor, R.attr.circleRadius, R.attr.count, R.attr.focusLineColor, R.attr.focusStokeColor, R.attr.height, R.attr.isDrawCircle, R.attr.isDrawLine, R.attr.lineColor, R.attr.lineWidth, R.attr.spaceWidth, R.attr.stokesColor, R.attr.textColor, R.attr.textSize};
    public static final int NumberPasswordEditText_circleColor = 0;
    public static final int NumberPasswordEditText_circleRadius = 1;
    public static final int NumberPasswordEditText_count = 2;
    public static final int NumberPasswordEditText_focusLineColor = 3;
    public static final int NumberPasswordEditText_focusStokeColor = 4;
    public static final int NumberPasswordEditText_height = 5;
    public static final int NumberPasswordEditText_isDrawCircle = 6;
    public static final int NumberPasswordEditText_isDrawLine = 7;
    public static final int NumberPasswordEditText_lineColor = 8;
    public static final int NumberPasswordEditText_lineWidth = 9;
    public static final int NumberPasswordEditText_spaceWidth = 10;
    public static final int NumberPasswordEditText_stokesColor = 11;
    public static final int NumberPasswordEditText_textColor = 12;
    public static final int NumberPasswordEditText_textSize = 13;
    public static final int[] OMCircleView = {R.attr.min_circle_radio, R.attr.ring_width};
    public static final int OMCircleView_min_circle_radio = 0;
    public static final int OMCircleView_ring_width = 1;
    public static final int[] PasswordUnlockMediatorAttrs = {R.attr.reset_password};
    public static final int PasswordUnlockMediatorAttrs_reset_password = 0;
    public static final int[] PercentLayout = {R.attr.heightPercent, R.attr.marginBottomPercent, R.attr.marginLeftPercent, R.attr.marginRightPercent, R.attr.marginTopPercent, R.attr.widthPercent};
    public static final int PercentLayout_heightPercent = 0;
    public static final int PercentLayout_marginBottomPercent = 1;
    public static final int PercentLayout_marginLeftPercent = 2;
    public static final int PercentLayout_marginRightPercent = 3;
    public static final int PercentLayout_marginTopPercent = 4;
    public static final int PercentLayout_widthPercent = 5;
    ...
    public static final int[] ProgressCircle = {R.attr.circleBgColor, R.attr.circleSize, R.attr.finishDrawable, R.attr.innerPieColor, R.attr.innerPieMaxProgress, R.attr.innerPieProgress, R.attr.innerPieStartingAngle};
    public static final int ProgressCircle_circleBgColor = 0;
    public static final int ProgressCircle_circleSize = 1;
    public static final int ProgressCircle_finishDrawable = 2;
    ...
    public static final int[] RoundImageView = {R.attr.needStat, R.attr.radiusLeftBottom, R.attr.radiusLeftTop, R.attr.radiusRightBottom, R.attr.radiusRightTop};
    public static final int RoundImageView_needStat = 0;
    ...
    public static final int[] SimSignalView = {R.attr.simId};
    public static final int SimSignalView_simId = 0;
